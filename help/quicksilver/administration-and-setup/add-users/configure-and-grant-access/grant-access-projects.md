...
description: 作为Adobe Workfront管理员，您可以使用访问级别定义用户对Workfront中项目的访问权限。
author: Caroline
...
作为Adobe Workfront管理员，您可以使用访问级别定义用户对项目的访问权限，如 [访问级别概述](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).
...
1. 单击齿轮图标 ![](assets/gear-icon-settings.png) 在 **查看** 或 **编辑** 按钮，然后选择要在 **优化设置**.
   ...
   >[!NOTE]
   >
   >* 具有工作许可证的用户具有有限的项目权限。 他们可以为项目贡献内容，但不能管理项目。
   >* 具有“审阅”许可证的用户对已转换问题的项目具有“查看”权限，但其“查看”权限有限。
   ...
   >* 在为特定类型的对象配置访问级别设置时，该配置不会影响用户对级别较低的对象的访问。 例如，您可以限制用户删除其访问级别中的项目，但这并不限制用户删除排名低于项目的任务。有关对象层次结构的详细信息，请参阅部分 [对象的相互依赖和层次结构](../../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md#understanding-interdependency-and-hierarchy-of-objects) 在文章中 [了解Adobe Workfront中的对象](../../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md).


1. （可选）单击 **设置共享默认值** ，则 **添加规则** 为新项目添加共享规则。

   当具有此访问级别的用户创建项目时，该项目将自动与您在左侧菜单中选择的用户共享。

   ![](assets/project-sharing-menu.png)

   在右侧的菜单中，您可以指定希望如何与这些用户共享项目：

   ![](assets/project-sharing-right-menu.png)

   >[!NOTE]
   >
   >如果具有此访问级别的用户正在使用项目访问模板，则模板将覆盖访问级别中的共享设置。 有关项目访问模板的信息，请参阅 [在Adobe Workfront中共享项目](../../../workfront-basics/grant-and-request-access-to-objects/share-a-project.md).

   您可以重复此步骤，以根据需要添加任意数量的项目共享规则来设置访问级别。
...
有关每个访问级别中的用户可以处理问题的信息，请参阅部分 [项目](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md#projects) 在文章中 [可用于每种对象类型的功能](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md).

## 访问共享项目

作为问题的所有者或创建者，您可以通过授予其他用户对该问题的权限与其共享，如 [在Adobe Workfront中共享项目](../../../workfront-basics/grant-and-request-access-to-objects/share-a-project.md).
