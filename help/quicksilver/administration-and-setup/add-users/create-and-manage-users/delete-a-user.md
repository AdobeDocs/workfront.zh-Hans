...
* 删除该用户与以下对象的关联：
   ...
   * 仪表板
     ...
     >若要了解更多信息，请参阅[如何访问包含已删除用户所拥有报表的仪表板？](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md#how)报告常见问题解答[文章的](../../../reports-and-dashboards/reports/tips-tricks-and-troubleshooting/reports-faq.md)部分。
