...
Sam需要不同方式访问A机构和B机构的项目。这两个代理都在Workfront中设置为组。 （有关组的信息，请参阅[组概述](/help/quicksilver/administration-and-setup/manage-groups/groups-overview/groups-overview.md)。）
...
* 企业配置文件仅适用于具有Workflow Ultimate包的组织。
