...
&#42; 具有“请求”许可证的用户只能查看与其共享的报告、功能板和日历。

>[!NOTE]
>
>具有“审阅”许可证或“请求”许可证的用户共享功能有限。 有关更多信息，请参阅 [Adobe Workfront许可证概述](../../../administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md).
>
