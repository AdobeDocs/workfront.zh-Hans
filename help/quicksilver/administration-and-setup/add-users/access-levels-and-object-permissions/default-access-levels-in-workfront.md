...
# Adobe Workfront中内置的旧版访问级别

六个内置旧版访问级别中的每个级别都针对特定类型的用户而设计：
...
根据旧版访问级别，大多数Workfront对象类型最多可使用3个设置：
...
如果您需要自定义的“计划员”、“工人”、“请求者”或“审核者”访问级别，则可以复制内置的旧版访问级别并确定您希望它允许的各种Workfront对象类型的访问量。 有关创建自定义访问级别或修改其中一个内置旧版访问级别的信息，请参阅 [创建或修改自定义访问级别](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md).

>[!IMPORTANT]
>
>我们强烈建议您保持内置旧版访问级别不变，以便在设置用户后，您可以参考这些级别。
...
此内置的旧版访问级别附加到“计划”许可证，专为负责管理Adobe Workfront系统的用户而设计。 您无法修改此内置访问级别。

具有系统管理员旧版访问权限级别的用户可以在Workfront中执行所有操作。 他们可以查看和编辑所有其他用户在Workfront中输入的所有Workfront对象和信息。
...
您可以创建计划员内置旧版访问级别的自定义版本，并确定它允许的各种Workfront对象类型的访问量。 有关更多信息，请参阅 [Adobe Workfront中的内置访问级别](#Customiz) 在本文中。

以下是计划员旧版访问级别中对象可用的最高访问设置：
...
您可以创建Worker内置旧版访问级别的自定义版本，并确定它允许对各种Workfront对象类型的访问量。 有关更多信息，请参阅 [Adobe Workfront中的内置访问级别](#Customiz) 在本文中。
...
您可以创建Reviewer内置旧版访问级别的自定义版本，并确定它允许对各种Workfront对象类型的访问量。 有关更多信息，请参阅 [Adobe Workfront中的内置访问级别](#Customiz) 在本文中。
...
您可以创建Requester内置旧版访问级别的自定义版本，并确定它允许对各种Workfront对象类型的访问量。 有关更多信息，请参阅 [Adobe Workfront中的内置访问级别](#Customiz) 在本文中。
