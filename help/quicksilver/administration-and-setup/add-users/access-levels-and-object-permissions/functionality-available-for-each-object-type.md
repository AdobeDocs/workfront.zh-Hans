...
>[!NOTE]
>
>本文介绍了可用于访问当前Workfront包模型中的级别的功能。 要查看新包模型中可用的功能，请参阅[新访问级别中每个对象类型可用的功能](/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/functionality-available-for-objects.md)。

## 项目

只有拥有计划许可证的用户才能被授予对项目的完全访问权限。

| 操作 | 规划者 | 员工 | 审阅者 | 请求者 | 外部用户 |
|---|---|---|---|---|---|
| 创建 | ✓&#42; |  |  |  |  |
| 复制 | ✓&#42; |  |  |  |  |
| 删除 | ✓&#42; |  |  |  |  |
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>✓*<p><b>注意</b>：您无法作为系统管理员的任何用户登录。</p></td> 
   <td> </td> 
   <td> </td> 
   <td> </td> 
   <td> </td> 
...
| 添加或编辑计划和计划的成本信息&#42; | ✓ | ✓ | ✓ |  |  |
| 删除计划和计划 | ✓ | ✓ | ✓ |  |  |
| 在主菜单![方案规划器图标](assets/esp-icon-in-main-menu.png)中查看方案 | ✓ | ✓ | ✓ | |  |
| 查看用户创建的计划和计划&#42; | ✓ | ✓ | ✓ |  |  |
