...
1. 在屏幕左侧的&#x200B;**新字段**&#x200B;选项卡中，找到&#x200B;**外部查找**&#x200B;或&#x200B;**多选外部查找**，并将其拖动到画布上的部分。
1. 在屏幕右侧，配置自定义字段的选项：
...
此列表显示自定义表单可用的本地字段，以及可在其中使用每个字段的对象类型。
...
* **转换的问题发起人**：项目
* **货币**：项目，模板
* **描述**：项目、任务、问题、模板、模板任务、Portfolio、项目、组、文档、费率卡、工作角色
* **工期**：任务，模板任务
* **持续时间类型**：任务、模板任务
* **持续时间单位**：任务、模板任务
* **输入者**：项目、任务、问题、模板、模板任务、组
* **输入日期**：项目、任务、问题、模板、模板任务、组
* **汇率日期**：项目
* **固定成本**：项目，模板
* **固定收入**：项目、模板、记帐记录
* **组**：项目、模板、Portfolio、项目、公司、费率卡
* **问题类型**：问题
* **迭代**：任务
* **上次更新者**：项目、任务、问题、模板、模板任务
* **上次更新日期**：项目、任务、问题、模板、模板任务
* **名称**：项目，任务，问题，模板，模板任务， Portfolio，项目，组，文档，公司，费率卡，工作角色
* **所有者**：项目、模板、Portfolio、项目群
* **绩效指数方法**：项目，模板
* **计划的收益**：项目，模板
* **计划完成日期**：项目、任务、问题
* **计划持续时间**：项目、模板
...
>
>要访问Workfront Planning，您必须具有其他包。
>
