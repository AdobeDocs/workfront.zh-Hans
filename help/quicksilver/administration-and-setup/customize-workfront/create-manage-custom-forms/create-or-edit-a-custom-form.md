...
有关从现有表单创建新自定义表单的信息，请参阅[复制自定义表单以使用旧表单生成器创建新表单](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/copy-custom-form-to-create-a-new-one.md)。
...
1. 在打开的&#x200B;**表单设置**&#x200B;选项卡上，为自定义表单键入&#x200B;**表单标题**&#x200B;和可选的&#x200B;**描述**。

1. （可选）如果要向表单添加更多对象类型，以便将其附加到更多对象，请单击&#x200B;**对象类型**&#x200B;后面的&#x200B;**加号**，然后在显示的菜单中选择所需的对象类型。

   您可以重复此操作，以添加所需数量的对象类型。

1. （可选）单击对象类型上的&#x200B;**X**&#x200B;以将其从表单中删除。
...
1. 如果要向表单中添加新的自定义字段，请继续[向自定义表单中添加自定义字段](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md)或[在自定义表单中重用自定义字段或小组件](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)。
...
>[!CAUTION]
>
>有关从自定义表单中删除字段而不丢失用户在这些字段输入的数据的信息，请参阅[删除自定义字段而不丢失用户在这些字段输入的数据](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/delete-a-custom-field.md#remove)一节[从系统中删除自定义字段或小组件](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/delete-a-custom-field.md)。
>
...
1. （可选）要更改自定义表单的标题和说明，请单击&#x200B;**表单设置**&#x200B;选项卡，然后键入&#x200B;**表单标题**&#x200B;和&#x200B;**说明**。

1. （可选）如果要向表单添加更多对象类型，以便将其附加到更多对象，请单击&#x200B;**对象类型**&#x200B;后面的加号+，然后在显示的菜单中选择所需的类型。

   ![](assets/add-object-type-existing-form.png)

   您可以重复此操作，以添加所需数量的对象类型。

   也可以单击对象类型上的X将其从表单中删除。 当您想要从已保存的自定义表单中删除对象类型时，应谨慎执行此操作。 有关详细信息，请参阅[删除自定义表单上的对象类型](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)。
