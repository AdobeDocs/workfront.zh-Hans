...
默认布局是主菜单![主菜单图标](assets/main-menu-icon-left-nav.png)、左侧面板以及Adobe Workfront管理员使用布局模板进行任何更改之前的视图、分组和筛选器的排列。
...
下表显示了默认的主菜单项以及针对每种旧版许可证类型显示的左面板项：

<table class="tg"><thead>
  <tr>
    <th class="tg-0lax"><span style="font-weight:bold">区域</span></th>
