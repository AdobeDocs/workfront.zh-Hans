...
1. 在 **顶部导航区域**，单击 **选择登陆页面**，然后选择您希望用户登录时看到的区域。

   >[!IMPORTANT]
   >
   >要查看“场景和目标”区域，需要额外的许可证。 有关Workfront目标的信息，请参阅 [Adobe Workfront目标概述](../../../workfront-goals/goal-management/wf-goals-overview.md) 或有关Workfront Scenario Planner的信息，请参阅 [Scenario Planner概述](../../../scenario-planner/scenario-planner-overview.md).
