...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>“任一”</p>
       <p>将自定义应用程序添加到左侧面板仅适用于获得Adobe App Builder许可的组织。</p></td> 
  </tr> 
  <tr> 
...
1. 单击![自定义用户看到的内容](assets/dropdown-arrow.png)下的向下箭头&#x200B;**[!UICONTROL 向下箭头]**，然后单击要自定义其左侧面板的对象类型或[!DNL Workfront]区域的名称。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td>[!UICONTROL 项目]</td> 
      <td>[！UICONTROL主菜单]中的项目<img src="assets/projects-in-main-menu.png"> <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL 项目]</td> 
     </tr> 
     <tr> 
      <td><span class="preview">[！UICONTROL资源]</span></td> 
      <td><span class="preview">[！UICONTROL主菜单]中的[！UICONTROL资源] <img src="assets/main-menu-icon-left-nav.png"></span></td> 
      <td><span class="preview">[！UICONTROL Planner]（无法隐藏）、[！UICONTROL工作负载均衡器]、[！UICONTROL利用率]、[！UICONTROL资源池]</span></td> 
     </tr> 
     <tr> 
      <td>[！UICONTROL请求]</td> 
      <td>请求的名称</td> 
     ...
     <tr> 
       <td><span class="preview">[！UICONTROL用户详细信息]</span></td> 
       <td><span class="preview">用户的名称</span></td> 
       <td><span class="preview">[！UICONTROL详细信息]、[！UICONTROL组织结构图]、[！UICONTROL休息时间]、[！UICONTROL自定义Forms]、[！UICONTROL业务配置文件]、[！UICONTROL更新]、[！UICONTROL工作负载均衡器]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[！UICONTROL速率卡]</span></td> 
       <td><span class="preview">费率卡的名称</span></td> 
       <td><span class="preview">[！UICONTROL工作角色和费率]、[！UICONTROL费率卡详细信息]、[！UICONTROL费用类型和费率]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[！UICONTROL组]</span></td> 
       <td><span class="preview">组的名称</span></td> 
       <td><span class="preview">[！UICONTROL组成员]、[！UICONTROL子组成员]、[！UICONTROL组详细信息]、[！UICONTROL项目首选项]、[！UICONTROL任务和问题首选项]、[！UICONTROL时间表和小时数]、[！UICONTROL子组]、[！UICONTROL状态]、[！UICONTROL事件通知]、[！UICONTROL项目组合]、[！UICONTROL uicontrol项目]、[！UICONTROL项目]、[！UICONTROL模板]、[！UICONTROL最近删除]、[！UICONTROL最近恢复]、[！UICONTROL批准]、[！UICONTROL公司]、[！UICONTROL团队]、[！UICONTROL计划]、[！UICONTROL时间表配置文件]、[！UICONTROL布局模板]</span></td> 
     </tr>
     <!--
      <tr> 
       <td>Company</td> 
...
1. （可选）如果要添加链接到贵组织某个功能板的左侧面板项，请单击“添加功能板”****，键入该项的&#x200B;**[!UICONTROL 快速链接名称]**，然后选择该功能板。
   ...
   >[!NOTE]
   >
   >用户可以将自定义功能板项目添加到他们自己的左侧面板。 在布局模板中添加自定义仪表板项目时，除了它们所添加的项目外，还会显示您的项目，而不会覆盖或重置这些项目。 如果将用户分配给具有自定义仪表板项目的新布局模板，也是如此。 有关用户如何自定义左侧面板的信息，请参阅[在Workfront对象或区域的左侧面板中添加仪表板](../../../workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/create-custom-tabs.md)。
   >
