...
1. 单击![自定义用户看到的内容](assets/dropdown-arrow.png)下的向下箭头&#x200B;**[!UICONTROL 向下箭头]**，然后单击要自定义其左侧面板的对象类型或[!DNL Workfront]区域的名称。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td>[!UICONTROL 资源]</td> 
      <td>[!UICONTROL 主菜单]中的[!UICONTROL 资源] <img src="assets/main-menu-icon-left-nav.png"></td> 
      <td>[!UICONTROL Planner]（无法隐藏）、[!UICONTROL 工作负载均衡器]、[!UICONTROL 利用率]、[!UICONTROL 资源池]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL 请求]</td> 
      <td>请求的名称</td> 
