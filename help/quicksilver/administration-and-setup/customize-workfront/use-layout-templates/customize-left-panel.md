...
1. 单击![自定义用户看到的内容](assets/dropdown-arrow.png)下的向下箭头&#x200B;**[!UICONTROL 向下箭头]**，然后单击要自定义其左侧面板的对象类型或[!DNL Workfront]区域的名称。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td><span class="preview">[!UICONTROL 资源]</span></td> 
      <td><span class="preview">[!UICONTROL 主菜单]中的[!UICONTROL 资源] <img src="assets/main-menu-icon-left-nav.png"></span></td> 
      <td><span class="preview">[!UICONTROL Planner]（无法隐藏）、[!UICONTROL 工作负载均衡器]、[!UICONTROL 利用率]、[!UICONTROL 资源池]</span></td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL 请求]</td> 
      <td>请求的名称</td> 
     ...
     <tr> 
       <td><span class="preview">[!UICONTROL 用户详细信息]</span></td> 
       <td><span class="preview">用户的名称</span></td> 
       <td><span class="preview">[!UICONTROL 详细信息]、[!UICONTROL 组织结构图]、[!UICONTROL 休息时间]、[!UICONTROL 自定义Forms]、[!UICONTROL 业务配置文件]、[!UICONTROL 更新]、[!UICONTROL 工作负载均衡器]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[!UICONTROL 速率卡]</span></td> 
       <td><span class="preview">费率卡的名称</span></td> 
       <td><span class="preview">[!UICONTROL 工作角色和费率]、[!UICONTROL 费率卡详细信息]、[!UICONTROL 费用类型和费率]</span></td> 
     </tr>
     <tr> 
       <td><span class="preview">[!UICONTROL 组]</span></td> 
       <td><span class="preview">组的名称</span></td> 
       <td><span class="preview">[!UICONTROL 组成员]、[!UICONTROL 子组成员]、[!UICONTROL 组详细信息]、[!UICONTROL 项目首选项]、[!UICONTROL 任务和问题首选项]、[!UICONTROL 时间表和小时数]、[!UICONTROL 子组]、[!UICONTROL 状态]、[!UICONTROL 事件通知]、[!UICONTROL 项目组合]、[!UICONTROL uicontrol项目]、[!UICONTROL 项目]、[!UICONTROL 模板]、[!UICONTROL 最近删除]、[!UICONTROL 最近恢复]、[!UICONTROL 批准]、[!UICONTROL 公司]、[!UICONTROL 团队]、[!UICONTROL 计划]、[!UICONTROL 时间表配置文件]、[!UICONTROL 布局模板]</span></td> 
     </tr>
     <!--
      <tr> 
       <td>Company</td> 
