...
description: Blueprint提供基本的构建基块来帮助您创建随您发展的工作管理系统。 所有 [!DNL Adobe Workfront] 用户都可以浏览Blueprint的目录。 如果管理员已启用Blueprint请求，则还可以请求让 [!DNL Workfront] 管理员为您安装特定的Blueprint。
author: Courtney
...
Blueprint提供基本的构建基块来帮助您创建随您发展的工作管理系统。 所有[!DNL Adobe Workfront]用户都可以浏览Blueprint的目录。 此外，如果您的管理员启用了Blueprint请求，您还可以请求让[!DNL Workfront]管理员为您安装特定的Blueprint。
...
1. （可选）在Blueprint上单击&#x200B;**[!UICONTROL 详细信息]**，了解其工作方式。

   有关[!UICONTROL 详细信息]页面上可用内容的信息，请参阅[Blueprints概述](../../administration-and-setup/blueprints/blueprints-overview.md)。
