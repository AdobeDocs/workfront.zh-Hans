...
**[!UICONTROL 基线仪表板]**
此Blueprint包含一个功能板，可帮助您做出更智能、更快的项目决策。 基线使您能够比较计划的内容和发生的情况，让您一眼就发现问题任务、范围潜移和项目趋势。 基线仪表板包括以下报告：基线|进行中项目、基线|已完成项目、基线|进行中任务和基线|已完成任务。
...
**[!UICONTROL 数字资产生产] （集成）**
集成流程的[!UICONTROL 数字资产生产] Blueprint包含用于组织标准数字生产流程的工作的模板。 该模板为团队的原始数字资产创建提供了一个精益流程，该流程依赖于标准工序来定义工作方式，并且仅使用项目来排列工作的优先顺序并跟踪进度。

**[!UICONTROL 数字资产生产] （托管）**
[!UICONTROL Digital Asset Production]包中包含一个模板，该模板可为标准数字生产流程组织工作。 它旨在作为管理Workfront中数字资源创建的入口点。 使用此资源包为数字内容创作奠定基础，然后对其进行自定义以满足其他创意过程对数字材料的需求。

**[!UICONTROL 数字资产修订版] （集成）**
集成流程的[!UICONTROL Digital Asset版本] Blueprint包含单个模板，用于组织与修订现有资产关联的工作流程。 该模板为依赖标准操作程序来定义工作方式的团队提供了一个精益流程，并且仅使用项目来排列工作的优先顺序并跟踪进度。
