...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>设置汇率：任何Workfront或Workflow包</p>
       <p>要将有效日期应用于汇率：工作流Ultimate包</p></td> 
  </tr> 
  <tr> 
...
1. （可选）要更改基本（默认）货币，请执行下列操作之一：
   ...
   * 将鼠标悬停在货币名称上，然后单击显示的&#x200B;**更多**&#x200B;菜单。 然后，选择&#x200B;**设为默认值**。
     ...
     新的默认货币已更新，其图标为![默认货币图标](assets/default-icon.png)。
...
1. 单击&#x200B;**项目首选项** > **汇率**。
1. 在列表中选择一种货币，然后单击操作栏上的&#x200B;**管理日期**。
1. 在&#x200B;**（货币名称）日期有效汇率**&#x200B;对话框中，为当前汇率选择&#x200B;**结束日期**。

   或

   为新汇率选择&#x200B;**开始日期**。

   第一个汇率没有开始日期，最后一个汇率没有结束日期。 某些日期会自动添加。 例如，如果第一个汇率没有结束日期，并且您添加的汇率的开始日期为2025年12月1日，则结束日期为2025年11月30日，这样第一个汇率中就不会存在任何差额。

   ![有效汇率对话框](assets/euro-date-effective-rates.png)
