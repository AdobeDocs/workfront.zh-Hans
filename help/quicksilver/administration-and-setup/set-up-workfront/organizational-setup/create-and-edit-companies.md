...
1. 更新&#x200B;**基本信息**&#x200B;部分中的以下信息：
   ...
   * **是主要的**：将公司指定为组织的主要公司。 主要公司通常表示您的大多数用户工作的Workfront帐户。
...
通过访问[!UICONTROL 公司]页面，组管理员可以将组分配给公司，但该公司必须是组管理员创建的公司。 如果组管理员的访问权限级别未配置为对公司的管理访问权限，则组管理员创建公司时需要[!UICONTROL 组]字段，星号指示如下：
