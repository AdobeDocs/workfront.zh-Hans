...
title: 创建和编辑公司
description: 您可以将公司添加到 [!DNL Adobe Workfront] 并将它们用于财务规划、报告、定义对象相关权限以及保密信息。
author: Lisa
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>下列选项之一：</p> 
    <ul> 
     <li> <p>[！UICONTROL系统管理员]访问级别，允许您编辑系统中的任何公司。 有关更多信息，请参阅 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/grant-a-user-full-administrative-access.md">授予用户完全管理权限</a>. </p> </li> 
     <li> <p>管理公司的管理权限，允许您编辑系统中的任何公司。 有关更多信息，请参阅 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/grant-users-admin-access-certain-areas.md">授予用户对特定区域的管理访问权限</a>.</p> </li> 
    </ul> <p><b>注意</b>：  
     <ul> 
...
1. 如果要添加公司，请单击 **[!UICONTROL 新建公司]**.
   ...
   如果您正在编辑现有公司，请选择该公司，然后单击 **[!UICONTROL 编辑]** 在公司名单的顶端。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>如果存在您想添加到公司但在中不可用的字段 [!DNL Workfront]，您可以构建自定义表单并将其与您的公司关联。 </p> <p>您可以从下拉菜单中选择此表单，以将其附加到您的公司。</p> <p>下拉菜单中仅列出活动的自定义表单。</p> <p> 有关创建自定义Forms的信息，请参阅 <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md" class="MCXref xref">创建或编辑自定义表单</a>. </p> </td> 
     </tr> 
    </tbody> 
   </table>

1. （视情况而定）如果要创建公司，请单击 **[!UICONTROL 创建公司]**.
...
有关在公司层覆盖计费率的信息，请参阅 [覆盖公司级别的工作角色记帐费率](/help/quicksilver/administration-and-setup/set-up-workfront/organizational-setup/override-job-role-billing-rates-company-level.md).
