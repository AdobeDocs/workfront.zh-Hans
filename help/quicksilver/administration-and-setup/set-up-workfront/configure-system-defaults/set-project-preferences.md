...
<tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <span class="preview">自定义季度区域已从“预览”环境中的“项目首选项”部分删除。</span> 
   <span class="preview">有关详细信息，请参阅<a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/enable-custom-quarters-projects.md" class="MCXref xref" data-mc-variable-override="">启用自定义季度</a>。</p></span>
   <p>在生产环境中，为将处理项目的用户配置自定义年度季度。 自定义季度通常是不匹配日历年内传统季度划分的季度。 您可以添加多个自定义季度。   <p><b>注释</b>： </p><p>[!DNL Workfront] 管理员无法解锁[!UICONTROL 自定义季度]首选项，并且组管理员无法在组级别编辑这些设置。</p> </td> 
  </tr> 
 </tbody> 
</table>
