...
费率卡允许您根据位置为每个角色定义多个计费费率。 您可以让位于巴黎的设计师担任工作角色，让位于纽约的设计师担任第二个工作角色，每个角色具有不同的计费率。 但是，费率卡上的工作角色不需要位置。 费率卡上工作角色（以及可能的地点）的计费费率还可以包括有效日期。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>要编辑与您共享的费率卡，您必须拥有该费率卡的“管理”权限。</td> 
  </tr> 
 </tbody> 
</table>
...
1. 单击 [!UICONTROL **新建费率卡**]，然后在列表中输入费率卡名称和描述。
1. 要添加记帐费率，请单击列表中的费率卡名称。
1. 在信息卡屏幕上，单击 [!UICONTROL **新记帐费率**].
1. 在“新建记帐费率”对话框中，选择 [!UICONTROL **工作角色**] 以定义记帐费率。
...
1. 在 [!UICONTROL **记帐费率1**] 字段中，输入此位置的记帐费率。 然后，单击 [!UICONTROL **保存**] 以一次性覆盖记帐费率。
   ...
   单击 [!UICONTROL **添加费率**] 以添加更多具有有效日期的特定于地点的开单费率。
...
1. （视情况而定）如果要为此地点添加多个开单费率，请输入以下信息：
   ...
   * **[!UICONTROL 结束日期]：** 费率覆盖结束的日期。
     ...
     记帐费率1没有开始日期，最后一个记帐费率没有结束日期。 某些日期会自动添加。 例如，如果记帐费率1没有结束日期，而您添加的开单费率2的开始日期为2023年5月1日，则结束日期为2023年4月30日将添加到记帐费率1，这样不存在任何间隔。

1. 单击&#x200B;[!UICONTROL **保存**]。
1. （可选）要为其他位置的同一工作角色或单独的工作角色添加其他记帐费率，请单击 [!UICONTROL **新记帐费率**].
...
1. 在左侧面板中，单击 [!UICONTROL **费率卡**].
1. 选中列表中评级卡旁边的复选框，然后单击 **复制** 图标 ![“复制”图标](assets/copy-icon.png).

   添加了重复费率卡。 单击列表中的费率卡名称以更改其名称。
...
1. 在左侧面板中，单击 [!UICONTROL **费率卡**].
1. 选中列表中评级卡旁边的复选框，然后单击 **删除** 图标 ![“删除”图标](assets/delete.png).
