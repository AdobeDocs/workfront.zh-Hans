...
description: Adobe Workfront从2011年12月31日起改用100%软件即服务模式，并停止销售内部部署软件。 自2014年起，不再支持AtTask OnPremise，许可证密钥相关问题除外。 内部部署应用程序不再可用于下载或安装。
...
Adobe Workfront从2011年12月31日起改用100%软件即服务模式，并停止销售内部部署软件。 自2014年起，不再支持AtTask OnPremise，许可证密钥相关问题除外。 内部部署应用程序不再可用于下载或安装。
...
如果您需要新的许可证密钥，请拨打844-306-HELP(4357)联系Workfront客户支持部门。

获得新的许可证密钥后，

1. 停止atTask服务器。
1. 重命名当前的license.key文件（位于AtTaskDoc文件夹中）。
