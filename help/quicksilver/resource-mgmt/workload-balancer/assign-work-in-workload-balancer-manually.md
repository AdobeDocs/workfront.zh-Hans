...
1. 单击 **更多菜单** ![](assets/qs-more-menu.png) 的工作项名称左侧，然后单击 **将此分派至**.
...
1. 执行下列操作之一：
   ...
   * 开始键入要分配给项目中的用户、工作角色或团队的名称 **搜索人员、角色或团队** 字段中，将其在列表中显示时选中，然后单击 **保存**.
   ...
   >[!TIP]
   >
   > 如果您的Workfront或组管理员在环境中启用了委托，请使用“工作总揽”选项卡将用户分配给任务或问题。 使用“委派”选项卡可查看被委派给工作项目的用户。 有关委托工作的信息，请参阅 [管理任务和问题委派](../../manage-work/delegate-work/how-to-delegate-work.md).
   ...
   * 单击 **高级** 以访问高级工作。
     ...
     有关创建高级工作分配的更多信息，请参见 [创建高级工作](../../manage-work/tasks/assign-tasks/create-advanced-assignments.md).
