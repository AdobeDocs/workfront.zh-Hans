...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>访问级别配置</td> 
   <td> <p>编辑对资源管理的访问权限，包括访问资源规划者中的编辑优先级和预算小时数</p> <p>编辑对财务数据的访问权限，包括对“编辑成本率”和“编辑常规财务”的访问权限，可按成本预算资源</p> <p>编辑对项目和用户的访问权限</p></td> 
  </tr> 
  <tr> 
   <td>对象权限</td> 
...
1. 要分配工作角色的预算，请执行以下操作之一：
   ...
   * 单击工作角色的&#x200B;**更多**&#x200B;菜单，然后单击&#x200B;**将项目的计划小时数设置为预算。**&#x200B;角色预算小时数使用以下公式计算：\
     &#x200B;*
