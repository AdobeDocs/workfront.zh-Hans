...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>访问级别配置</td> 
   <td> <p>编辑对资源管理的访问权限，包括访问资源规划者中的编辑优先级和预算小时数</p> <p>编辑对财务数据的访问权限，包括对“编辑成本率”和“编辑常规财务”的访问权限</p>
   <p>编辑对项目和用户的访问权限</p></td> 
  </tr> 
  <tr> 
   <td>对象权限</td> 
   <td> <p>通过编辑成本率和编辑常规财务管理功能管理要为其预算信息的项目的权限</p></td>
  </tr> 
 </tbody> 
</table>
