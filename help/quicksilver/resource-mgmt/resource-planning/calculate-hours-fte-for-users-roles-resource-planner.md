...
* 小时差异\
  有关此值表示什么的详细信息，请参阅资源规划者](../../resource-mgmt/resource-planning/overview-of-planner-hour-fte-cost-information-in-role-project-views.md)的项目和角色视图中的[小时概述、FTE和成本信息。
