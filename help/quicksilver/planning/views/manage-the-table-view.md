...
* 您可以引用与当前记录类型相距最多4级的字段。 例如，如果要为活动记录类型创建过滤器，并且该活动连接到产品记录类型，而该产品记录类型连接到营销活动记录类型，而该营销活动记录类型又连接到Workfront项目，则可以在为活动记录类型创建的过滤器中引用项目所有者。
...
* 您可以引用与当前记录类型相距最多4级的字段。 例如，如果要为活动记录类型创建分组，并且活动连接到产品记录类型，而产品记录类型连接到营销活动记录类型，而营销活动记录类型又连接到Workfront项目，则可以在为活动记录类型创建的分组中引用项目所有者。
...
* 您可以引用与当前记录类型相距最多4级的字段。 例如，如果要为活动记录类型创建排序，并且活动连接到产品记录类型，而产品记录类型连接到市场活动记录类型，而市场活动记录类型连接到Workfront项目，则可以在为活动记录类型创建的排序中引用项目责任人。
