---
title: 层次结构和痕迹导航概述
description: 作为工作区管理员，您可以在Adobe Workfront Planning中的连接的记录类型和其他对象类型之间定义灵活但结构化的层次结构。 层级是记录类型之间或记录类型与Workfront项目之间的连接。
...
* 您不能在层次结构中添加以下对象类型：
  ...
  * 所有其他Workfront对象。
  * Adobe Experience Manager Assets或内容片段。
...
* 如果您的公司同时购买了Workfront和Planning软件包，则痕迹导航可以在Workfront和Planning中使用。
