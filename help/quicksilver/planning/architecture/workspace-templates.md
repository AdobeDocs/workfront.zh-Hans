...
* **基本：营销管理**：适用于为基本营销系统奠定基础的组织。 该模板包括以下记录类型和字段数，包括连接到其他记录类型的字段：
...
* **高级：营销管理**：适用于准备好探索更细微营销策略的团队。 该模板包括以下记录类型和字段数，包括连接到其他记录类型的字段：
...
* **企业：营销管理**：专为具有复杂营销系统的大型或成熟组织设计。 该模板包括以下记录类型和字段数，包括连接到其他记录类型的字段：
...
* **产品管理**：您可以使用此模板创建高效的结构化产品管理流程。 该模板包括以下记录类型和字段数，包括连接到其他记录类型的字段：
