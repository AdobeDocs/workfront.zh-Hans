...
## 在Workfront Planning中管理GenStudio工作区
...
1. 单击&#x200B;**其他工作区**，然后找到具有系统创建的指示且卡上有GenStudio标记的工作区。
...
1. 默认情况下，在Workfront Planning中创建和显示以下GenStudio记录类型：
   ...
   * 区域
   ...
   GenStudio记录类型上会显示它们最初是在GenStudio中创建的。
...
1. 执行下列操作之一：
   ...
   * 单击&#x200B;**共享**，然后单击&#x200B;**复制视图链接**&#x200B;以共享记录类型的链接，或单击&#x200B;**导出当前视图**&#x200B;以将其导出到文件。 只能导出表格视图。
   ...
   * 删除表视图中的记录。
     ...
     如果从Workfront中删除已删除的记录，则可以从Workfront Planning的表视图回收站中恢复这些记录。 有关信息，请参阅[恢复已删除的记录](/help/quicksilver/planning/records/restore-deleted-records.md)
