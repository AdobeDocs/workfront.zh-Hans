...
本文列出了在2024年8月28日正式发布之前2024年Workfront规划早期阶段发布的功能。
...
提供了一个新的“设置”选项，通过该选项，您可以在“日历”视图中个性化录制栏的外观。 您可以执行以下操作：
...
有关Workfront规划AI助手的详细信息，请参阅[Adobe Workfront规划AI助手概述](/help/quicksilver/planning/general/planning-ai-assistant-overview.md)。

### 使用画布功能板的Workfront Planning的报告功能

预览和生产： 2024年8月28日

您现在可以使用Workfront画布功能板在报表中查看Workfront计划信息。 有关信息，请参阅[画布功能板概述](/help/quicksilver/reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md)。
