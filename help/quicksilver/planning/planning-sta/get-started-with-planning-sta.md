...
通过Workfront Planning的集成版本，您可以：

* 将Planning对象连接到Workfront对象
* 将来自Workfront的现有自定义字段添加到Planning记录类型
* 根据规划信息自动创建Workfront项目
* 请参阅Workfront Canvas Dashboard报告系统中的规划信息

借助独立版本的Workfront Planning，您可以：

* 使用Workfront Planning独立开放API将Planning对象与任何其他应用程序<!--ask Lilit and I think this is an Integrated benefit also-->集成
