...
1. 访问讨论区。 有关信息，请参阅[创建或编辑展示板](../../agile/get-started-with-boards/create-edit-board.md)。
1. 单击讨论区名称旁边的&#x200B;**[!UICONTROL 更多]**&#x200B;菜单![更多菜单](assets/more-icon-spectrum.png)，然后选择&#x200B;**[!UICONTROL 标记管理器]**。

   ![选择标记管理器](assets/boards-tagmanager-350x189.png)

1. 在“[!UICONTROL 标记管理器]”对话框中，在“[!UICONTROL **讨论区标记**]”部分中选择“[!UICONTROL 添加标记]”。
1. 在高亮显示的框中键入标签名称，然后从下拉菜单中选择此标签的颜色。 标签会自动保存。
...
1. 在“[!UICONTROL 标记管理器]”对话框中，在“工作流标记”部分中选择“[!UICONTROL **添加标记**]”。
1. 在高亮显示的框中键入标签名称，然后从下拉菜单中选择此标签的颜色。 标签会自动保存。
1. （有条件）重复步骤4-5以创建其他标签。
1. 单击框右上角的&#x200B;**[!UICONTROL 完成]**。
...
1. 在&#x200B;**[!UICONTROL 标签]**&#x200B;框中，键入现有标签的名称，然后从搜索结果中选择该标签。\
   或\
...
1. （有条件）单击标签名称可编辑文本。
1. （条件）单击[!UICONTROL 颜色]下拉菜单以更改标签颜色。
1. 单击&#x200B;**[!UICONTROL 完成]**。
...
1. 找到要从卡中删除的标签，然后单击&#x200B;**[!UICONTROL “删除”]**&#x200B;图标![“删除标签”](assets/copy-of-boards-remove-30x23.png)。
1. 单击&#x200B;**[!UICONTROL 关闭]**。
