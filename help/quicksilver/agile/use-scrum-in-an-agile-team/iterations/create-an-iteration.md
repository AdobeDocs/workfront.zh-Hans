...
title: 创建迭代
description: 迭代是Scrum Agile团队规划工作容量的关键组件。 [!DNL Adobe Workfront] 允许Scrum Agile团队通过创建多个迭代来满足团队需求来管理其工作。
author: Courtney
feature: Agile
...
迭代是Scrum敏捷团队规划工作容量的关键组件。 [!DNL Adobe Workfront]允许Scrum Agile团队通过创建多个迭代以适应团队需求来管理其工作。
