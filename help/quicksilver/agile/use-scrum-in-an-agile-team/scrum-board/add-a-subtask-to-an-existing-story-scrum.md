...
title: 将子任务添加到Scrum展示板上的现有文章
description: 为现有文章创建子任务时，请记住项目的“完成模式”设置，因为这将影响文章的更新方式。
author: Courtney
feature: Agile
...
# 向[!UICONTROL 脚本]展示板上的现有文章添加子任务

为现有文章创建子任务时，请牢记以下几点：

**当项目的[!UICONTROL 完成模式]设置设置为[!UICONTROL 手动]:**
...
## 向Scrum展示板上的现有文章添加子任务

{{step1-to-team}}

1. （可选）单击&#x200B;**[!UICONTROL 切换团队]**&#x200B;图标![切换团队图标](assets/switch-team-icon.png)，然后从下拉菜单中选择新的Scrum团队，或者在搜索栏中搜索团队。

1. 转到Agile小版本或项目，该项目包含要在其中添加子任务的情节。 有关如何导航到小版本的信息，请参阅[查看小版本](../../../agile/use-scrum-in-an-agile-team/iterations/view-iteration.md)。
...
1. 单击主故事卡上的&#x200B;**[!UICONTROL 添加子任务]**&#x200B;以创建子任务到故事。
   ...
   将子任务添加到当前没有泳道的文章时，父任务将提升到[!UICONTROL 父文章]列，并且子任务将在泳道内移动。
