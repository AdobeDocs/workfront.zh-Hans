...
1. 单击&#x200B;**[!UICONTROL 更多]**&#x200B;菜单![](assets/more-menu.png)，然后选择&#x200B;**[!UICONTROL 编辑]**。
   ...
   ![编辑团队](assets/edit-team-settings-kanban.png)
...
必须在[!UICONTROL Kanban]展示板上启用&#x200B;**显示积压**&#x200B;设置才能使用此功能。

每当一个故事从[!UICONTROL 进行中]列移动到故事板上代表[!UICONTROL 完成]状态（或相当于[!UICONTROL 完成]状态）的列时，“积压”列中的下一个故事就会自动移动到[!UICONTROL Kanban展示板]的[!UICONTROL 新建]列。

下一个案例是积压订单编号最低且满足以下所有条件的未完成案例：
...
积压工作顺序与优先级不同。 您可以通过拖放积压事项列中的故事来安排积压事项顺序。 积压工作最上面的故事是下一个被拉到板子上的故事。

要将积压中的故事自动添加到[!UICONTROL Kanban]展示板，请执行以下操作：
...
1. 选择要管理的Kanban团队。
1. 单击&#x200B;**[!UICONTROL 更多]**&#x200B;菜单![](assets/more-menu.png)，然后选择&#x200B;**[!UICONTROL 编辑]**。
1. 选择&#x200B;**[!UICONTROL 从积压工作自动添加下一个故事]**&#x200B;以将积压工作中的下一个项目配置为当某个项目移出&#x200B;**[!UICONTROL 进行中]**&#x200B;列时，自动添加到&#x200B;**[!UICONTROL 新建]**&#x200B;列。
