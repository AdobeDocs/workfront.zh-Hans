...
# 从[!UICONTROL Kanban]展示板中删除故事或问题

您可以从[!UICONTROL Kanban]展示板中删除故事或问题。 删除文章或问题后，该文章或问题将被移动到回收站保留30天，只有系统管理员才能恢复。
...
1. 单击文章或问题上的&#x200B;**[!UICONTROL 更多]**&#x200B;图标，然后选择&#x200B;**[!UICONTROL 删除]**。

   ![删除Kanban故事](assets/kanban-delete-story.png)
