...
title: 创造敏捷的故事
description: 您可以通过多种方式在迭代上创建一个Agile故事。 创建Agile文章后，您可以向文章添加子任务。
author: Courtney
feature: Agile
...
您可以通过多种方式在迭代上创建一个Agile故事。 创建Agile文章后，您可以向文章添加子任务。

在迭代中添加文章或子任务时，“持续时间类型”设置为[!UICONTROL 简单]，“任务约束”设置为“固定日期”，并且日期已在迭代中锁定。 不能在迭代中修改“工期类型”或“任务约束”。 此外，任务持续时间必须大于0分钟。

有关在将文章添加到小版本后如何对其进行管理的信息，请参阅[小版本](../../agile/use-scrum-in-an-agile-team/iterations/iterations.md)。
...
1. 转到要创建故事的敏捷迭代：
   ...
   ![将新文章添加到迭代](assets/iteration-stories-list.png)
   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>如果文章已准备好添加到小版本，请选择此选项。 选择此选项后，将向用户指示哪些积压工作中的文章已准备好添加到迭代。<br>可以将故事添加到迭代，无论它是否标记为<strong>[!UICONTROL 就绪]。</strong></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td>选择父项目后，您可以选择父任务。 选择父任务后，故事将作为选定项目上父任务的子任务创建。<br>开始键入文章的父任务的名称，然后在任务出现在下拉列表中时单击该名称。</td>
     </tr>
     <tr>
