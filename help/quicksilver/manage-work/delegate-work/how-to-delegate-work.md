...
* 此 [!DNL Workload Balancer] 手動指派任務或問題時
...
>[!TIP]
>
>委派任務和問題的計畫或實際時數未納入資源管理工具中，例如 [!DNL Workload Balancer] 或 [!DNL Resource Planner] 適用於委派的使用者。 時數僅與指派的使用者相關聯。
