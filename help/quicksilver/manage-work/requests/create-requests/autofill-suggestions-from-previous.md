---
title: 使用来自先前请求的数据自动完成请求
content-type: reference
description: 您可以使用AI通过来自先前请求的数据自动完成请求字段。
author: Becky
...
自动完成可以在您填写表单时建议字段值。 在请求字段中输入值时，Workfront会将这些值与以前的请求进行比较。 如果输入的值与以前请求中类似上下文中的其他字段值紧密相关，则Workfront会推荐这些值。
