...
队列主题可与工艺路线规则配合使用，以自动将传入工作分配给用户、工作角色、团队，或将其置于项目中。 队列主题定义实施路由规则所需的条件。
...
1. 创建路由规则、主题组和自定义表单（如果计划将它们与队列主题相关联）。\
...
1. 转到您选择启用为帮助请求队列的项目以及要创建新队列主题的位置。\
   有关如何将项目指定为帮助请求队列的更多信息，请参阅以下文章：\
   [创建请求队列](../../../manage-work/requests/create-and-manage-request-queues/create-request-queue.md)

   您可以将相关队列主题组织在“主题组”下，也可以直接组织到指定为“帮助请求队列”的项目下。 这将在发出请求时为请求者提供一系列下拉菜单。\
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> 如果项目中没有主题组，则项目名称将默认为主题组。<br>如果要从此处创建其他主题组，请选择 <strong>创建新主题组</strong> 下拉菜单中。<br><img src="assets/create-new-topic-group-within-queue-topic-350x203.png" alt="create_new_topic_group_within_queue_topic.png" style="width: 350;height: 203;"></td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>将审批流程与此队列主题关联。 此下拉菜单中仅显示“问题批准流程”。 提交到此队列的所有问题都将与此批准流程相关联。 您的Adobe Workfront管理员必须先定义系统级别的批准流程，然后才能将它与队列主题相关联。 <span>对批准流程具有管理访问权限的用户也可以创建特定于组的批准流程。</span> 有关创建批准流程的详细信息，请参阅 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md" class="MCXref xref">为工作项创建批准流程</a>.<br></p> 
       <div> 
        <p>重要信息：如果项目组发生更改，则附加到现有问题的组特定审批流程将变成一次性审批流程。 有关对项目组的更改或审批流程中的更改如何影响审批设置的更多信息，请参阅 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/how-changes-affect-group-approvals.md" class="MCXref xref">组和审批流程更改如何影响分配的审批流程</a>.</p> 
        <p>将审批流程添加到队列主题时，请考虑以下事项： </p> 
        <ul style="list-style-type: circle;"> 
         <li>列表中仅显示有效的审批流程。 </li> 
         <li> <p>列表中将显示系统范围和组特定的批准流程。 与项目组以外的组关联的审批流程不会显示在列表中。</p> </li> 
        </ul> 
       </div> </td> 
     </tr> 
     <tr> 
...
1.  
1. 单击&#x200B;**保存**。\
   在选择“请求队列”和“主题组”后，“队列主题”现在可供使用，并且在Workfront的“请求”区域中可见。
