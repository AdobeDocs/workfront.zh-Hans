...
1. 从与您共享的每个实体的下拉菜单中，从以下各项中选择：
   ...
   * **管理**：具有这些权限的用户能够编辑或删除模板。
     ...
     有关此处提供的高级设置![齿轮图标](assets/gear-icon-in-access-levels.png)的信息，请参阅[共享模板](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md)一文中的[模板共享高级设置](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md#template-permissions)部分。
