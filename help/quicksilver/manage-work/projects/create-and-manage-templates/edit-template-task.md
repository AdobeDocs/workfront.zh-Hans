...
根据您选择编辑任务的环境，编辑模板任务会有所不同。

### 在生产环境中编辑模板任务

>[!NOTE]
>
><span class="preview">某些客户可以像在预览环境中编辑模板任务一样，在其生产环境中编辑模板任务。</span>
>
><span class="preview">有关在预览环境中编辑任务的信息，请参阅本文中的[在预览环境中编辑模板任务](#edit-template-tasks-in-the-preview-environment)部分。</span>
...
1. （视情况而定）要同时编辑有关模板任务或多个任务的所有信息，请单击从列表中选择这些任务，然后单击列表顶部的&#x200B;**编辑**&#x200B;图标![编辑图标](assets/edit-icon.png)。
...
1. 单击左侧面板中的&#x200B;**工作**。
   ...
   **工作**&#x200B;区域打开。
   ...
   ![模板任务中的工作分配](assets/assignments-edit-template-tasks-box.png)
...
1. 更新以下信息：
   ...
   <p><b>重要</b></p>
   <p>由于任务持续时间通常是计划开始日期和计划完成日期之间的时间量，因此它会影响项目的时间表。</p> 
