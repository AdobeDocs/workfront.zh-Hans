...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <p>在模板详细信息选项卡中编辑该模板的参与权限</p> 
     <p>管理在编辑模板框中编辑模板的权限</p>
   </td> 
  </tr> 
 </tbody> 
</table>
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>指定是使用小时数还是成本计算未来项目的实现值指标。 有关绩效指数方法的详细信息，请参阅<a href="../../../manage-work/projects/project-finances/set-pim.md" class="MCXref xref">设置绩效指数方法(PIM)</a>。 </p></td> 
     </tr>
     <tr> 
