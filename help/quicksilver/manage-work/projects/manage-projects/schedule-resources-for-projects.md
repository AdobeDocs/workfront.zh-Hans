...
title: 为项目计划资源
description: 您可以为单个项目计划资源，以指明每个资源被分配的工作以及完成工作所花费的时间。 您可以为项目计划资源，并在项目级别使用工作负载均衡器为每个资源分配小时数。
author: Alina, Lisa
...
您可以为单个项目计划资源，以指明每个资源被分配的工作以及完成工作所花费的时间。 您可以为项目计划资源，并在项目级别使用工作负载均衡器为每个资源分配小时数。
