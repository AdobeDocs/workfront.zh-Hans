...
* 如果任何自定义表单上的必填字段都附加到所有项目，并且您选择了一个字段而没有对其进行实际编辑，则必须放弃对该字段所做的更改或向其添加信息，然后才能保存您选择的项目。 如果您根本没有选择必填字段，则可以保存您选择的项目，即使必填字段为空也是如此。
...
1. 单击以在 **添加自定义表单** 或 **Forms添加** 子区域。
   ...
   当自定义表单已附加到某些选定项目时，表单名称旁会显示一个指示，指示在添加表单时，有多少项目已附加表单。
