...
![项目量度](assets/project-metrics-full-screen-350x238.png)
...
![项目量度](assets/project-metrics-kpis-350x52.png)
...
>![已完成的任务](assets/completed-tasks-dialog-350x75.png)\
...
![任务问题（按状态）](assets/project-metrics-task-issue-by-status-350x120.png)

在此图表中选择优先级后，您可以查看项目中任务或问题的所有优先级。

![按优先级列出的任务和问题](assets/project-metrics-task-issue-by-priority-350x121.png)

>[!TIP]
>
>要显示具有特定状态或优先级的工作项列表，请单击图表中的条形。 在该列表中，您可以单击特定工作项以在新选项卡中查看更多详细信息。\
>![已完成的任务框](assets/completed-tasks-dialog-350x75.png)\
>有关详细信息，请参阅[查看量度详细信息](#view-metrics-details)。
...
![按完成状态列出的任务或问题](assets/tasks-issues-by-complete-status-350x250.png)
...
![被分派人的任务和问题](assets/tasks-issues-by-assignee-350x104.png)
...
1. 在左侧面板中，单击&#x200B;**量度**。\
   ...
   ![指标部分](assets/metrics-section-350x298.png)

1. （视情况而定）如果图表上显示下拉箭头，请单击图表上的&#x200B;**下拉箭头**&#x200B;图标![下拉箭头](assets/dropdown-arrow.png)，然后从菜单中选择所需的选项。\
...
1. （可选）要更详细地了解页面上任何量度的任务或问题，请执行以下操作：
   ...
   1. 使用列表底部的箭头找到要查看的任务或问题。
      ...
      ![分页](assets/pagination-300x152.png)

   1. 选择任务或问题以查看更多详细信息。

      任务或问题将在新选项卡中打开。

1. （可选）要将项目量度仪表板导出到.png文件，请单击&#x200B;**导出**&#x200B;图标![导出图标](assets/export.png)，然后从下拉菜单中选择&#x200B;**导出为PNG**。
