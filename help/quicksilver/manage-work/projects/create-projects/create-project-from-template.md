...
1. 单击&#x200B;**收藏模板**&#x200B;列表中的模板名称。
   ...
   1. （有条件，可选）如果您选择了旧版存储模板，请选择“新建项目”框右下角的&#x200B;**在Adobe云存储中创建此项目**&#x200B;设置。 这将创建一个Adobe云存储项目。 不会将模板中的文档和文档文件夹添加到项目中。
   ...
   1. （可选）将鼠标悬停在左侧面板中模板名称的名称上，然后单击&#x200B;**收藏夹** **图标** ![收藏夹图标](assets/favorites-icon-small.png)以将其标记为收藏以供将来使用。
