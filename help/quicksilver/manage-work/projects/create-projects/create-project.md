...
* 在从Workfront Planning中的记录类型连接项目时添加项目。
  ...
  有关通过将项目添加到记录来创建项目的信息，请参阅[在将Workfront Planning中的项目与记录连接时，从Workfront Planning中创建Workfront对象](/help/quicksilver/planning/records/create-workfront-objects-from-workfront-planning.md)一节中的“将项目与Planning中的记录连接时创建项目”。

* 使用Workfront Planning自动化添加项目。
