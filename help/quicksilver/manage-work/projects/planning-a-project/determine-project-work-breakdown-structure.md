...
* 确定子任务之间和里程碑之间的依赖关系。\
  ...
  有关任务依赖性的信息，请参阅相关文章 [前置任务概述](../../../manage-work/tasks/use-prdcssrs/predecessors-overview.md) 和 [在任务列表上创建前置任务关系](../../../manage-work/tasks/use-prdcssrs/create-predecessors-on-task-list.md).

* 确定在项目生命周期的任何时间点，是否需要批准和审查。 创建批准流程以满足此需求。\
  有关批准的信息，请参阅文章 [创建工作项的审批流程](../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md).
...
* 任务约束定义任务工作必须开始或结束的时间。
  ...
  有关定义任务限制的信息，请参阅文章 [任务限制概述](../../../manage-work/tasks/task-constraints/task-constraint-overview.md).
...
有关计划资源的信息，请参阅 [工作负载均衡器：文章索引](../../../resource-mgmt/workload-balancer/workload-balancer.md) 部分。
