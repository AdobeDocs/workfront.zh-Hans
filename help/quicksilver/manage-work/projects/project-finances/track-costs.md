...
<tbody> 
  ...
  <tr> 
   ...
   <td> <p><span class="preview"><strong>计划成本</strong>按以下公式计算：</span></p> <p><span class="preview"><code style="font-style: normal;">Task Planned Cost = Task Planned Labor Cost + Task Planned Expense Cost</code> </span></p> <p><span class="preview">其中任务计划劳力成本的计算方式：</span></p> <p><span class="preview"><code>Planned Labor Cost = Planned Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> <p><span class="preview"><strong>实际成本</strong>按以下公式计算：</span></p> <p><span class="preview"><code style="font-style: normal;">Task Actual Cost = Task Actual Labor Cost + Task Actual Expense Cost</code> </span></p> <p><span class="preview">其中任务实际人工成本的计算方法为：</span></p> <p><span class="preview"><code>Task Actual Labor Cost = Actual Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> </td> 
  </tr> 
  <tr> 
   <td> <p>固定每小时</p> </td> 
