...
* 项目的计划收入按以下公式计算：
  ...
  有关如何计算任务计划收入的信息，请参阅 [基于用户和角色分配的任务的收入计算](#revenue-calculations-for-tasks-based-on-user-and-role-assignments) 章节。
