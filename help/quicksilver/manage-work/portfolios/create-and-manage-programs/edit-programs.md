...
1. 单击&#x200B;<span class="preview">**保存**</span>&#x200B;或&#x200B;**[!UICONTROL 保存更改]**，或继续编辑以下部分。
...
1. 更新自定义表单中的任何字段，然后单击&#x200B;<span class="preview">**保存**</span>&#x200B;或&#x200B;**[!UICONTROL 保存更改]**，或者继续下面的部分。

### [!UICONTROL 评论] {#comment}

1. 按如上所述开始编辑程序。
1. 单击&#x200B;**[!UICONTROL 评论]**。
1. 在&#x200B;**[!UICONTROL 为项目群发布更新]** / <span class="preview">**为每个项目群字段添加更新**</span>&#x200B;中添加注释。
1. （可选）单击&#x200B;**[!UICONTROL 人员]**&#x200B;图标以向评论添加用户或团队。
1. （可选）单击&#x200B;**[!UICONTROL 锁定]**&#x200B;图标<span class="preview">或选择&#x200B;[!UICONTROL **我的公司私有**]</span>&#x200B;以锁定评论并使其仅对公司中的用户私有。
