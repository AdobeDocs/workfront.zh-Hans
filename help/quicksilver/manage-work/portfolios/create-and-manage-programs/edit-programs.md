...
1. 请考虑在以下任意部分中指定信息：
   ...
   * [[!UICONTROL 评论]](#comment)
   ...
   >[!TIP]
   >
   >要一次为多个程序重新计算自定义字段，请选择一个列表中的多个程序，然后单击列表顶部的&#x200B;**更多**&#x200B;菜单![更多](assets/more-icon.png)，然后&#x200B;**重新计算表达式**。
...
1. 更新自定义表单中的任何字段，然后单击“**[!UICONTROL 保存]**”，或者继续下面的部分。
...
1. 单击&#x200B;**[!UICONTROL 评论]**。
   ...
   编辑程序框中的![评论框](assets/comment-box-on-edit-program.png)

1. 在&#x200B;**[!UICONTROL 为每个程序]**&#x200B;添加更新字段中添加评论。
