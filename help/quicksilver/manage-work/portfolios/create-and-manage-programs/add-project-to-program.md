...
1. （视情况而定）如果您选择&#x200B;**[!UICONTROL 现有项目]**，将打开&#x200B;<span class="preview">**添加项目**&#x200B;框</span>。<!--check at unshimming-->

   <span class="preview">![将现有项目添加到项目群框](assets/add-projects-to-programs-box.png)</span><!--check at unshimming-->
...
1. 执行以下操作：
   ...
   1. 在&#x200B;**[!UICONTROL 添加项目]**&#x200B;框中，在&#x200B;**将项目添加到此程序**&#x200B;字段中键入项目的名称，然后当它显示在列表中时将其选中。<!--check casing on links and buttons-->
      ...
      您可以添加多个项目。
   1. （可选）如果决定不将某个项目添加到项目，请单击该项目名称旁边的&#x200B;<span class="preview">**删除**&#x200B;图标![删除图标](assets/delete-icon.png)</span>。
