...
1. （视情况而定）如果您选择添加现有项目，将打开&#x200B;<span class="preview">**添加项目**&#x200B;框。</span> <!--check this after UI changes-->

   <span class="preview">![添加现有项目](assets/add-existing-projects-to-portfolios-box.png)</span> <!--check this after UI changes-->
