...
1. 单击&#x200B;**x图标**&#x200B;以关闭优化类别。
   ...
   有关[!UICONTROL Portfolio Optimizer]分数的信息，请参阅[Portfolio Optimizer[!UICONTROL 分数]的概述。](../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-score.md)
