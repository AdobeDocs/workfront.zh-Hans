...
* 在项目、任务和问题报告和列表中：
   ...
   * **传统实际小时数**：随时为项目、任务或问题记录的小时数，包括2021年5月之前的小时数。 它们以分钟的形式存储在Workfront数据库中，其valuefield为`actualWorkRequired`。<!--check below and see if you need to add this to the API section - asked on the tech doc task -->
