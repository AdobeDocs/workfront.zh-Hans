...
title: 分派任务
description: 您可以将任务分配给用户、角色、团队或工作代理，以指明负责完成任务的人员。 您可以一次将任务分配给多个资源。
author: Lisa
...
您可以将任务分配给用户、工作角色、团队或工作代理，以指明负责完成任务的人员。 您可以一次将任务分配给多个资源。
...
1. 执行下列操作之一：
   ...
   * 开始键入要分配的用户、工作角色、团队或工作代理的名称，然后在名称出现在列表中时单击该名称。

     >[!TIP]
     >
     >* 添加工作代理时，工作代理的名称仅为名字。 工作代理的姓氏为空。
...
1. 要分配任务，请执行下列操作之一：
   ...
   * 单击&#x200B;**工作总揽**&#x200B;字段并开始键入要分配给任务的活跃用户、工作角色、团队或工作代理的名称，然后在它显示在列表中时单击它。
...
1. 在&#x200B;**工作总揽**&#x200B;区域，在提供的&#x200B;**搜索人员、角色或团队**&#x200B;字段中开始键入用户、团队、角色或工作代理的名称，然后在他们显示在列表中时单击它们
