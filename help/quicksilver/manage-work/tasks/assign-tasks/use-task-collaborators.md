...
* 已为其分配任务协作者的任务变为准备开始，且任务协作者是唯一或主要任务接受者。 （例如，如果任务具有前置任务，则前置任务为完成。）
* 已为其分配任务协作者和用户的任务变为准备开始，任务协作者被首先分配或为主要被分配者。 （例如，如果任务具有前置任务，则前置任务为完成。）
...
* 任务协作者被分配给已经分配了任务协作者的任务。 在这种情况下，第一个分配的任务协作者将已开始工作，而第二个任务协作者将不执行任何操作。
