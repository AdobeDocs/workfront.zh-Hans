...
title: 编辑任务
description: 您可以编辑有关已创建、具有Contribute或Manage权限的任务的信息。
author: Alina
...
* 只有当Workfront管理员或组管理员在项目偏好设置区域中启用此功能时，您才能编辑文档并将其添加到状态为“完成”、“废弃”或“未决批准”的项目中的任务。 有关设置项目首选项的信息，请参阅 [配置系统范围的项目首选项](../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md).
...
1. 单击 **任务** 在左侧面板中。
1. 单击要编辑的任务。
1. （视情况而定）要编辑有关任务的有限信息，请单击 **任务详细信息** 在左侧面板中。
   ...
   * **财务**
   ...
   1. （可选）如果没有自定义表单附加到任务，请在任务的 **添加自定义表单** 字段，然后在列表中显示该字段时将其选定，然后单击 **保存更改**.
...
1. （视情况而定）要编辑有关任务的所有信息，请以对该任务具有管理权限的用户身份，单击 **更多** 菜单 ![](assets/more-icon.png) 单击任务名称旁边的，然后单击 **编辑**.
...
1. 更新关于任务的以下信息：
   ...
   您可以在任务标题中更新任务状态。 </p> </td>
     ...
     <tr> 
      ...
      <td> <p>通过指定任务限制来确定何时必须完成任务。 </p> <p>从以下选项中选择： </p> 
       <ul> 
      <li> <p><span>固定日期</span> </p> <p>指定 <strong>已计划开始</strong> 和 <strong>计划完成日期</strong>. </p> </li> 
     ...
     <tr> 
      ...
      <td> <p>任务计划开始的时间。 任务的计划开始日期受许多因素的影响和影响：</p> 
       <ul> 
      <li>根据系统范围对任务计划开始日期的偏好设置，项目上新任务的开始日期可以是今天，也可以是项目的开始日期（默认情况下）。 <span>与项目关联的组的组管理员也可以为组设置此首选项。</span> 有关系统级别或组级别任务首选项的详细信息，请参阅 <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-task-issue-preferences.md" class="MCXref xref">配置系统范围的任务和问题首选项</a>.</li> 
     ...
     <tr> 
      ...
      <li>如果任务的持续时间类型发生更改，并且任务上的资源数量同时发生更改，则计划完成日期也会发生更改。 有关持续时间类型的详细信息，请参见 <a href="../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md" class="MCXref xref">任务工期和工期类型概览</a>.</li> 
       </ul> </td> 
     </tr> 
     <tr> 
   ...
   更新工作量可能会更新任务计划小时数。 如果项目更新类型为“自动”，则立即进行更新。 当项目更新类型为手动时，您必须重新计算时间表以查看更新的计划小时数。 </p>
...
1. （有条件和可选）更新以下字段：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <li> <p> 任务的总持续时间。 </p> </li> 
       </ul> <p>您的Workfront管理员 <span> 或组管理员</span> 为系统或组中的任务选择默认持续时间类型设置。 有关设置项目默认值的信息，请参阅 <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md" class="MCXref xref">配置系统范围的项目首选项</a>. </p> <p>持续时间类型使您能够根据任务的需要设置一致的资源分配。 有关任务的持续时间类型的详细信息，请参阅 <a href="../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md" class="MCXref xref">任务工期和工期类型概览</a>. </p> <p>从以下选项中选择： </p> 
       <ul> 
      <li> <p>计算的分配量 </p> </li> 
      <li> <p> 计算的工作量 </p> </li> 
      <li> <p>投入比导向 </p> </li> 
   ...
   常规时间会考虑假日、周末和休息时间，并将它们排除在任务的持续时间之外。 有关任务持续时间的详细信息，请参阅 <a href="../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md" class="MCXref xref">任务工期和工期类型概览</a>. </p>
   </div> 
   </div> </td> 
   </tr> 
   <tr> 
   ...
   <td> <p>如果您的任务限制是计算的工作或投入比导向的，请指定 <strong>分配%</strong> （分配百分比）分配至每个被分配人。 这是指从被分派人计划起他们可在此任务上花费的时间。 更改被分配人的分配百分比将更改任务的已计划小时数。 </p> <p>当“任务约束”为“简单”时，可以指定以下内容：</p> 
      <ul> 
   ...
   <td> <p>从中选择角色 <strong>被分派人的角色</strong> 选择人员作为被分配人时的下拉菜单。 这是被分派人可以在这项任务上履行的职责。 </p> <p><b>提示</b>
...
可定义在将任务添加到项目时自动附加到任务的默认自定义表单。 有关设置项目以包含所有新任务的默认任务自定义表单的信息，请参阅文章中的“任务”部分 [编辑项目](../../../manage-work/projects/manage-projects/edit-projects.md).
...
1. 更新以下字段：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>以小时为单位指定均衡延迟。 </p> <p> 有关调配延迟的详细信息，请参见 <a href="../../../manage-work/tasks/task-information/task-leveling-delay.md" class="MCXref xref">更新任务均衡延迟</a>. </p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">审批流程</td> 
      <td> <p>选择要与任务关联的审批流程。 您的Workfront管理员必须定义系统级别的批准流程，然后才能将其与任务关联。 对审批流程具有管理权限的用户也可以创建特定于组的审批流程。 </p> <p>有关创建批准流程的详细信息，请参阅 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-approval-processes.md">创建工作项的审批流程</a>. 添加审批流程时，请考虑以下事项： </p> 
       <ul>
   ...
   如果项目组发生更改，则以前附加的组特定审批流程会变成一次性审批流程。 有关对项目组的更改或审批流程中的更改如何影响审批设置的更多信息，请参阅 <a href="../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/how-changes-affect-group-approvals.md">组和审批流程更改如何影响分配的审批流程</a>. </p>

   </li>

   <li> <p>您可以定义在任务添加到项目时自动附加到任务的默认审批流程。 有关设置项目以包含默认任务审批流程的信息，请参阅文章中的“任务”部分 <a href="../../../manage-work/projects/manage-projects/edit-projects.md" class="MCXref xref">编辑项目</a>. </p> </li>
...
* 计划完成日期和时间
  ...
  >[!CAUTION]
  >
  >某些任务约束和其他依赖关系可能会阻止您编辑此字段。 有关任务限制的信息，请参见 [任务限制概述](../../../manage-work/tasks/task-constraints/task-constraint-overview.md).
