---
title: 访问概述
description: 使用Adobe Workfront规划存在许可证和共享权限限制。
hidefromtoc: true
hide: true
...
使用Adobe Workfront规划存在许可证和共享权限限制。

## 访问要求

要使用Adobe Workfront规划，您必须具有以下设置：
...
<td>
 ...
 <td role="rowheader"><p>Adobe Workfront协议</p></td>
   <td>
<p>贵组织必须注册Adobe Workfront计划封闭测试版计划。 </p>
   </td>
  </tr>
  <tr>
...
贵组织在注册Workfront计划测试版计划后，可使用版面模板将“计划”区域添加到所有用户的主菜单。
...
您的Adobe Workfront许可证类型可与Workfront规划权限配合使用，让您有权查看、贡献或管理Workfront规划对象。

有关许可证类型如何影响Workfront规划对象的权限级别的信息，请参阅 [使用Adobe Workfront规划时的许可证类型概述](/help/quicksilver/maestro/access/license-type-overview.md).
