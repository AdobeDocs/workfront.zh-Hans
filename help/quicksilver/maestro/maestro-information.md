...
description: 作为营销运营负责人，您可以使用Adobe Workfront规划来组织所有团队在营销生命周期中的工作。 此部分中的文章介绍如何配置规划功能，以及如何开始将它们用作营销活动管理操作的一部分。
hidefromtoc: true
hide: true
...
您可以使用此页面作为所有与Adobe Workfront规划相关的文档的起点。

以下各节中的文章介绍了如何配置Workfront规划并开始使用它。
...
* [Adobe Workfront计划发布活动](../maestro/release-activity.md)：列出了自2023年5月22日Adobe Workfront计划结束测试版项目启动以来发布的所有功能，包括确切的发布日期以及每项功能的简短概述。
* Workfront Fusion的Adobe大师模块

## Workfront规划架构和功能

以下部分包含详细介绍Workfront Planning当前可用功能的文章：

* [访问：文章索引](../maestro/access/access-information.md)：有关使用Workfront规划所需的访问权限的信息。
* [架构：文章索引](../maestro/architecture/architecture-information.md)：有关Workfront规划的架构的深入信息，其中包含有关如何创建和管理工作区和记录类型的分步说明。
