---
title: Adobe Workfront目标：文章索引
description: Adobe Workfront目标将战略与工作执行和交付联系起来，帮助您定义、传达和实现战略成果。 请参阅以下部分中的文章，了解如何设置和管理组织中的目标，以及驱动这些目标的因素。
author: Alina
draft: Probably
...
Adobe Workfront目标将战略与工作执行和交付联系起来，帮助您定义、传达和实现战略成果。

请参阅以下部分中的文章，了解如何设置和管理组织中的目标，以及驱动这些目标的因素：

* [Adobe Workfront目标概述](../workfront-goals/goal-management/wf-goals-overview.md)
* [Adobe Workfront目标中的目标管理：文章索引](../workfront-goals/goal-management/goal-management.md)
* [Adobe Workfront目标中的目标对齐方式：文章索引](../workfront-goals/goal-alignment/goal-alignment.md)
