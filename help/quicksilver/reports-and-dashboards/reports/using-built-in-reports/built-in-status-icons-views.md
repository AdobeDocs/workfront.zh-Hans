...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>指示项目的完成情况符合目标（绿色）、存在问题（红色）或处于风险（黄色）。<br>有关项目完成情况的信息，请参阅<a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref">项目完成情况和完成情况类型概述</a>。</td> 
   <td>项目</td> 
   <td>单击以打开项目的任务列表。 </td> 
   <td> </td> 
  </tr> 
