...
* “状态图标”字段中的大多数指示器都是指向其表示的实际对象或对象区域的快速链接。

* 如果对象中缺少由图标表示的任何项目，则表示缺少项目的图标在“状态图标”列中将显示为灰色，而不是彩色图像。

  ![task_status_icons.png](assets/task-status-icons.png)

  欲了解更多信息，请参见 [状态图标和标志概览](#overview-of-status-icons-and-flags) 章节。

* 在某些观点中， **状态图标** 字段已命名 **标志** 或 **查看图标**.\
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>编辑对筛选器、视图、分组的访问权限</p> <p>编辑对报告、功能板、日历的访问权限以向报告添加列</p> <p>注意：如果您仍然没有访问权限，请咨询Workfront管理员是否对您的访问级别设置了其他限制。 有关Workfront管理员如何修改您的访问级别的信息，请参阅 <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">创建或修改自定义访问级别</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">对象权限</td> 
   <td> <p>管理现有视图的权限</p> <p>管理对报告的权限以向其添加列</p> <p>有关请求其他访问权限的信息，请参阅 <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">请求访问对象 </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
要将“状态图标”字段添加到从头开始构建的自定义视图中，请执行以下操作：
...
1. 转到以下任意对象的列表：
   ...
   * 用户\
     只有这些对象具有 **状态图标** 字段可用。\
     有关对象列表的信息，请参见 [开始使用Adobe Workfront中的列表](../../../workfront-basics/navigate-workfront/use-lists/view-items-in-a-list.md).

1. 从 **视图** 下拉菜单，选择 **新建视图**.

1. 单击 **添加列**.
1. 在 **显示在此列中** 框中，开始键入以下任何字段名称，然后当它出现在列表中时将其选中：
   ...
   * *查看图标*（仅在文档视图中）。
   ...
   内置图标会列在任意这些名称下。\
   “模板”视图同时包含 **状态图标** 和 **标志** 字段。 在这种情况下，两列包含相同的图标。\
   文档视图包含 **查看图标** 字段。
...
1. （可选）单击图标以转到由其表示的对象区域。\
   并非所有图标都是指向对象的链接。\
   有关每个图标的完整属性列表，请参阅 [状态图标和标志概览](#overview-of-status-icons-and-flags) 部分。

## 状态图标和标志概览 {#overview-of-status-icons-and-flags}

下表列出了Workfront中可用的所有状态图标、可以与其关联的对象类型，以及单击这些图标时会发生什么情况。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>表示项目的完成情况符合目标（绿色）、存在问题（红色）或处于风险中（黄色）。<br>有关项目完成情况的信息，请参阅 <a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref">项目完成情况和完成情况类型概览</a>.</td> 
   <td>项目</td> 
   <td>单击以打开项目的任务列表。 </td> 
   <td> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td>表示存在最终解决该问题的解决对象。 在这种情况下，无法完成问题。 解析对象完成时完成。 <br>有关解析对象的信息，请参阅 <a href="../../../manage-work/issues/convert-issues/resolving-and-resolvable-objects.md" class="MCXref xref">解析和可解析对象概述 </a>.</td> 
   <td>问题</td> 
   <td>单击以打开问题的解决对象。 </td> 
   <td> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td>用户分配选项卡的快捷方式。 </td> 
   <td>用户</td> 
   <td>单击以打开用户的“分配”选项卡，并了解分配给用户的工作项。</td> 
   <td> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>表示费用可记帐。<br>有关费用的信息，请参阅 <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">管理项目支出 </a>.</td> 
   <td>费用</td> 
   <td>不可用</td> 
   <td> </td> 
  </tr> 
  <tr> 
   ...
   <td> 指示费用是可退还。<br>有关费用的信息，请参阅 <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">管理项目支出 </a>.</td> 
   <td>费用</td> 
   <td>不可用</td> 
   <td> </td> 
  </tr> 
  <tr> 
   ...
   <td> 指示费用已退还。<br>有关费用的信息，请参阅 <a href="../../../manage-work/projects/project-finances/manage-project-expenses.md" class="MCXref xref">管理项目支出 </a>.</td> 
   <td>费用</td> 
   <td>不可用</td> 
   <td> </td> 
  </tr> 
