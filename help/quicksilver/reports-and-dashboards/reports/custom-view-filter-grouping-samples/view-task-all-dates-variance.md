...
此任务视图类似于您的Adobe Workfront帐户提供的“所有日期”视图。 此特定视图包括 *变量* 列，用于计算以下日期之间的天数差异：
...
有关在视图中使用计算的更多信息，请参见 [文本模式的常见用途概述](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md) 中的部分  [文本模式的常见用途概述](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md).
