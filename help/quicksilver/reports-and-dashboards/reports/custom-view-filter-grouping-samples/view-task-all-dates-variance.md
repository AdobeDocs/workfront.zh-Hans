...
description: 此任務檢視類似於您的Adobe Workfront帳戶隨附的「所有日期」檢視。 此特定檢視包含「差異」欄，可計算下列日期（編輯我）之間的天數差異。
...
此任務檢視類似於您的Adobe Workfront帳戶隨附的「所有日期」檢視。 此特定檢視包括 *變數* 欄，計算下列日期之間的天數差異：
...
此檢視代表計算欄的範例，您可以在此範例中取得兩個不同欄的值，然後透過計算將它們連線起來，以取得第三個值。 在此情況下，您會從日期2減去日期1。

如需在檢視中使用計算的詳細資訊，請參閱 [文字模式的常見用途概觀](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md) 中的區段  [文字模式的常見用途概觀](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md).
