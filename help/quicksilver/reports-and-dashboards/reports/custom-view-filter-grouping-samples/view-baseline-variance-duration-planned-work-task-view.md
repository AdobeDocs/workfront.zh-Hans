...
title: 「檢視：任務檢視中工期與計畫工時的比較基準差異」
description: 此檢視在任務檢視中顯示以下內容 — 編輯我。
...
>[!NOTE]
>
> 下列檢視中顯示的資料會比較實際作業值與與「預設基準線」作業相關的值。
