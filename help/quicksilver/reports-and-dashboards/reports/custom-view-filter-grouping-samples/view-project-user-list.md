...
>[!TIP]
>
>如果沒有為使用者列出職務角色，但您知道他們與其使用者設定檔中的職務角色相關聯，這可能表示他們被指派給任務和問題，但他們可能未與任務或問題上的職務角色相關聯，或者報告中列出的使用者不是任務和問題的受指派人，而是履行專案上的其他角色（例如，所有者或贊助者）。
