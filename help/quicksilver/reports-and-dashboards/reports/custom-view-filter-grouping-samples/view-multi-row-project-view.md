...
* 以多行格式显示项目信息。\
  ...
  标签组合同一列标题下的多个字段。要了解有关此标记的更多信息，请参阅[视图：合并一个共享列中多个列的信息](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-merge-columns.md)。
...
1. 创建新的项目视图。有关如何创建新视图的更多信息，请参阅Adobe Workfront中的[视图概述](../../../reports-and-dashboards/reports/reporting-elements/views-overview.md)。
