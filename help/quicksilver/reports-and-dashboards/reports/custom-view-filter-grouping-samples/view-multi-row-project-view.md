...
* 以多列格式顯示專案資訊。\
   ...
   標籤以組合相同欄標題下的多個欄位。 若要進一步瞭解此標籤，請參閱 [檢視：合併一個共用欄中多個欄的資訊](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-merge-columns.md).
