...
title: “查看：解决对象详细信息问题
description: 此问题视图显示问题解决对象的名称和完成百分比，从而使问题发起者能够洞察问题的进度，即使没有解决任务或项目的访问权限也是如此。
...
此问题视图显示问题解决对象的名称和完成百分比，从而使问题发起者能够洞察问题的进度，即使没有解决任务或项目的访问权限也是如此。
