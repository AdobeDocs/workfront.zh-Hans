...
1. （可选） **分组列**：选择此选项可定义您希望如何对列进行分组。\
   ...
   * 从&#x200B;**分组数据依据**&#x200B;下拉菜单中选择要在图表中包含的分组。
   * （可选）单击&#x200B;**自定义颜色**&#x200B;以自定义列的颜色。\
     有关自定义图表颜色的详细信息，请参阅[自定义图表颜色](#customize-chart-colors)。

1. （可选）单击&#x200B;**组合图表**，以便在图表中包含其他值，以及您希望如何汇总信息。\
   请考虑以下选项：
...
1. 在&#x200B;**值**&#x200B;字段中，选择要显示在报表中的值，然后在&#x200B;**汇总方式**&#x200B;字段中选择汇总信息的方式。 如果选择&#x200B;**记录计数**，则显示的值是报表的对象。

1. 在&#x200B;**指示器**&#x200B;字段中，选择要包含在图表中的分组。 分组由图表上的指示线表示。\
   如果分组包含两个项目，则图表上将显示两个指示符。\
   例如，如果您有一个“项目状态分组”，并且有两个项目状态（“当前”和“暂挂”），则量规图表包含两个量规指示符。 他们会指出处于该状态的项目数量。\
...
1. 在&#x200B;**底部(X)轴字段**&#x200B;中，选择要包含在图表的X轴上的值。 值来自报表视图。 指定希望如何汇总信息。
