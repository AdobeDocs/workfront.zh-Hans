...
在使用里程碑视图之前，需要配置里程碑，需要向项目添加里程碑路径，并且里程碑需要与任务关联，如文章中所述 [创建里程碑路径](../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-milestone-path.md) 和 [将里程碑与任务关联](../../../manage-work/tasks/manage-tasks/associate-milestones-with-tasks.md).
...
1. 单击 **视图** 下拉菜单，然后单击 **里程碑**.
   ...
   有关里程碑视图的信息，请参阅部分 [里程碑视图概述](#milestone-view-overview) 本文章中。
...
有关如何切换到里程碑视图的信息，请参阅部分 [切换到里程碑视图](#switch-to-the-milestone-view) 本文章中。
...
* **计划日期或预计日期：** 指定是要在“里程碑”视图中显示计划日期，还是显示预计日期。\
  将显示开始日期和完成日期，以及里程碑路径中每个里程碑的日期。\
  如果您查看的是计划日期，并且您还拥有项目的“管理”访问权限，则可以直接从“里程碑”视图中编辑以下日期：（如果您查看的是预计日期，则无法编辑日期，因为预计日期已经计算并且无法手动更改。）

   * **项目开始日期：** 如果从起始日期开始计划项目，您可以人工更改项目的起始日期，然后计算完成日期。
   * **项目完成日期：** 如果从完成日期开始计划项目，您可以人工更改项目的完成日期，然后计算开始日期。
   * **任务完成日期：** 您可以直接从“里程碑”视图中手动更新任务的完成情况。

* **完成百分比：** 显示每个任务和项目的完成百分比。\
  您可以禁用显示完成百分比，如一节中所述 [配置里程碑视图中显示的信息](#configure-what-information-displays-in-the-milestone-view) 本文章中。\
  您可以直接从“里程碑”视图中调整完成百分比，如一节中所述 [调整“里程碑”视图中任务的完成百分比](#adjust-percent-complete-for-tasks-in-the-milestone-view) 本文章中。

* **任务状态图标：** “里程碑”视图中的每个项目和任务旁边会显示一个状态图标。
  ...
  您可以禁用这些状态图标的显示，如一节中所述 [配置里程碑视图中显示的信息](#configure-what-information-displays-in-the-milestone-view) 本文章中。\
  有关每种状态类型的更多详细信息，请参阅文章 [任务进度状态概述](../../../manage-work/tasks/task-information/task-progress-status.md).

* **已完成任务的任务状态底纹**：将任务标记为“完成”后，任务的背景将在“里程碑”视图中加阴影，以指示任务是按时完成还是延迟完成：

   * **任务列的红色底纹**：当进度状态为“ ”时，任务的背景为红色 **晚的**.

   * **任务列的绿色底纹**：当进度状态为“ ”时，任务的背景为绿色 **准时**.

* **项目开始和完成列的项目状态底纹**：

   * **项目开始列**：只有在填充了实际开始日期时，项目开始列的背景才显示为红色或绿色：

      * **项目开始列的红色底纹**：当项目的进度状态为时，项目开始列的背景为红色 **晚的**.

      * **项目开始列的绿色底纹**：当项目的进度状态为时，项目开始列的背景为绿色 **准时**.

   * **“项目完成”列**：只有在填写了实际完成日期时，项目完成列的背景才显示为红色或绿色：

      * **项目完成列的红色底纹**：当项目的进度状态为时，项目完成列的背景为红色 **晚的**.

      * **项目完成列的绿色底纹**：当项目的进度状态为时，项目完成列的背景为绿色 **准时**.

   * 当任务的进度状态为“风险”或“落后”时，不会为“开始”和“完成”列分配颜色底纹。

  ![带有底纹的里程碑视图](assets/milestone-view-with-shading.png)

* **项目名称**：显示项目名称时会包含指向项目的链接。
* **项目完成情况图标**：在项目名称旁显示一个图标，用于指示项目的条件。
...
1. 单击 **视图** 下拉菜单，然后单击 **里程碑**.\
   如果您查看的是Portfolio或项目群内的项目列表，请选择 **里程碑** 子选项卡。
...
1. （视情况而定）如果“里程碑”视图中当前未显示完成百分比，请单击 **选项** （位于里程碑视图右上角），然后确保 **完成百分比** 已启用。
