...
1. 执行下列操作之一：
   ...
   1. 要从列表中访问分组，请转到该列表，然后从&#x200B;**分组**&#x200B;下拉菜单中，将鼠标悬停在要修改的分组上，然后单击&#x200B;**编辑**&#x200B;图标![编辑图标](assets/edit-icon.png)。
