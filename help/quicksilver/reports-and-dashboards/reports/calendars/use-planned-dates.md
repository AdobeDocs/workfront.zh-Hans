...
title: 在日历报表中使用计划日期
description: 日历报告是一种动态报告，以可视方式呈现您的工作。 您可以在日历报表中将“计划日期”字段用于任务、问题和项目。
author: Courtney
...
# 在日历报表中使用[!UICONTROL 计划日期]

<!--
<span class="preview">The highlighted information on this page refers to functionality not yet generally available. It is available only in the Preview Sandbox environment.</span> 
-->

日历报告是一种动态报告，以可视方式呈现您的工作。 您可以在日历报表中为以下对象使用[!UICONTROL 计划日期]字段：
...
单击“**[!UICONTROL +新建日历]**”并输入日历名称。
   ...
   >[!NOTE]
   >
   >您必须对访问级别中的报告、仪表板和日历具有编辑访问权限，才能创建日历报告。
...
1. 在&#x200B;**[!UICONTROL 中，您想要向日历添加什么？]**&#x200B;部分，选择
...
1. 单击&#x200B;**[!UICONTROL 添加任务]**、**[!UICONTROL 添加项目]**&#x200B;或&#x200B;**[!UICONTROL 添加问题]**，具体取决于要添加到日历的对象类型。

1. 在下拉菜单中，开始键入字段名称，然后选择要在日历上显示的对象的字段源（例如，**[!UICONTROL 延迟任务]**）。
1. 为日历分组设置条件语句。


   ![为日历选择对象](assets/calendar-field-name.png)

   要了解如何设置条件，请参阅[筛选器和条件修饰符](../../../reports-and-dashboards/reports/reporting-elements/filter-condition-modifiers.md)。

1. （可选）通过重复步骤1-4，为日历分组指定其他对象。

1. 在&#x200B;**[!UICONTROL 将任务/项目/问题标签设置为……]**&#x200B;字段中，选择日历中如何标记此日历分组中的对象。

   >[!NOTE]
   >
   >如果某个对象没有默认的标签选项，则会显示相应的对象名称。 例如，当选择“[!UICONTROL 父任务]”标签且没有与该对象关联的父任务时，[!DNL Adobe Workfront]将显示您在日历中查看的对象名称。
