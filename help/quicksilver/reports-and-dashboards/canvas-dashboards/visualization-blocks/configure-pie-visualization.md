...
1. 首先，向报表添加一个可视化图表块，该可视化图表块具有&#x200B;**饼图**&#x200B;可视化图表类型，如[在报表画布](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md)中添加或编辑可视化图表块中所述。
