...
1. <span class="preview">（可选）在提供的空间中添加轴标签。</span>
1. <span class="preview"> （可选）切换&#x200B;**隐藏轴**&#x200B;打开。</span>
1. <span class="preview">（可选）输入&#x200B;**参考线值**&#x200B;以在图表上设置目标或阈值。</span>
1. 从下拉菜单中选择&#x200B;**行类型**。
...
1. <span class="preview"> （可选）在&#x200B;**饼图**&#x200B;节中，将&#x200B;**显示区段标签**&#x200B;切换为显示区段标签。</span>
1. <span class="preview"> （可选）打开&#x200B;**显示总计**&#x200B;以在图表中间显示总计。 启用时，还有其他选项可显示中心标签并选择值格式。</span>
...
1. <span class="preview">（可选）在“图例”部分中，将&#x200B;**显示图例**&#x200B;切换为打开以显示图表图例。</span>

1. <span class="preview"> （可选）从下拉菜单中选择&#x200B;**图例位置**。</span>
