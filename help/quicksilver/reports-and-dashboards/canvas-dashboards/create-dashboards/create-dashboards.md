   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>选择仪表板的默认货币类型。 <br>
      <br>用户可在筛选仪表板时切换不同的货币类型。 有关详细信息，请参阅<a href="/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/filter-canvas-dashboard.md">按货币类型筛选仪表板</a>。</td>
     </tr>
    </tbody>
   </table>
