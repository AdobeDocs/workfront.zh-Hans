   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>选择仪表板的默认货币类型。</p>
      <p>在筛选功能板时，您可以在不同的货币类型之间切换。 有关详细信息，请参阅<a href="/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/filter-canvas-dashboard.md">按货币类型筛选仪表板</a>。</p>
      <p><strong>注意：</strong>如果在Workfront实例中只定义了一种货币，则在创建仪表板时不会看到“货币”字段。</p></td>
     </tr>
    </tbody>
   </table>
