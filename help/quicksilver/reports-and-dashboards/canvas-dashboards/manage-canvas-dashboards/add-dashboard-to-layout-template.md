...
title: 将画布仪表板添加到布局模板
description: 您可以将画布仪表板添加到布局模板，以使其替换主页登陆页面、显示在对象的左侧面板中或固定到顶栏。
author: Courtney
...
1. 单击&#x200B;**添加**。 仪表板会显示在左侧面板部分。

1. 单击&#x200B;**保存**。

   >[!NOTE]
   >
   >当置于工作对象(如“项目”、“任务”、“问题”、“Portfolio”或“项目群”)上时，每个报告中显示的结果将仅限于该对象内可用的记录。
...
1. 在&#x200B;**顶部导航区域**&#x200B;部分，单击&#x200B;**选择登陆页面**，然后在下拉列表中选择&#x200B;**添加仪表板**。

1. 在&#x200B;**添加自定义仪表板**&#x200B;框中，输入&#x200B;**快速链接名称**。

1. 在&#x200B;**选择仪表板**&#x200B;下拉列表中，选择&#x200B;**画布仪表板**。

1. 在&#x200B;**选择一个仪表板**&#x200B;右侧的下拉列表中，选择要添加为主页登陆页面的画布仪表板。
