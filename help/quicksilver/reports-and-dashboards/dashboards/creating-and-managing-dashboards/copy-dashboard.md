...
1. 要选择现有仪表板上的所有项目并将它们复制到复制的仪表板，请保留&#x200B;**选择全部**。 默认情况下，现有仪表板上的报告、日历或列表将被复制到新仪表板。\
   ...
   * **制作副本：**&#x200B;该项从原始功能板复制，该项的新版本将显示在新功能板中。 对新功能板上的项目所做的更改不会反映到原始功能板上的项目中。 同样，对原始仪表板上的项目所做的更改不会反映在新仪表板上的项目中。\
     当您想要修改原始仪表板上的原始报表时，请使用此选项。\
     例如，您可以复制一个名为“Team B”的功能板，并将其重命名为“Team A”。 在“B组”仪表板上，有一个名为“B组报告”的报告。 由于此报表包含特定于团队B的数据，因此您可以选择复制此报表的选项，以便您能够为团队A自定义该报表，并稍后将其重命名为“团队A报表”。\
     使用此选项，可以从复制的报表中删除原始报表的共享权限。 使用信息访问权限运行此报告在复制的报告中保持不变。

   * **使用原始：**&#x200B;在新功能板上显示原始项目。 对新功能板上的项目所做的更改也会反映到原始功能板上的项目中。 同样，对原始仪表板上的项目所做的更改会反映在新仪表板上的项目中。\
     通过此选项，您可以保留原始报表的共享权限。 “Run this report with the Access Rights of information”也仍然完好。
...
1. （可选）如果要在复制的控制板上编辑任何复制的报告、日历和外部页面，请执行以下任一操作：
   ...
   * 要修改使用此信息访问权限运行此报告，请单击新仪表板上的报告名称，然后单击&#x200B;**报告操作** > **编辑** > **报告选项**。\
     复制报表后，仅在以下情况下才维护具有访问权限的“运行此报表”：

     （如果以上任何条件均不成立，则删除了“使用权限运行此报告”，并将新的“使用访问权限运行此报告”更改为创建复制报表的用户。）

     如果复制功能板及其报表的用户具有管理员访问权限。

      * 如果复制功能板及其报表的用户具有管理员访问权限。
      * 如果复制功能板及其报表的用户当前被设置为“运行此报表”，并且所复制报表的访问权限为。
      * 如果复制报表的用户对报表具有“管理”权限。
