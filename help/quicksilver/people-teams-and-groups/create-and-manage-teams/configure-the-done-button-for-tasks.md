...
* 如果用户已分配主团队、[!DNL Workfront]管理员或具有[!UICONTROL Standard]或[!UICONTROL Plan]许可证的用户，则可以配置[!UICONTROL Done]按钮以反映团队成员的特定状态。 请参阅本文中的[为团队](#configure-the-uicontrol-done-button-for-a-team)配置[!UICONTROL 完成]按钮。
