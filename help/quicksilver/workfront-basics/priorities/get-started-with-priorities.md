...
Workfront管理员可以在布局模板中为您的用户启用优先级。 有关详细信息，请参阅[使用布局模板自定义主菜单](/help/quicksilver/administration-and-setup/customize-workfront/use-layout-templates/customize-main-menu.md)。
...
![我的焦点](assets/my-focus-060226.png)
