...
>[!IMPORTANT]
>
>如果左侧面板默认只显示一个部分（如&#x200B;**[!UICONTROL 项目]**&#x200B;区域中的&#x200B;**[!UICONTROL 所有项目]**），则在构建布局模板时，[!DNL Workfront]管理员必须向该区域添加至少一个仪表板并分配给该模板，左侧面板才会显示在该区域中。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"><strong>规划者</strong></td> 
...
<table style="table-layout:auto">
    ...
    <tr>
        <td><strong>[!UICONTROL 功能板]</strong></td>
        <td>您可以查看您的[!DNL Workfront]管理员添加到布局模板中[!UICONTROL 项目]区域左侧面板的所有仪表板。 这些功能板的名称已针对您的环境进行了自定义。</td>
    </tr>
</table>
...
<table style="table-layout:auto">
    <tr>
        ...
        <td>显示您有权查看的所有目标。 有关详细信息，请参阅<a href="../../workfront-goals/goal-review-and-workfront-goals-sections/manage-goals-in-goal-list.md">的[!UICONTROL 目标列表]中的[!DNL Adobe Workfront Goals]</a>管理目标。</td>
    </tr>
    <tr>
...
1. （视情况而定）如果您选择的区域包含对象列表，如&#x200B;**[!UICONTROL 项目]**&#x200B;或&#x200B;**[!UICONTROL 项目组合]**，则必须执行以下操作才能访问左侧面板导航：
