...
![顶部导航栏](assets/wf-top-navigation-070626.png)
...
**[!UICONTROL 主菜单]**&#x200B;图标![主菜单](assets/main-menu-icon-left-nav.png)打开[!UICONTROL 主菜单]，您可以在此处导航到Workfront的其他区域。
...
* **许可证类型**：要了解不同许可证类型的默认配置，请参阅[了解轻型许可证用户的导航](../../workfront-basics/navigate-workfront/workfront-navigation/reviewer-global-navigation-bar.md)或[了解[!UICONTROL 工作]许可证用户的导航](../../workfront-basics/navigate-workfront/workfront-navigation/worker-global-navigation-bar.md)。
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>[!UICONTROL 讨论区]： <a href="/help/quicksilver/agile/boards-overview.md">讨论区概述</a></li>
     <li>[!UICONTROL Blueprints]： <a href="/help/quicksilver/administration-and-setup/blueprints/blueprints-overview.md">Blueprints概述</a></li>
     <li>[!UICONTROL 优先级]： <a href="/help/quicksilver/workfront-basics/priorities/get-started-with-priorities.md">优先级入门</a></li>
...
**[!UICONTROL 收藏夹]**&#x200B;图标![收藏夹](assets/favorites-icon.png)会打开系统中已标记为收藏的页面的列表。 通过此菜单，您可以添加当前所在的页面。

要了解有关收藏夹的详细信息，请参阅[查看和管理收藏夹](../../workfront-basics/navigate-workfront/recent-and-favorites/view-and-manage-favorites.md)。

## [!UICONTROL 最近访问]菜单

**[!UICONTROL 最近]**&#x200B;图标![[!UICONTROL 最近]](assets/recents-icon.png)打开了您最近访问的页面列表。
