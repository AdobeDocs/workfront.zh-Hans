...
1. 单击 **[!UICONTROL 摘要]** 图标 ![](assets/qs-summary-in-new-toolbar-small.png)
   ...
   单击 **[!UICONTROL 打开摘要]** 图标 ![](assets/open-summary-with-text-nwe.png) 在 [!UICONTROL 已提交] 部分 [!UICONTROL 请求] 区域。
...
1. （可选）要关闭 [!UICONTROL 摘要] 执行下面操作之一：
   ...
   * 在 [!UICONTROL 已提交] 部分 [!UICONTROL 请求] 区域，单击 **[!UICONTROL 关闭摘要]** 图标 ![](assets/close-summary-with-text-nwe.png)
