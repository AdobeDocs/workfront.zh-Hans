...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>项目名称<br>Portfolio名称<br>项目参考编号<br>将人员添加到项目的用户名称<br>添加到项目的用户名称<br>项目[！UICONTROL计划开始日期]<br>项目[！UICONTROL计划完成日期]<br>项目完成百分比<br>项目上其他人的名称<br>项目状态<br>项目所有者<br><strong>[！UICONTROL查看更多详细信息]</strong>按钮<br><br><br></p> </td> 
   <td><strong>即时</strong> </td> 
  </tr> 
  <tr> 
