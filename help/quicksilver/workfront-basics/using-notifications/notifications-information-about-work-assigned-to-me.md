...
<table style="table-layout:auto"> 
 ...
 <tbody>
  ...
  <tr> 
   ...
   <td> 任务名称<br>项目名称<br>任务参考编号<br>授予审批的用户名称<br>新任务状态<br>批准或拒绝任务的日期和时间<br>上一任务状态<br><strong>[!UICONTROL 查看更多详细信息]</strong>按钮<br>*项目名称<br>*项目参考编号<br>*已批准或拒绝的任务总数<br>*任务名称<br>*已批准或拒绝任务的用户的名称<br>*审批决定（[!UICONTROL 已批准]/ [!UICONTROL 已拒绝]）<br>*每日摘要的日期<br></td> 
   <td><strong>每天</strong> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>请求名称<br>项目名称（请求队列名称）<br>文档参考编号<br>上载文档的用户的名称<br>文档名称<br>已于日期添加<br>文档详细信息（格式、大小、版本号）<br>文档缩略图<br><strong>[!UICONTROL 预览]</strong>和<strong>[!UICONTROL 下载]</strong>按钮<br>*项目名称<br>*项目参考编号<br>*上载或上载的文档总数已更改<br>*文档名称<br>*对象名称<br>*上传文档的用户的名称<br>*每日摘要的日期</p> </td> 
   <td><strong>每天</strong> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>当任务到期日期更改时，发送电子邮件给分派用户</strong> </p> <p>当任务的[!UICONTROL 规划完成日期]发生更改时，任务被分配人会收到电子邮件通知，除非更改规划完成日期的用户同时也是任务被分配人。</p> <p>仅当项目状态不是[!UICONTROL Planning]时，才会发送通知。</p> <p>不会发送有关个人任务的通知。</p> <p> 拥有外部许可证的用户不会收到通知。 </p> <p> 即时通知电子邮件的主题为： <em>[!UICONTROL 到期日期已更改。]</em></p> <p> 每日摘要通知的主题是：<em> [!UICONTROL 分配给您的工作摘要] &lt;每日摘要的日期&gt; </em></p> </td> 
   <td> 任务名称<br>项目名称<br>任务参考编号<br>新到期日期（[!UICONTROL 计划完成日期]）<br>更改到期日期的日期和时间<br>更改到期日期的用户名称<br>*项目名称<br>*项目参考编号<br>*更改到期日期（计划完成日期）的任务总数<br>*任务名称<br>*新计划完成日期<br>*更改到期日期的用户名称日期<br>*每日摘要的日期 </td> 
  ...
  <tr> 
   ...
   <td> <p>问题名称<br>项目名称<br>问题参考编号<br>新到期日期（[!UICONTROL 计划完成日期]）<br>更改到期日期的日期和时间<br>更改到期日期的用户名称<br>*项目名称<br>*项目参考编号<br>*到期日期（[!UICONTROL 计划完成日期]）更改的问题总数<br>*问题名称<br>*新[!UICONTROL 计划完成日期日期]<br>*更改每日摘要的截止日期<br>*的用户名称<br></p> </td> 
   <td> <p><strong>即时</strong> </p> <p><strong>和每天</strong> </p> </td> 
  </tr> 
  <tr> 
