...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>在项目、任务或问题报表中，[!UICONTROL 实际小时数]是项目、任务或问题中记录的所有小时数的总和。</p> <p class="example" data-mc-autonum="<b>Example: </b>"><span class="autonumber"><span><b>示例： </b></span></span>如果从任务1的[!UICONTROL 更新]选项卡中单击“记录时间”并输入25小时，则任务1的实际小时数= 25小时。 </p> <p>[!DNL Workfront] 使用以下公式计算父任务或项目的[!UICONTROL 实际小时数]：</p> 
    <ul> 
