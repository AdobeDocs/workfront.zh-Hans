...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <p>[!UICONTROL 实际成本]计算考虑了[!UICONTROL 旧版实际小时数]。 有关信息，请参阅此表中的“[!UICONTROL 实际小时数]”或“[!UICONTROL 旧版实际小时数]”。 </p>   </td> 
  </tr> 
  <tr> 
...
<tr> 
   <td>[!UICONTROL 成本绩效指数(CPI)]</td> 
   <td> <p>[!UICONTROL 成本绩效指数(CPI)]描述了项目或任务级别的计划成本与实际成本之间的关系。 项目经理审查此量度，以确定当前在给定时间点跟踪成本不足或超过成本的任务或项目。 成本可以按小时或货币计量，具体取决于您的[!UICONTROL 绩效指数方法(PIM)]。</p> 
...
<tr> 
   <td>[!UICONTROL 成本计划绩效指数(CSI)]</td> 
   <td> <p>[!UICONTROL 成本计划绩效指数(CSI)]是一种自动计算，它将[!UICONTROL 成本绩效指数(CPI)]和[!UICONTROL 计划绩效指数(SPI)]结合为一个用于平衡成本和计划的一般指标。 通过将这些值相乘，单个量度可以以较低的预算处理较长的计划，反之亦然。 当牺牲成本来推动项目中期计划时，项目经理可以使用此项来确定一般项目或任务的运行状况。</p> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>将此字段添加到[!UICONTROL 任务]报告时，任务子对象（如问题、子任务或文档）上剩余的任何更新不会显示在此列中。</p> 
   <p><b>注释</p>
...
<tr> 
   <td>[!UICONTROL 绩效指数方法(PIM)]</td> 
   <td> <p>项目的[!UICONTROL 绩效指数方法(PIM)]控制Adobe Workfront用于计算项目绩效指标的方法，如成本绩效指数(CPI)、成本计划绩效指数(CSI)、计划绩效指数(SPI)和完工估算(EAC)。</p> 
  ...
  <tr> 
   ...
   <td> <p>在项目、任务和目标报告中，此字段显示项目、任务或战略目标的进度状态。 有关更多信息，请参阅以下文章：</p> 
    <ul> 
     ...
     <p>仅当您的组织购买了[!DNL goals]时，[!DNL Workfront Goals]字段的[!UICONTROL 目标]报表和[!UICONTROL 进度状态]才可见。 有关[!DNL Workfront Goals]中战略目标的信息，请参阅<a href="../../../workfront-goals/goal-management/wf-goals-overview.md">[!DNL Workfront Goals]概述</a>。 </p> </li>
    </ul> </td> 
  </tr> 
  <td>[!UICONTROL 项目]</td> 
...
<tr> 
   <td>[!UICONTROL 计划绩效指数(SPI)]</td> 
   <td><p>[!UICONTROL 计划绩效指数(SPI)]描述了计划计划与实际计划之间的关系。 Adobe Workfront在项目和任务级别计算SPI。 项目经理审查此量度，以确定任务或项目当前正在跟踪的时间是提前还是晚于。</p>
