...
1. 在&#x200B;**授予项目组合对**&#x200B;的访问权限字段中，开始键入要与其共享项目组合的用户、团队、角色、组、公司、<span class="preview">或业务配置文件</span>的名称，然后在名称出现在下拉列表中时单击该名称。
...
1. 在&#x200B;**授予项目组合对**&#x200B;的访问权限字段中，开始键入要与其共享项目组合的用户、团队、角色、组、公司、<span class="preview">或业务配置文件</span>的名称，然后在其出现在下拉列表中时单击该名称。
