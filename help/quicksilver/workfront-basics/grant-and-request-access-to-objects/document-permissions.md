...
Workfront正在过渡到Adobe企业级存储解决方案，以便提供与Adobe Creative Cloud产品的更大连接。 如果您的组织使用企业存储，则当您访问Workfront中的文档时，将会看到新的“文档”区域。 有关企业存储的更多信息，请参阅[Adobe企业存储概述](/help/quicksilver/review-and-approve-work/esm-overview.md)。
