...
* **费率卡**：有关信息，请参阅[共享费率卡](/help/quicksilver/administration-and-setup/manage-enterprise-operations/share-rate-cards.md)。
  ...
  <tr> 
   ...
   <td> <p>您可以对对象执行以下操作：</p> 
    <ul> 
     ...
     <li><p>查看有关对象的成本费率、记帐费率或一般财务信息</p></li> 
