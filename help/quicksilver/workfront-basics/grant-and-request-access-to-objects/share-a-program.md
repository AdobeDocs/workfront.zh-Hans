...
在分配访问级别时，Adobe Workfront管理员可以向您授予查看或编辑程序的权限。 您必须拥有Standard或Plan许可证才能编辑项目。 有关详细信息，请参阅[授予程序访问权限](../../administration-and-setup/add-users/configure-and-grant-access/grant-access-programs.md)。
...
1. 在&#x200B;**授予程序访问**&#x200B;字段中，开始键入要与其共享程序的用户、团队、角色、组、公司或业务配置文件的名称，然后在名称出现在下拉列表中时单击该名称。
...
1. 在&#x200B;**将程序访问权限授予**&#x200B;字段中，开始键入要与其共享程序的用户、团队、角色、组、公司或业务配置文件的名称，然后在名称出现在下拉列表中时单击该名称。
