...
查看当前文档中的以下部分 [!UICONTROL 主页] 区域，如上图中突出显示的内容：

* **A**：使用左侧面板过滤、排序和选择分配给您的工作。

* **B**：在左侧面板中选择工作项后，使用右侧面板与自定义字段交互、进行更新并记录时间。

有关使用 [!UICONTROL 主页工作列表]，请参阅以下文章：
...
* **A**：使用 [!UICONTROL 日历] 视图，用于创建需要完成的工作的可视化地图。 只需从以下位置单击并拖动工作项即可： [!UICONTROL 工作列表] 到 [!UICONTROL 日历] 来阻止你工作的时间。

* **B**：使用 [!UICONTROL 日历]的同步选项，用于与您的 [!DNL Outlook] 日历。 在一个地方管理会议和工作。

* **C**：使用 [!UICONTROL 详细信息] 按钮打开新的右侧面板，您可以在此处查看有关工作项的更多信息。

* **D**：使用到期栏跟踪分配给您的工作的到期时间。
...
有关如何使用分组的更多信息，请参阅 [在中显示项目 [!UICONTROL 工作列表] 在 [!UICONTROL 主页] 区域](../../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md).

![](assets/group-by-drop-down-expanded-in-home-with-planned-start-date-nwe-350x273.png)

### 使用筛选器缩小您的关注范围

此 [!UICONTROL 工作列表] 过滤器允许您将焦点缩小到特定工作项。

以下示例介绍了如何过滤在主页中查看的项目：

* 按项目类型和状态筛选。

  例如，如果要显示所有任务，可以选择 [!UICONTROL 任务] 筛选。 如果您希望更加具体化，并且只显示已准备好开始处理的任务，请选择 [!UICONTROL 准备开始] 下的过滤器 [!UICONTROL 任务] 筛选。
...
>[!NOTE]
>
>任何工作项已添加到 [!UICONTROL 我的优先级] 仅对您可见，任何人都不能为您设置工作优先级。

有关如何使用的更多信息 [!UICONTROL 我的优先级]，请参见 [排定工作的优先顺序 [!UICONTROL 主页] 区域](../../../workfront-basics/using-home/using-the-home-area/prioritize-work-in-home.md).
...
跟踪您在单个工作项上工作的小时数。 您可以选择常规小时类型，例如 [!UICONTROL 任务时间]，或者您可以选择由您指定的项目特定小时类型 [!DNL Workfront] 管理员。

有关如何记录时间的详细信息，请参阅 [!UICONTROL 主页] 区域，请参阅部分 [主页](../../../timesheets/create-and-manage-timesheets/log-time.md#home) 在文章中 [记录时间](../../../timesheets/create-and-manage-timesheets/log-time.md).
