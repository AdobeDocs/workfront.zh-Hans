...
* 产品公告 {#product-announcements}
  ...
  * 产品版本 {#product-releases}
    ...
    * 2026年第三季度发行 {#release-26-q3}
      ...
      * [2026年第三季度人工智能增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-ai.md)
      * [2026年第三季度管理员增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md)
      * [2026年第三季度文档增强](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-documents.md)
      * [2026年第三季度财务管理增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-financial-management-enhancements.md)
      * [2026年第三季度主页增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-home.md)
      * [2026年第三季度项目增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-projects.md)
      * [2026年第三季度报告增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-reports.md)
      * [2026年第三季度请求增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-requests.md)
      * [2026年第三季度资源管理增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-resource-mgmt.md)
      * [2026年第三季度其他增强功能](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-other.md)
    * 2026年第二季度发布 {#release-26-q2}
      * [2026年第二季度发行版概述](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-release-overview.md)
      * [2026年第二季度管理员增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md)
      * [2026年第二季度文档增强](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md)
      * [2026年第二季度企业运营增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-enterprise-operations-enhancements.md)
      * [2026年第二季度项目增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-projects.md)
      * [2026年第二季度报表增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md)
      * [2026年第二季度要求增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-requests.md)
      * [2026年第二季度其他增强功能](/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md)
    * 2026年第一季度发行 {#release-26-q1}
      ...
      * [2026年第一季度主页增强功能](/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-home.md)
    ...
    * 2025年第四季度发行 {#release-25-q4}
      ...
      * [2025年第四季度功能板增强功能](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-dashboards.md)
      ...
      * [2025年第四季度项目增强功能](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-project.md)
      ...
      * [2025年第四季度其他增强功能](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-other.md)
    ...
    * 2025年第三季度发行 {#release-25-q3}
      ...
      * [在2025年第3季度发布时间范围内的外观更新](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-look-and-feel-updates.md)
    * 2025年第二季度发布 {#release-25-q2}
    ...
    * 2024年第四季度发行 {#release-24-q4}
      ...
      * [2024年第4季度文档管理增强功能](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-document-mgmt-enhancements.md)
      * [2024年第4季度集成增强功能](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-integration-enhancements.md)
      * [2024年第4季度主页增强功能](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-home-enhancements.md)
      ...
      * [2024年第4季度校对功能增强](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-proofing-enhancements.md)
      * [2024年第4季度报告和功能板增强功能](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-report-and-dashboard-enhancements.md)
      * [2024年第四季度发布时间框架内的其他增强功能](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-other-enhancements.md)
...
* 管理和设置 {#administration-and-setup}
  ...
  * 设置Workfront {#set-up-wf}
    ...
    * 配置系统默认值 {#configure-system-defaults}
      ...
      * [为您的组织启用Adobe云存储](administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md)
      * [将旧版项目组合转换为Adobe云存储](administration-and-setup/set-up-workfront/configure-system-defaults/convert-portfolios-to-acs.md)
    ...
    * 系统跟踪的更新馈送 {#system-tracked-updates}
      * [系统跟踪的更新信息源：文章索引](administration-and-setup/set-up-workfront/system-tracked-update-feeds/system-tracked-updates-feeds.md)
  ...
  * 管理Adobe Workfront {#manage-wf}
    ...
    * 管理已删除的项目 {#manage-deleted-items}
      ...
      * [查看已恢复的项目](administration-and-setup/manage-workfront/manage-deleted-items/view-restored-items.md)
      * [已删除的对象如何影响小时数](administration-and-setup/manage-workfront/manage-deleted-items/configure-how-hours-affected-when-obj-deleted-restored.md)
  ...
  * 管理企业运营 {#manage-enterprise-operations}
  ...
  * 配置集成 {#configure-integrations}
    ...
    * [从Workfront OAuth2迁移到Adobe Developer Console](/help/quicksilver/administration-and-setup/configure-integrations/migrate-oauth2-to-developer-console.md)
  ...
  * Adobe Admin Console中的管理 {#admin-in-admin-console}
    ...
    * [准备Adobe Admin Console](administration-and-setup/adobe-admin-console/prep-for-admin-console.md)
...
* Adobe Workfront基础知识 {#basics}
  ...
  * 优先次序 {#priorities}
    ...
    * [在优先级中查看项目和工作项详细信息](workfront-basics/priorities/view-task-project-details.md)
  ...
  * 主页 {#home}
    ...
    * 使用“主页”区域 {#use-home-area}
      ...
      * [创建和管理个人待办事项](workfront-basics/using-home/using-the-home-area/manage-to-do-in-home.md)
      ...
      * [使用我的请求小组件](workfront-basics/using-home/using-the-home-area/my-requests-widget.md)
  * AI 助手 {#ai-assistant}
  ...
  * Workfront MCP服务器 {#workfront-mcp-server}
    * [Workfront MCP服务器：文章索引](/help/quicksilver/workfront-basics/workfront-mcp-server/workfront-mcp-server.md)
  ...
  * Adobe Workfront基础知识的提示、技巧和疑难解答 {#tips-tricks-for-basics}
    * [Adobe Workfront的提示、技巧和故障排除：文章索引](workfront-basics/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-basics.md)
    ...
    * [多个浏览器选项卡会导致Workfront注销](workfront-basics/tips-tricks-and-troubleshooting/multiple-browser-tabs-cause-logout.md)
    * [如何共享对象而不生成通知](workfront-basics/tips-tricks-and-troubleshooting/how-to-share-objects-without-sending-out-notifications.md)
...
* 敏捷 {#agile}
  ...
  * Adobe Workfront中的讨论区入门 {#boards-in-workfront}
    ...
    * [Workfront展示板视频演示](/help/quicksilver/agile/get-started-with-boards/boards-video-demonstrations.md)
    ...
    * [管理讨论区管理员视图](/help/quicksilver/agile/get-started-with-boards/manage-boards-admin-view.md)
    * [讨论区电子邮件通知和首选项](/help/quicksilver/agile/get-started-with-boards/boards-emails.md)
  * 在展示板中使用敏捷规划工具 {#agile-planning-boards}
    * [Agile规划工具概述：文章索引](agile/use-boards-agile-planning-tools/agile-planning-tools-overview.md)
...
* 管理工作 {#manage-work}
  ...
  * 项目 {#projects}
    ...
    * 创建项目 {#create-projects}
      ...
      * [创建和查看项目快照](manage-work/projects/create-projects/create-snapshots.md)
    ...
    * 创建和管理项目模板 {#create-and-manage-project-templates}
      ...
      * [删除模板任务](manage-work/projects/create-and-manage-templates/delete-template-tasks.md)
    ...
    * 项目财务 {#project-finances}
      ...
      * [覆盖开单费率和计算项目收入概览](manage-work/projects/project-finances/override-role-billing-rates-and-calculate-project-revenue.md)
  ...
  * 任务 {#tasks}
    ...
    * 任务信息 {#task-information}
      * [任务信息：文章索引](manage-work/tasks/task-information/task-information.md)
      ...
      * [预计日期和预计日期概览](manage-work/tasks/task-information/differentiate-projected-estimated-dates.md)
  ...
  * 组合管理 {#portfolio-management}
    ...
    * Adobe Workfront中的Portfolio概述 {#portfolio-overview-in-adobe-workfront}
      * [组合：文章索引](manage-work/portfolios/portfolios-overview/portfolio-overview-1.md)
    ...
    * 创建和管理程序 {#create-and-manage-programs}
      * [程序概述](manage-work/portfolios/create-and-manage-programs/programs-overview.md)
      * [创建和管理程序：文章索引](manage-work/portfolios/create-and-manage-programs/create-and-manage-programs.md)
      ...
      * [删除和停用程序](manage-work/portfolios/create-and-manage-programs/delete-and-deactivate-programs.md)
    * 在Portfolio Optimizer管理项目 {#manage-projects-in-portfolio-optimizer}
      * [在Portfolio Optimizer中管理项目：文章索引](manage-work/portfolios/portfolio-optimizer/manage-projects-in-portfolio-optimizer.md)
  ...
  * 请求 {#requests}
    * [请求：文章索引](manage-work/requests/requests-overview.md)
...
* 团队和组 {#teams-groups}
  ...
  * 与组和团队合作 {#work-with-groups-teams}
    ...
    * [Workfront中的组与团队](people-teams-and-groups/work-with-groups-and-teams/understanding-differences-and-similarities-between-groups-and-teams.md)
...
* 报告 {#reporting}
  ...
  * 报告 {#reports}
    ...
    * 创建和管理报告 {#create-manage-reports}
      ...
      * [使用日记帐分录报表报告更新区域](reports-and-dashboards/reports/creating-and-managing-reports/create-journal-entry-report.md)
    ...
    * 报表使用情况概述 {#report-usage-overview}
      ...
      * [使用可共享的报告文件夹](/help/quicksilver/reports-and-dashboards/reports/report-usage/use-sharable-report-folders.md)
  ...
  * Workfront数据连接 {#data-lake}
    ...
    * Data Connect的提示、技巧和疑难解答{#troubleshooting-data-connect}
      * [Data Connect的提示、技巧和疑难解答](/help/quicksilver/reports-and-dashboards/data-lake/tips-tricks-troubleshooting/tips-tricks-troubleshooting-data-connect.md)
...
* 管理资源 {#manage-resources}
  * [管理资源：文章索引](resource-mgmt/manage-resources.md)
  * 资源管理 {#resource-management}
    * [资源管理：文章索引](resource-mgmt/resource-mgmt-overview/resource-management-overview.md)
  ...
  * 资源利用率 {#resource-utilization}
    * [资源利用率：文章索引](resource-mgmt/resource-utilization/resource-utilization.md)
...
* 审阅和批准工作 {#review-and-approve-work}
  ...
  * 统一审批 {#document-reviews-and-approvals}
    * [统一文档审批：文章索引](review-and-approve-work/document-reviews-and-approvals/document-reviews-and-approvals.md)
    ...
    * [从旧文档审批移至统一审批](/help/quicksilver/review-and-approve-work/move-to-unified-approvals.md)
    ...
    * 审阅和批准资源和文档 {#review-and-approve-documents}
      ...
      * [查看内容查看者得分和反馈](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/view-ai-reviewer-feedback.md)
...
* Adobe Workfront Scenario Planner {#scenario-planner}
  ...
  * [在Scenario Planner中请求计划的权限](scenario-planner/request-access-to-plan.md)
...
* Adobe Workfront目标 {#adobe-workfront-goals}
  * [Adobe Workfront目标：文章索引](workfront-goals/workfront-goals.md)
...
* Adobe Workfront 规划 {#adobe-workfront-planning}
  * [Adobe Workfront Planning的一般信息和文章索引](planning/planning-information.md)
  * Adobe Workfront规划一般信息 {#adobe-workfront-planning-general-information}
    ...
    * [Workfront Planning术语概述](planning/general/planning-terminology.md)
  ...
  * Adobe Workfront规划最佳实践 {#adobe-workfront-planning-best-practices}
    ...
    * [架构您的成功：建模您的营销活动层次结构](planning/best-practices.md/model-campaign-hierarchy.md)
    * [构建营销日历：无平台，只需清晰明了](planning/best-practices.md/marketing-calendar.md)
    * [将您的首次成功转化为可持续的发展势头：管理式扩展的剧本](planning/best-practices.md/playbook-how-to-scale.md)
    * [搭建桥梁：将战略意图与项目联系起来](planning/best-practices.md/the-bridge-connect-strategy-with-projects.md)
  * Adobe Workfront规划架构 {#adobe-workfront-planning-architecture}
    ...
    * [层次结构和痕迹导航概述](planning/architecture/hierarchy-and-breadcrumb-overview.md)
    * [创建工作区层次结构](planning/architecture/create-workspace-hierarchies.md)
    ...
    * [管理从属连接](planning/architecture/manage-dependent-connections.md)
    * [编辑记录类型](planning/architecture/edit-record-types.md)
    * [删除工作区](planning/architecture/delete-workspaces.md)
    * [编辑工作区](planning/architecture/edit-workspaces.md)
    * [删除记录类型](planning/architecture/delete-record-types.md)
    * [连接记录类型和记录的示例](planning/architecture/example-connect-record-types-and-records.md)
    * [工作区模板列表](planning/architecture/workspace-templates.md)
  * Adobe Workfront规划字段 {#adobe-workfront-planning-fields}
    ...
    * [从Adobe Workfront导入字段](planning/fields/import-fields-from-workfront.md)
    * [主字段概述](planning/fields/primary-field-overview.md)
  * Adobe Workfront Planning访问权限 {#adobe-workfront-planning-access}
  ...
  * Adobe Workfront Planning记录 {#adobe-workfront-planning-records}
    ...
    * [删除记录](planning/records/delete-records.md)
    * [恢复已删除的记录](planning/records/restore-deleted-records.md)
    * [使用链接共享记录](planning/records/share-records.md)
    * [重复记录](planning/records/copy-or-duplicate-records.md)
    * [管理记录注释](planning/records/manage-record-comments.md)
    * [“历史记录”部分概述](planning/records/history-section-overview.md)
    * [向记录添加缩略图](planning/records/add-thumbnails-to-records.md)
  ...
  * Adobe Workfront规划请求 {#adobe-workfront-planning-requests}
  ...
  * Adobe Workfront Planning视图 {#adobe-workfront-planning-views}
    * [视图：文章索引](planning/views/views-information.md)
    * [管理记录视图](planning/views/manage-record-views.md)
    * [管理表视图](planning/views/manage-the-table-view.md)
    * [管理时间线视图](planning/views/manage-the-timeline-view.md)
    * [管理日历视图](planning/views/manage-the-calendar-view.md)
    * [管理列表视图](planning/views/manage-the-list-view.md)
    * [删除记录视图](planning/views/delete-record-views.md)
    * [复制记录视图](planning/views/duplicate-record-views.md)
  * Adobe Workfront计划通知 {#adobe-workfront-planning-notifications}
    * [Adobe Workfront计划通知：文章索引](planning/notifications/notifications-information.md)
    * [管理Adobe Workfront Planning通知首选项](planning/notifications/manage-notification-preferences.md)
    * [管理Adobe Workfront Planning电子邮件通知](planning/notifications/manage-planning-email-notifications.md)
...
* Adobe Workfront集成 {#adobe-workfront-integrations}
  ...
  * 适用于Jira的Adobe Workfront {#workfront-for-jira}
    * [适用于Jira的Adobe Workfront：文章索引](workfront-integrations-and-apps/use-workfront-with-jira/workfront-for-jira.md)
  ...
  * 适用于Slack的Adobe Workfront {#workfront-for-slack}
...
* Workfront 校样 {#workfront-proof}
  ...
  * Workfront Proof集成 {#wf-proof-integrations}
    ...
    * 盒子 {#box}
      * [盒子](workfront-proof/wp-integrations/box/box.md)
...
* ADOBE WORKFRONT API {#adobe-workfront-api}
  ...
  * API说明 {#api-notes}
    ...
    * [为事件订阅配置客户端TLS](wf-api/api/event-sub-certs.md)
  ...
  * 文档Webhooks API {#document-webhooks-api}
    * [文档Webhooks API：文章索引](wf-api/doc-wbhks-api/document-webhooks-api.md)
