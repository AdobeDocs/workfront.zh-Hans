...
* 产品公告 {#product-announcements}
   ...
   * 产品版本 {#product-releases}
      ...
      * 23.2版本 {#release-23-2}
         ...
         * [23.2发布活动： 2023年2月27日开始的周](product-announcements/product-releases/23.2-release-activity/23-2-feb-27.md)
         * [23.2发布活动： 2023年2月20日开始的周](product-announcements/product-releases/23.2-release-activity/23-2-feb-20.md)
         * [23.2发布活动： 2023年2月13日起的一周](product-announcements/product-releases/23.2-release-activity/23-2-feb-13.md)
         * [23.2发布活动： 2023年2月6日开始的周](product-announcements/product-releases/23.2-release-activity/23-2-feb-6.md)
         * [23.2发布活动： 2023年1月23日起的一周](product-announcements/product-releases/23.2-release-activity/23-1-jan-23.md)
...
* 管理和设置 {#administration-and-setup}
   ...
   * 自定义Adobe Workfront {#customize}
      ...
      * 自定义表单 {#custom-forms}
         ...
         * [将图像或其他资源小部件添加到自定义表单](administration-and-setup/customize-workfront/create-manage-custom-forms/add-widget-or-edit-its-properties-in-a-custom-form.md)
         * [添加分区界限](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
         ...
         * [重用现有的计算自定义字段](administration-and-setup/customize-workfront/create-manage-custom-forms/use-existing-calc-field-new-custom-form.md)
         * [定位自定义字段和小部件](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
         * [共享自定义字段和小部件](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
         * [重用自定义字段或构件](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
         ...
         * [删除自定义表单上的对象类型](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
...
* Adobe Workfront基础 {#basics}
   ...
   * 更新工作项并查看更新 {#update-work-items-view-updates}
      ...
      * [统一的评论体验](workfront-basics/updating-work-items-and-viewing-updates/unified-commenting-experience.md)
...
* 敏捷 {#agile}
   ...
   * 项目中的Agile {#agile-in-projects}
      * [项目中的Agile](agile/agile-in-projects/agile-in-projects.md)
      * [Agile项目](agile/agile-in-projects/use-agile-on-a-project.md)
...
* 管理资源 {#manage-resources}
   ...
   * 资源管理 {#resource-management}
      ...
      * [从资源计划迁移到工作负载均衡器](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
