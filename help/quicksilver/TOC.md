...
* 产品公告 {#product-announcements}
   ...
   * 产品版本 {#product-releases}
      ...
      * 23.2版 {#release-23-2}
         ...
         * [23.2发行活动： 2023年2月13日开始的一周](product-announcements/product-releases/23.2-release-activity/23-2-feb-13.md)
         * [23.2发行活动： 2023年2月6日开始的一周](product-announcements/product-releases/23.2-release-activity/23-2-feb-6.md)
         * [23.2发行活动： 2023年1月23日开始的一周](product-announcements/product-releases/23.2-release-activity/23-1-jan-23.md)
...
* 管理和设置 {#administration-and-setup}
   ...
   * 管理入门 {#get-started-administration}
      * [入门](administration-and-setup/get-started-wf-administration/get-started-with-wf-administration.md)
   ...
   * 自定义Adobe Workfront {#customize}
      ...
      * 自定义表单 {#custom-forms}
         ...
         * [将图像或其他资产小组件添加到自定义表单](administration-and-setup/customize-workfront/create-manage-custom-forms/add-widget-or-edit-its-properties-in-a-custom-form.md)
         * [添加节分符](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
         ...
         * [添加计算数据](administration-and-setup/customize-workfront/create-manage-custom-forms/add-calculated-data-to-custom-form.md)
         * [重复使用现有计算的自定义字段](administration-and-setup/customize-workfront/create-manage-custom-forms/use-existing-calc-field-new-custom-form.md)
         * [定位自定义字段和小组件](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
         * [共享自定义字段和小组件](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
         * [重复使用自定义字段或小组件](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
         * [添加显示逻辑和跳过逻辑](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
         ...
         * [删除自定义表单中的对象类型](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
...
* 管理资源 {#manage-resources}
   ...
   * 资源调度 {#resource-scheduling}
      ...
      * [资源计划入门](resource-mgmt/resource-scheduling/get-started-resource-scheduling.md)
      * [计划区域概述](resource-mgmt/resource-scheduling/overview-scheduling-areas.md)
      ...
      * [配置Workfront如何计算“计划”区域的资源小时数和FTE可用性](resource-mgmt/resource-scheduling/calculate-hours-fte-scheduling-area.md)
      * [在“计划”区域中筛选信息](resource-mgmt/resource-scheduling/filter-scheduling-area.md)
      * [在“计划”区域中管理用户分配](resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md)
      * [在“计划”区域中手动分配未分配的任务和问题](resource-mgmt/resource-scheduling/manually-assign-items-scheduling-areas.md)
      * [将多个用户分配修改为“计划”区域中的任务](resource-mgmt/resource-scheduling/modify-multipl-assignments-scheduling-areas.md)
...
* Adobe Workfront 模板 {#adobe-workfront-goals}
   ...
   * 目标审查和Adobe Workfront目标部分 {#goal-review-and-adobe-workfront-goals-sections}
      ...
      * [查看Adobe Workfront目标脉冲部分中的目标](workfront-goals/goal-review-and-workfront-goals-sections/review-goals-in-pulse.md)
