...
此 [!DNL Adobe Workfront Fusion] 模块允许您配置具有HTTP客户端证书授权的HTTP请求并将其提交到服务器。 接收的HTTP响应随后包含在输出包中。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>选择包含您的客户端证书身份验证凭据的密钥，或单击 <strong>[！UICONTROL添加]</strong> 以将您的凭据添加到新密钥。 </p> <p>注意：您可以添加更多凭据以便轻松地在每个连接之间切换。</p> </td> 
  </tr> 
  <tr> 
