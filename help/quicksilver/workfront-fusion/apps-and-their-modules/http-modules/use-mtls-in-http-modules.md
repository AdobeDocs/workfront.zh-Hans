...
>本文中的信息现在可在以下文章中找到：
>
>* [在Adobe Workfront Fusion的HTTP模块中使用双向TLS](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/use-mtls-in-http-modules.html)
>
>请更新任何书签。
>
>本文不再更新，不久将会删除。
