...
title: 电子邮件模块
description: 在 [!DNL Adobe Workfront Fusion] 方案，您可以将电子邮件帐户连接到多个第三方应用程序和服务。这使您能够通过IMAP下载电子邮件、通过SMTP发送电子邮件、创建新草稿、将电子邮件从一个文件夹移动和复制到另一个文件夹、将电子邮件标记为已读或未读，以及删除电子邮件。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 方案，您可以将电子邮件帐户连接到多个第三方应用程序和服务。这使您能够通过IMAP下载电子邮件、通过SMTP发送电子邮件、创建新草稿、将电子邮件从一个文件夹移动和复制到另一个文件夹、将电子邮件标记为已读或未读，以及删除电子邮件。
...
使用此选项可创建包含需要连接到您的的电子邮件模块的场景 [!DNL Google] 帐户。 这是范围受限的帐户。

您可以创建与 [!DNL Google] 电子邮件模块中的帐户。

1. 在任意电子邮件模块中，单击 **[!UICONTROL 添加]** 旁边的 [!UICONTROL 连接] 字段。
1. 选择 **[!DNL Google]** 作为连接类型。
1. 输入连接的名称。
1. （可选）输入您的 [!UICONTROL [!DNL Google] 客户端ID] 和 [!UICONTROL 客户端密码].
1. 单击 **[!UICONTROL 继续]** 以创建连接并返回模块。

### 连接到其他电子邮件服务(SMAP)

SMAP连接允许您远程访问邮箱，并读取或操作邮箱中的邮件。 大多数电子邮件模块都使用SMAP连接。

1. 在任意电子邮件模块中，单击 **[!UICONTROL 添加]** 旁边的 [!UICONTROL 连接] 字段。
1. 选择 **[!UICONTROL 其他(SMTP)]** 作为连接类型。
1. 输入 **[!UICONTROL 名称]** 用于连接。
1. 选择您的 **[!UICONTROL 电子邮件提供商]** 从名单上。 如果您的电子邮件提供商不在列表中，请选择“其他”。
1. 输入您的 **[!UICONTROL 电子邮件地址]**， **[!UICONTROL 您的全名]**，您的 **[!UICONTROL 用户名]**，以及您的 **[!UICONTROL 密码]**.
1. （视情况而定）如果您的提供商不在列表中，请输入 **[!UICONTROL SMTP服务器]** 和 **[!UICONTROL 端口]**，并指定是否要 **[!UICONTROL 使用安全连接(TLS)]**. 要查找此信息，请检查 [!UICONTROL 帮助] 邮箱分区。 如果您没有此信息，请与您的电子邮件服务提供商联系。
1. 单击 **[!UICONTROL 继续]** 以创建连接并返回模块。

## [!UICONTROL 电子邮件] 模块及其字段

配置时 [!UICONTROL 电子邮件] 模块， [!DNL Workfront Fusion] 显示下面列出的字段。 除此以外，还可能会显示其他字段，具体取决于应用程序或服务中的访问级别等因素。 模块中的粗体标题表示必填字段。

某些电子邮件字段可能包含数据，因为您在场景的其他模块中使用了这些数据。 如果您需要有关这些文档的信息，请参阅电子邮件帮助文档。
...
>[!NOTE]
>
>唯一电子邮件ID称为&#39;[!UICONTROL 电子邮件ID (UID)]&#39;是电子邮件的标识符。 电子邮件ID特定于每个电子邮件的文件夹。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>有关将电子邮件帐户连接到[！UICONTROL Workfront Fusion]的说明，请参阅 <a href="#connect-your-email-to-workfront-fusion" class="MCXref xref">将您的电子邮件连接到[！UICONTROL Workfront Fusion]</a> 本文章中。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 最大电子邮件数 [!DNL Workfront Fusion] 应在一个场景执行周期中返回。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[！UICONTROL连接] </td> 
   <td> <p>有关将您的电子邮件帐户连接到 [!DNL Workfront Fusion]，请参见 <a href="#connect-your-email-to-workfront-fusion" class="MCXref xref">将您的电子邮件连接到[！UICONTROL Workfront Fusion]</a> 本文章中。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL发送后保存消息]</td> 
   <td>发送电子邮件后，该邮件将保存在您的邮箱中。 如果要保存使用发送的电子邮件，请启用此选项 [!DNL Workfront Fusion] 到 <i>[！UICONTROL已发送邮件]</i> 文件夹或邮箱中的其他文件夹。 某些电子邮件服务，例如 [!DNL Gmail]，自动保存已发送的消息。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>根据您在[！UICONTROL Content Type]字段中选择的内容，使用HTML标签或纯文本以HTML格式输入或映射电子邮件内容。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>输入或映射一个或多个要向其发送此电子邮件副本的电子邮件地址。 </p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL盲文副本收件人]</td> 
   <td> <p> 输入或映射您要向其发送此电子邮件的副本的一个或多个电子邮件地址，而不在电子邮件中显示该电子邮件地址。</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td role="rowheader">[！UICONTROL From] </td> 
   <td> <p>输入或映射电子邮件中[！UICONTROL发件人]字段中显示的电子邮件地址（和名称，如果需要）。 </p> <p>重要信息：使用正确的语法： <code>name@email.com</code> 或 <code>"Name" name@email.com</code>.</p> <p>注意：通常， [!DNL Workfront Fusion] 使用您在创建连接时输入的电子邮件地址作为发件人地址。 如果您输入任何其他电子邮件地址，则在发送邮件时可能会发生错误，因为您的帐户可能无权从不同于您自己的地址发送电子邮件。 例如： <code>test@mail.com</code> 或"<code>John Bush" test@email.com</code>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[！UICONTROL发件人]</p> </td> 
   <td> <p>输入或映射显示在电子邮件的[！UICONTROL Sender]字段中的电子邮件地址。</p> <p>提示：如果您不确定是使用此字段还是从字段，我们建议您选择从字段。</p> <p>重要信息：使用正确的语法： <code>name@email.com</code> 或 <code>"Name" name@email.com</code></p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL回复]</td> 
   <td> <p> 如果要将此电子邮件的回复发送到与“发件人”地址不同的地址，请输入要用于回复此电子邮件的电子邮件地址。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL In-Reply-To]</td> 
   <td> <p> 如果要回复特定电子邮件，请输入或映射要回复的电子邮件ID。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td role="rowheader">[！UICONTROL回复]</td> 
   <td> <p> 如果希望将此电子邮件的回复发送到与“[！UICONTROL from]”地址不同的地址，请输入希望将此电子邮件的回复发送到的电子邮件地址。</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td role="rowheader">[！UICONTROL In-Reply-To]</td> 
   <td> <p> 如果要回复特定电子邮件，请输入或映射要回复的电子邮件ID。</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>添加标头：</p> 
    <ul> 
     <li> <p><strong>[！UICONTROL键]</strong> </p> <p>添加键。 例如，Sender、Date、To等。</p> </li> 
     <li> <p><strong>[！UICONTROL值]</strong> </p> <p>输入键的值。</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
...
通过设置，将选定文件夹中的电子邮件或草稿标记为已读 [!UICONTROL 读取] 标志。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL文件夹]</td> 
   <td>选择要标记为已读的电子邮件的文件夹。 例如： Primary。</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL文件夹]</td> 
   <td>选择要标记为未读的电子邮件文件夹。 例如： Primary。</td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[！UICONTROL电子邮件ID (UID)]</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>选择包含要从中移动电子邮件的电子邮件的文件夹。 例如： Primary。</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL源文件夹]</td> 
   <td>选择要从中复制电子邮件的文件夹。 例如： Primary。</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL目标文件夹]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL文件夹]</td> 
   <td>选择要删除的电子邮件的文件夹。 例如： Primary。</td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[！UICONTROL电子邮件ID (UID)]</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>启用此选项可允许模块永久删除当前打开的邮箱中标记为[！UICONTROL已删除]的所有邮件。</p> <p>注意：在 [!DNL Gmail]，此行为由[！UICONTROL设置] &gt;[！UICONTROL转发POP/IMAP in IMAP access]部分中的设置驱动。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>输入或映射日期，以检索在指定日期或之后处理的电子邮件。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 输入要检索其详细信息的电子邮件的电子邮件ID (UID)。</p> <p>您可以使用获取电子邮件的UID [!DNL Workfront Fusion]s[！UICONTROL关注电子邮件]模块或[！UICONTROL搜索电子邮件]模块。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL最大结果数]</td> 
   <td> <p> 最大电子邮件数 [!DNL Workfront Fusion] 应在一个场景执行周期中返回。</p> </td> 
...
电子邮件迭代器模块允许您单独管理电子邮件附件。 例如，您可以设置查看电子邮件，以迭代包含附件的电子邮件并接收警报。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>选择用于输出带有要对其进行迭代处理的附件的电子邮件的模块。</p> </td> 
  </tr> 
 </tbody> 
</table>

有关迭代器的详细信息，请参见 [中的迭代器模块 [!DNL Adobe Workfront Fusion]](../../workfront-fusion/modules/iterator-module.md).
