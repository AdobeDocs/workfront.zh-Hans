...
description: 在 [!DNL Adobe Workfront Fusion] 方案，您可以自动执行使用OneDrive的工作流，并将其连接到多个第三方应用程序和服务。
author: Becky
...
在 [!DNL Adobe Workfront Fusion] 场景，您可以自动执行使用 [!DNL OneDrive]，并将其连接到多个第三方应用程序和服务。
...
使用 [!DNL OneDrive] 模块，您必须具有 [!DNL Microsoft OneDrive] 帐户。

## 连接 [!DNL OneDrive] 服务目标 [!DNL Workfront Fusion]

有关连接 [!DNL OneDrive] 目标帐户 [!UICONTROL Workfront Fusion]，请参见 [创建连接 [!UICONTROL Adobe Workfront Fusion]  — 基本说明](../../workfront-fusion/connections/connect-to-fusion-general.md)

## [!DNL Microsoft OneDrive] 模块及其字段

配置时 [!DNL OneDrive] 模块， [!DNL Workfront Fusion] 显示下面列出的字段。 除此以外，还有 [!DNL OneDrive] 可能会显示字段，具体取决于应用程序或服务中的访问级别等因素。 模块中的粗体标题表示必填字段。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>有关连接 [!DNL OneDrive] 目标帐户 [!DNL Workfront Fusion]，请参见 <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">创建连接 [!DNL Adobe Workfront Fusion]  — 基本说明</a></td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL监视文件/文件夹]</td> 
   <td> <p>选择监视文件或文件夹的方式：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL按创建时间]</b> </p> <p>注意新文件或文件夹。</p> </li> 
     <li> <p><b>[！UICONTROL更新时间]</b> </p> <p>请注意已更新的现有文件或文件夹。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
    ...
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       ...
       <li> <p><b>[！UICONTROL否]</b> </p> <p>导航到您希望模块监视的文件夹。 您还可以输入查询以筛选返回的结果。</p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL与我共享]</b> </p> <p>该模块会监视已与该驱动器所有者共享的文件。</p> </li> 
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择要让模块观看的SharePoint站点。 可用站点是后跟登录用户的站点。</p> </li> 
     <li> <p><b>[！UICONTROL组的驱动器]</b> </p> <p>选择要让模块监视其驱动器的组。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL选择项目类型]</td> 
   <td> <p>选择是要监视文件、文件夹，还是同时监视两者。</p> <p>注意：您无法监视[！UICONTROL Shared With Me]驱动器中的文件夹。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>选择要搜索的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>输入您希望模块搜索的驱动器ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> <p>导航到您希望模块搜索的文件夹。 您还可以输入查询以筛选返回的结果。</p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL与我共享]</b> </p> <p>模块将搜索已与该驱动器所有者共享的文件。</p> </li> 
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 您希望模块搜索的站点。 可用站点是后跟登录用户的站点。</p> </li> 
     <li> <p><b>[！UICONTROL组的驱动器]</b> </p> <p>选择要搜索模块的驱动器所在的组。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL选择项目类型]</td> 
   <td> <p>选择是要搜索文件、文件夹，还是同时搜索两者。</p> <p>注意：您无法在[！UICONTROL Shared With Me]驱动器中搜索文件夹。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL限制]</td> 
   <td> <p>输入或映射您希望模块在每个方案执行周期内返回的最大记录数。</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择您希望如何输入文件ID或文件路径：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL手动输入]</b> </p> <p>如果要直接输入ID或路径，或者从上一个模块映射该ID或路径，请选择此选项。</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>如果选择了[！UICONTROL Enter Manually]，请输入或映射要获取的文件的ID或路径。</p> <p>如果选择了[！UICONTROL从列表中选择]，请选择要获取的文件。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择要包含要下载的文件的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>输入包含要下载的文件的驱动器ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL文件] / [！UICONTROL文件ID] / [！UICONTROL文件路径]</td>
   <td> <p>如果选择了[！UICONTROL Enter Manually]，请输入或映射要下载的文件的文件ID或路径。</p> <p>如果选择了[！UICONTROL从列表中选择]，请选择要下载的文件。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>选择要上载文件的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 包含要上载文件的文件夹的站点。 可用站点是后跟登录用户的站点。</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>选择要创建文件夹的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 要在其中创建文件夹的站点。 可用站点是后跟登录用户的站点。</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL文件] / [！UICONTROL文件ID] / [！UICONTROL文件路径]</td> 
   <td> <p>如果选择了[！UICONTROL Enter Manually]，请输入或映射要为其检索共享链接的文件ID或路径。</p> <p>如果从列表中选择[！UICONTROL选择]，则选择要为其检索共享链接的文件。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>选择是希望将文件提供给具有此链接的任何人，还是仅提供给具有此链接的组织成员。</td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>选择包含要移动的文件或文件夹的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>输入包含要移动的文件或文件夹的驱动器ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 包含要移动的文件或文件夹的站点。 可用站点是后跟登录用户的站点。</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>选择要移动文件或文件夹的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>输入要移动文件或文件夹的驱动器ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 要移动文件或文件夹的站点。 可用站点是后跟登录用户的站点。</p> </li> 
     <li> <p><b>[！UICONTROL组的驱动器]</b> </p> <p>选择要将文件或文件夹移动到其驱动器的组。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL驱动器ID]</td> 
   <td> <p>选择或映射包含要移动文件或文件夹的驱动器。 如果您在[！UICONTROL Enable to Enter a Drive ID]字段中选择了[！UICONTROL No] ，则此字段不可用。</p> <p>如果将此项留空，则文件或文件夹只能在同一文件夹内移动 [!DNL OneDrive].</p> <p>您可以将文件和文件夹从[！UICONTROL我的驱动器]移动到[！UICONTROL站点的驱动器]或[！UICONTROL组的驱动器]。 </p> <p>您只能将文件从[！UICONTROL站点的驱动器]移动到同一站点中的同一驱动器。</p> <p>您只能将文件从[！UICONTROL组的驱动器]移动到同一组中的同一驱动器。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL文件夹]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择包含要复制文件的位置：</p> 
    <ul> 
     <li> <p><b>[！UICONTROL我的驱动器]</b> </p> <p>选择是否启用模块以输入驱动器ID。</p> 
      <ul> 
       <li> <p><b>[！UICONTROL是]</b> </p> <p>输入包含要复制的文件或文件夹的驱动器ID。</p> </li> 
       <li> <p><b>[！UICONTROL否]</b> </p> </li> 
      </ul> </li> 
  ...
  <tr> 
   ...
   <td> <p>如果选择了[！UICONTROL手动输入]，请输入或映射要复制的文件的ID或路径。</p> <p>如果您从列表中选择[！UICONTROL选择]，请选择要复制的文件。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL输入新文件夹位置]</td> 
  ...
  <tr> 
   ...
   <td> <p>选择要复制文件服务器的位置。 如果您选择从列表中选择新文件夹位置，则此选项可用。</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 要复制文件的站点。 可用站点是后跟登录用户的站点。</p> </li> 
     <li> <p><b>[！UICONTROL组的驱动器]</b> </p> <p>选择要将文件复制到其驱动器上的组。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL驱动器ID]</td> 
   <td> <p>选择或映射包含要将文件复制到其中的文件夹的驱动器。 如果您在[！UICONTROL Enable to Enter a Drive ID]字段中选择了[！UICONTROL No] ，则此字段不可用。</p> <p>如果将此项留空，则文件或文件夹只能复制到同一[！UICONTROL OneDrive]中。</p> <p>您可以将文件和文件夹从[！UICONTROL我的驱动器]复制到[！UICONTROL站点的驱动器]或[！UICONTROL组的驱动器]。 </p> <p>您只能将文件从[！UICONTROL站点的驱动器]复制到同一站点中的同一驱动器。</p> <p>您只能将文件从[！UICONTROL组的驱动器]复制到同一组中的同一驱动器。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL文件夹]</td> 
  ...
  <tr> 
   ...
   <td> <p>选择要搜索的位置：</p> 
    <ul> 
     ...
     <li> <p><b>[！UICONTROL站点的驱动器]</b> </p> <p>选择 [!DNL SharePoint] 包含要删除的文件或文件夹的站点。 可用站点是后跟登录用户的站点。</p> </li> 
...
* 上传的文件太大，超过了您的文件大小上限。 [!DNL OneDrive] 计划或您已使用所有 [!DNL OneDrive] 帐户的存储配额。 要获得更多存储空间，请从删除现有文件 [!DNL OneDrive] 或升级 [!DNL OneDrive] 帐户。
* OneDrive不允许将两个同名文件上传到一个文件夹。 如果目标文件夹包含与正在上传的文件同名的文件，则场景运行将终止，并出现错误。 解决方案是简单地重命名要上传的文件。 如果您的目的是更新文件，请使用 [!UICONTROL 更新文件] 操作。
* 先前选定的文件夹（文件将上载到该文件夹）不再存在。 场景将停止，您将需要再次选择目标文件夹。
