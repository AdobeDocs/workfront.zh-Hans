...
在 [!DNL Adobe Workfront Fusion] 方案，您可以自动执行使用 [!DNL Microsoft Dynamics 365]，并将其连接到多个第三方应用程序和服务。
...
1. 在任何 [!DNL Microsoft Dynamics 365] 模块，单击 **[!UICONTROL 添加]** 旁边的 [!UICONTROL 连接] 字段。
1. 输入连接的名称。
1. 在 **[!UICONTROL 资源]** 字段，输入您的电子邮件地址 [!DNL Dynamics 365] 帐户，不含 `https://`.
1. 单击 **[!UICONTROL 继续]** 以创建连接并返回模块。

>[!NOTE]
>
>注册时 [!DNL Workfront Fusion] 在您的 [!DNL Microsoft Azure] 门户，请使用以下重定向URI：
>
...
配置时 [!DNL Microsoft Dynamics 365] 模块， [!DNL Workfront Fusion] 显示下面列出的字段。 除此以外，还有 [!DNL Microsoft Dynamics 365] 字段可能会显示，具体取决于应用程序或服务中的访问级别等因素。 模块中的粗体标题表示必填字段。
...
当您指定的对象中的记录是在中的上次计划运行之后创建或更新时，此计划触发器模块会执行一个方案 [!DNL Dynamics 365].
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <td> <p>有关连接 [!DNL Microsoft Dynamics 365] 帐户至 [!DNL Workfront Fusion]，请参见 <a href="#connect-microsoft-dynamics-365-to-workfront-fusion" class="MCXref xref">连接 [!DNL Microsoft Dynamics 365] 到 [!DNL Workfront Fusion]</a> 本文章中。 </p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL Include]</td> 
   <td>选择是否希望该模块监视 <strong>[！UICONTROL Only new records]</strong>， <strong>[！UICONTROL仅更新记录]</strong>，或 <strong>[！UICONTROL新记录和所有更改]</strong>.</td> 
  </tr> 
  <tr> 
...
此即时触发器模块可在您指定的记录（对象）在中创建或更新时执行场景 [!DNL Dynamics 365].
  ...
  <tr> 
   ...
   <td> <p>选择要用于此模块的webhook。 </p> <p>要添加新的webhook，请执行以下操作：</p> 
    <ol> 
     ...
     <li value="3"> <p>在 <strong>[！UICONTROL Connection]</strong> 字段中，选择要使用的连接</p> <p>有关连接 [!DNL Microsoft Dynamics 365] 帐户至 [!DNL Workfront Fusion]，请参见 <a href="#connect-microsoft-dynamics-365-to-workfront-fusion" class="MCXref xref">连接 [!DNL Microsoft Dynamics 365] 到 [!DNL Workfront Fusion]</a> 本文章中。 </p> </li> 
...
通过此操作模块，您可以对 [!DNL Microsoft Dynamics 365] API。 这样，您就可以创建另一个无法实现的数据流自动化 [!DNL Microsoft Dynamics 365] 模块。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择配置API调用所需的HTTP请求方法。 有关更多信息，请参阅 <a href="../../workfront-fusion/modules/http-request-methods.md" class="MCXref xref" data-mc-variable-override="">中的HTTP请求方法 [!DNL Adobe Workfront Fusion]</a>.</p> <p>中的更多信息</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>输入或映射唯一的 [!DNL Microsoft Dynamics 365] 您希望模块删除的记录的ID。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
此操作模块从中的单个实体读取数据 [!DNL Microsoft Dynamics 365].
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[！UICONTROL ID]</td> 
   <td>输入或映射唯一的 [!DNL Microsoft Dynamics 365] 您希望模块读取的记录的ID。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td role="rowheader">[！UICONTROL ID]</td> 
   <td>输入或映射唯一的 [!DNL Microsoft Dynamics] 您希望模块更新的记录的365 ID。</td> 
  </tr> 
 </tbody> 
</table>
...
此搜索模块查找对象中的记录 [!DNL Microsoft Dynamics 365] 匹配您指定的搜索查询的规则。 您可以在场景的后续模块中映射此信息。
  ...
  <tr> 
   ...
   <td> <p>选择要用于此搜索的过滤器。</p> 
    <ul> 
     ...
     <li> <p><strong>[！UICONTROL查询函数]</strong> </p> <p>输入 [!DNL Dynamics 365] 要用于搜索的Web API查询函数。 </p> <p>有关查询函数的更多信息，请参见 <a href="https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/queryfunctions?view=dynamics-ce-odata-9">Web API查询函数参考</a> 在 [!DNL Microsoft] 文档。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
