...
在 [!DNL Adobe Workfront Fusion] 方案，您可以使用 [!UICONTROL Markdown] 将Markdown转换为HTML并将HTML转换为Markdown的模块。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>启用此选项可将GitHub Flavored Markdown转换为HTML。</p> <p>欲了解更多信息，请参见[!DNL ]下拉备忘单 [!DNL GitHub] 文档。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL清理]</td> 
   <td>选择一个选项以指示要从文本中移除HTML标签还是转义HTML。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!DNL GitHub Flavored Markdown] </td> 
   <td> <p>启用此选项可将HTML转换为 [!DNL GitHub Flavored Markdown].</p> <p>有关更多信息，请参阅以下文档中的Markdown备忘单： [!DNL GitHub] 文档。</p> </td> 
  </tr> 
 </tbody> 
</table>
