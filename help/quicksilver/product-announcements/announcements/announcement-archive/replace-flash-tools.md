...
Workfront中现在提供了基于当前标准的替换工具。 这些更改与Adobe宣布的对Flash产品的支持终止一致。
...
有关替换工具的信息，请参阅本文中的[旧版基于Flash的工具及其替换工具](#legacy-flash-based-tools-and-their-replacements)。
