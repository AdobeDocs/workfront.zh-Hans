...
title: 新的评论体验测试版发布活动
description: 查看Adobe Workfront的每周发布活动，了解新的评论Beta版体验。
author: Alina
...
本页上的信息根据新评论测试版体验中包含的功能每周介绍一次的发布活动。 该页面列出了针对新的评论测试版体验添加的新功能和已解决的问题。

有关新的评论测试版体验的一般信息，包括当前可用或正在研究的功能列表，请参阅 [新的评论体验](../new-commenting-experience-beta/unified-commenting-experience.md).
