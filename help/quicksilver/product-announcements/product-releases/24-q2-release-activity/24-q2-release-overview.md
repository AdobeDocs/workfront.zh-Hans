...
代替发布网络研讨会，我们邀请您[注册Adobe Summit](https://summit.adobe.com/na/)以观看以下Workfront讲座：

[Adobe Workfront的未来](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?search=S302)，2024年3月26日，大致了解战略规划和工作流的未来。 了解Workfront团队计划如何在整个营销生命周期中处理业务功能 — 所有这些功能都是通过人工智能优先的方法来自动化工作、简化用户体验并提高生产效率。

[于2024年3月28日推出端到端营销活动计划的营销日历和工具](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?search=s304)，了解旨在使您的组织能够管理和可视化端到端运营生命周期的新产品功能。

您还可以[查看包含24.4版本突出显示内容的PDF文件](https://acrobat.adobe.com/id/urn:aaid:sc:US:1754831a-dbfe-471d-bca7-386264d90352){target="_blank"}。
...
Workfront Fusion中的新增功能在2024年第二季度发布计划之外的“生产”环境中一次提供。 有关最新功能的详细信息，请参阅[Adobe Workfront Fusion发行活动](https://experienceleague.adobe.com/zh-hans/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)。
...
有关2024年第二季度版本中进行的维护更新的信息，请参阅[Workfront维护更新](https://experienceleague.adobe.com/zh-hans/docs/workfront-known-issues/releases/current-updates)。
