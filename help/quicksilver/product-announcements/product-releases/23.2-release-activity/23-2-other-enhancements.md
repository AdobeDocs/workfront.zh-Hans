...
## 初次使用Workfront for Creative Cloud插件

我们已将以下更改添加到Workfront for Creative Cloud插件：
...
## 登记到Adobe Unified Experience的全新客户

2023年3月中下旬，新客户将开始加入Adobe Unified Experience。 新客户在登记到Adobe业务平台后，将按个案进行处理。
