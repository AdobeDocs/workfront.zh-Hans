...
本页介绍了23.1版本中包含的功能信息。 2023年4月6日和7日发布的23.2版本在“生产”环境中提供了这些增强功能。
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>您现在可以直接从对象详细信息将现有任务或问题添加到Workfront展示板或工作流信息卡列表。 您添加到展示板的任何项目都将成为连接的卡片，添加到工作流的任何项目将作为计划外卡片添加到卡片列表。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">将任务和问题从列表和报告添加到工作流信息卡列表</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">将任务和问题从列表和报告添加到Workfront展示板</a></p>
                ...
                <tr>
                    ...
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            ...
                            <li>
                                 <p><span class="preview">生产版本：从3月23日开始，该版本将分阶段发布到生产环境，并将在2023年5月11日之后完成</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>画布功能板已添加为可在布局模板中启用的功能板的进行中功能。 除了新布局选项外，画布仪表板还允许将报告画布可视化与现有报告合并。 目前仅支持列表报告，但随着开发的继续，将添加更多选项。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>我们已将以下更改添加到Workfront以用于Creative Cloud插件：
                        <ul>
                        <li>插件现在会在任务具有前置任务时通知您</li>
                        <li>韩语现在是受支持的语言</li>
                        </ul> </p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">问题Beta版的新评论体验</a>
                        <p>目前正在开发Adobe Workfront中评论体验的更新。 此更新包括一些对象的“更新”部分中的新界面、新功能和改进的性能。 </p>
                        <p>这一新体验最终将统一整个Adobe Workfront以及整个Adobe Experience Cloud中的其他部门的评论工作。 </p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">新客户将加入AdobeUnified Experience</a></p>
                        <p>Adobe统一体验包括：
                        <ul>
                        <li>通过Adobe Experience Cloud对所有Adobe应用程序进行单次登录</li>
                        <li>用于在Workfront组织和环境之间移动的“组织切换器”</li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md" class="MCXref xref" xrefformat="{para}">验证查看器将在新选项卡中打开，以供统一体验中的用户使用</a></p>
...
Workfront Goals 23.2版本中的新增功能。 有关这些现在可在“预览”中使用的新功能的信息，请参阅 [23.2版本中的Adobe Workfront目标](/help/quicksilver/product-announcements/product-releases/goals-release-activity/goals-23-2-release/goals-23-2-release.md).

### API版本16

API版本16将随22.3版本一起发布。 对于API版本16，我们修改了一些资源和端点。 一些更改支持新功能，而其他更改使您能够更轻松地使用通过API获得的信息。
...
为了改进功能板的稳定性和加载时间，功能板中的外部页面将不再能够引用功能板URL。 如果帐户中包含任何引用仪表板的外部页面，系统管理员将收到应用程序内通知，提醒他们存在此更改。 有关更多信息，请参阅 [在功能板中嵌入外部页面](/help/quicksilver/reports-and-dashboards/dashboards/creating-and-managing-dashboards/embed-external-web-page-dashboard.md).
