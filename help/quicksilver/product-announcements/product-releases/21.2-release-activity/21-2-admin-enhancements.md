...
title: 21.2管理员增强功能
description: 本页介绍了在21.2版本中对“预览”环境所做的所有管理员增强。 这些增强功能将在2021年5月10日这一周的“生产”环境中提供。 有关21.2版本中可用的所有更改列表，请参阅21.2版本概述。
author: Luke
...
* 现代化的字体样式和大小
  ...
  ![已在设置中更新标头](assets/updated-headers-in-setup-02-29-21-350x214.png)
...
此功能现已包含在Workfront One上的新Workfront Experience第3部分：控制和界面体验](https://experienceleague.adobe.com/zh-hans/docs/workfront-learn/tutorials-workfront/home)学习路径的[管理员基础知识中。
