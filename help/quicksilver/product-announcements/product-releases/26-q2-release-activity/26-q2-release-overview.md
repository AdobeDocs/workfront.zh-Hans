...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">AI协作者现已可用</a><p>为了让您更轻松地在日常工作中从AI中获益，我们创建了AI协作者。  AI协作者是一种将AI代理加入您的项目和任务的方法。 您可以使用品牌指南配置AI协作器，然后像向用户一样将其分配给任务。</p>
        </td>
        <td><p>2026年4月2日</p></td>
