...
>[!NOTE]
>
>对于每季度的最终版本（本季度25.4版），按快速发布计划的用户将提前一天收到版本。
>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>针对快速版本的生产：25.3版（2025年3月）</li>
                <li>适用于所有客户的生产版本：随25.4版本一起提供（2025年4月）</li>
            </ul>
        </td>
    </tr>                          
</tbody>
...
<tbody>
    <tr>
        <td>
            ...
            Data Connect中现在提供文档批准和决策数据</a><p>[!BADGE In Production &#x200B;]{type=Informational}</p>
...
我们正在更新整个Adobe Workfront的界面以改进用户体验，并将其与其他Adobe应用程序统一。 这些更改将在标准发布计划之外发布。 有关这些更改的列表，请参阅[接口现代化](/help/quicksilver/product-announcements/product-releases/interface-modernization/interface-modernization.md)。

### Workfront Fusion增强

>[!IMPORTANT]
>
>Workfront Fusion文档已移至新位置。 有关Fusion的信息、说明和版本，请访问[Workfront Fusion文档](https://experienceleague.adobe.com/zh-hans/docs/workfront-fusion/using/home)。
>
...
此版本中目前没有更新Workfront Goals。 在有更新可用时，将更新此区域。
...
有关当前支持哪些API版本的信息，请参阅[API版本控制和支持计划](/help/quicksilver/wf-api/api/api-version-support-schedule.md)。
