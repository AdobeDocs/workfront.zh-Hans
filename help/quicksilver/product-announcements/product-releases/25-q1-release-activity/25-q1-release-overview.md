...
>[!IMPORTANT]
>
>23.3版包括将您的组织移至每月版本的选项。 因此，Workfront已更改了版本的编号方案，以考虑月发行轨道和季度发行轨道。 第一个数字表示年份，第二个数字表示发行的月份。 示例：2025年4月的版本为25.4。
>
...
>
>请注意，对于每季度的最终版本（本季度25.1版），按快速发布计划的用户将提前一天收到版本。
>
...
* [讨论区增强功能](#boards-enhancements)
* [文档管理增强功能](#document-management-enhancements)
* [优先级增强](#priorities-enhancements)
* [项目增强功能](#project-enhancements)
* [校样增强功能](#proofing-enhancements)
* [报告和信息板增强功能](#report-and-dashboard-enhancements)
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li>针对快速版本的生产：随着24.12版本的发布（2024年12月12日）</li>
                <li>适用于所有客户的生产版本：使用25.1版本（2025年1月16日）</li>
            </ul>
        </td>
    </tr>     
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>预览版本：2024年11月21日</li>
                <li>针对快速版本的生产：随着24.12版本的发布（2024年12月12日）</li>
                <li>所有客户的生产版本：随25.1版本（2025年1月16日）一起提供</li>
            </ul>
        </td>
    </tr>    
    <tr>
        <td>
            ...
            现在可对本机预输入字段进行筛选</a></p>
            [!BADGE In Production &#x200B;]{type=Informational}
            <p>当您将本地字段引用添加到自定义表单并且它引用预输入字段时（例如Portfolio、公司或所有者），筛选器选项现在可用。 过滤器允许您限制用户在使用该字段时可以选择的对象。 此自定义过滤器的工作方式与自定义预先输入字段上的过滤器相同，都是使用文本模式来定义过滤器。</p>
        </td>
        <td>
            <p><b>在以下日期提供：</b></p>
            <ul>
    ...
    <tr>
        <td>
            ...
            <p>当自定义表单包含多个包含多个字段的部分时，通过拖放操作可能很难将字段从一个部分移动到另一个部分。 每个字段都添加了“移至”图标，允许您选择字段所在的部分。</p>
        </td>
        <td>
            <p><b>在以下日期可用：</b></p>
            <ul>
                <li>预览版本： 2024年10月29日</li>
                <li>针对快速版本的生产：随着24.11版本的发布（2024年11月14日）</li>
                <li>所有客户的生产版本：随25.1版本（2025年1月16日）一起提供</li>
            </ul>
        </td>
    </tr>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            使用智能滤镜按优先级查找您的作品</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
            <p>使用自然语言在“优先级”工作列表中快速筛选工作。 您可以键入以下内容 </p>
            <ul>
                <li>显示迟到任务</li>
                <li>显示本周到期的任务</li>
                <li>显示最高优先级</li>
    ...
    <tr>
        <td>
            ...
            在优先事务中赶上工作</a></p>
            [!BADGE In production &#x200B;]{type=Informative}
            <p>您可以使用“及时跟进”来帮助减少查找有关活动项目信息的时间。</p>
    ...
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-home-enhancements.md" class="MCXref xref" xrefformat="{para}">
            在“优先级”中的“详细信息”页面上实时查看更改</a></p>
            <p>现在，您可以在任务或问题的“详细信息”页面上查看实时更新。 您还可以查看其他人是否与您同时查看页面，并指示是否存在实时在线状态。</p>
        </td>
        [!BADGE In production &#x200B;]{type=Informative}
        <td>
            <p><b>在以下日期提供：</b></p>
    ...
    <tr>
        <td>
            ...
            在优先级中上传和查看文档和验证</a></p>
            [!BADGE In Production &#x200B;]{type=Informational}
            <p>您现在可以与工作列表和日历中任务和问题的文档和验证进行交互。 在新文档选项卡中，您可以</p>
            <ul>
                <li>上传文档</li>
                <li>创建验证</li>
                <li>启动验证查看器</li>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            针对快速发布环境，从“预览”和“生产”中删除了更多相关的分配</a></p>
            [!BADGE In Production &#x200B;]{type=Informational}
...
<tr>
    ...
    <tr>
        ...
        <td>
            <p><b>在以下日期可用：</b></p>
            <ul>
                <li>预览版本： 2024年1月2日</li>
                <li><span class="preview">所有客户的生产版本： 2025年1月9日</span></li>
            </ul>
        </td>
    </tr>
    <tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><b>在以下日期可用：</b></p>
            <ul>
                <li>预览版本： 2025年1月15日</li>
                <li>所有客户的生产版本： 2025年1月15日</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            ...
            [!BADGE In Production &#x200B;]{type=Informational}
            <p>首次访问Data Connect的管理员现在可以选择通过单击单个按钮来创建新的Snowflake阅读器帐户。 该过程需要几分钟才能完成，但无需进一步操作。</p>
        </td>
        <td>
            <p><b>在以下日期提供：</b></p>
            <ul>
...
对于API版本19，我们修改了一些资源和端点。 某些更改支持新功能，而其他更改使您更容易使用通过API获得的信息。

有关新增功能和更新内容的信息，请参阅[API版本19](/help/quicksilver/wf-api/api/new-api-version-19.md)中的新增功能。

有关API版本的信息，请参阅[API版本和支持计划](/help/quicksilver/wf-api/api/api-version-support-schedule.md)。

### Workfront 维护更新

有关2025年第一季度期间所做的维护更新的信息，请参阅[Workfront维护更新](https://experienceleague.adobe.com/zh-hans/docs/workfront-known-issues/releases/current-updates)。
