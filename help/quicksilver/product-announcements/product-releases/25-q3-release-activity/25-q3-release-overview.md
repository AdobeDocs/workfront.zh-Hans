  ...
  <tbody>
    ...
    <tr>
        <td>
            ...
            <p>现有实际小时数字段已重命名为旧版实际小时数。 此字段存储为项目、任务和问题记录的时间（以分钟为单位）。 字段以actualWorkRequired形式存储在Workfront数据库中。 </p>
            <p>我们添加了一个新的实际小时数字段，该字段以小时为单位存储为项目、任务和问题记录的时间，具有十进制精度。 字段以actualWorkRequiredDouble形式存储在Workfront数据库中。</p>
        </td>
        <td>2025年6月24日</td>
        <td>2025年6月24日</td>
        <td>2025年6月24日</td>
