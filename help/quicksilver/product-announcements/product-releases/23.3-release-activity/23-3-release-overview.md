...
>[!IMPORTANT]
>
>23.3版本包括将您的组织移至每月版本的选项。 因此，Workfront正在更改版本的编号方案，以便兼顾每月和每季度的版本跟踪。
>
>* 如果您位于 **快速发布（每月）** 跟踪，23.3之后的版本将 **23.8**，2023年8月31日。
> * 如果您位于 **每季** 版本跟踪，23.3之后的版本将 **23.10**，在2023年10月26日这一周内。
> 
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-admin-enhancements.md" class="MCXref xref" xrefformat="{para}">加快了Workfront的发布周期</a></p>
                        <p>为了让您更快地接收新的Workfront产品功能和更新，我们添加了启用更快发布周期的功能。 现在，您可以选择让您的组织每季度收到一次Workfront版本的频率高于一次。 季度发行周期仍可供偏好发行频率较低的组织使用。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-admin-enhancements.md" class="MCXref xref" xrefformat="{para}">可用于“用户可以在其中记录时间”时间表和小时首选项的组级别控制</a></p>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>您现在可以向展示板上的临时信息卡和已连接信息卡添加注释，并在注释上标记其他用户。 备注可在信息卡详细信息中找到。 展示板的评论功能使用新的Adobe Workfront评论体验。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">板载摄取列上可用的简单过滤器</a></p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">Adobe Creative Cloud集成现在支持多个分配的用户</a></p> 
                        <p>Adobe Creative Cloud集成现在支持在任务或问题有多个分配用户时选择“完成我的部分”和“完成”（或“已解决”）的功能。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">从Workfront查看和管理Workfront通知以用于Creative Cloud插件</a></p> 
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">改进了通过拖放操作将文档移动到链接的文件夹时的体验</a></p> 
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-integration-enhancements.md" class="MCXref xref" xrefformat="{para}">使用Adobe Workfront调整自动验证工作流模板设置以进行Creative Cloud</a></p>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>已从项目、任务和问题的更多菜单中提取了共享选项，以便更直观地共享。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>随着在23.4中弃用独立的Workfront校对应用程序，主Workfront移动设备应用程序已添加校对功能，以便能够在移动设备上继续校对。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p><span class="preview">生产版本：2023年6月21日在Apple App Store和Google Play Store中提供</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
...
<table>
            ...
            <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>在发布到生产环境的23.3版本后不久，新的评论体验将适用于以下对象：模板任务、模板、时间表、团队、用户、程序、项目组合。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
            ...
            <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-other-enhancements.md" class="MCXref xref" xrefformat="{para}">项目、任务和文档的新评论测试版体验</a> </p>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-other-enhancements.md" class="MCXref xref" xrefformat="{para}">没有头像的配置文件现在会显示用户缩写</a></p>
                 ...
                 <tr>
                    <td>
                        ...
                        <p>对“更新”部分的增强功能将在新的注释测试版体验的23.3发行时间范围内提供。 除非另有说明，否则这些增强功能将在23.3版本的生产环境中提供。</p>
                    </td>
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>在以下日期提供：</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">发布到预览后至少2周（除非另有指定）</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>                
...
我们将在23.4版本中正式弃用Proof移动应用程序。 常规Workfront移动设备应用程序已使用新验证功能进行增强(有关更多信息，请参阅Workfront移动设备增强功能下的发行说明)，建议用户尽快开始使用它进行验证工作。

请注意，Workfront移动设备应用程序要求先登录Workfront。 外部用户和来宾可以继续使用校对应用程序进行校对工作；但是，它不再受支持，在23.4中将变得不可用。
