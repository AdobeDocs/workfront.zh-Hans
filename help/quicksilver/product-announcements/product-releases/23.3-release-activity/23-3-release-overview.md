...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-apr-17.md" class="MCXref xref" xrefformat="{para}">展示板电子邮件通知和首选项</a><span style="color: #ff0000;"> 预览中的新增功能！</span></p>
...
此时，版本中没有Workfront Fusion更新。 此区域将在更新可用时进行更新。
