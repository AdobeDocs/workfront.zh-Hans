...
有关详细信息，请参阅[在Workfront Proof中生成验证](../../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/generate-proofs.md)。
...
## 新的Portfolio Optimizer {#new-portfolio-optimizer}

Workfront的Portfolio Optimizer区域现已更新为新外观。 功能没有改变。
