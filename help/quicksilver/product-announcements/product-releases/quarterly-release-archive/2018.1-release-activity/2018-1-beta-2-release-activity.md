...
title: 2018.1 Beta 2发布活动
description: 本页介绍了2018.1 Beta 2版本预览环境中最近提供的所有更改。 2017年12月14日，预览环境中提供了此页面上的功能。 该版本将于2018年3月在生产环境中提供。
author: Luke
...
本页介绍了2018.1 Beta 2版本预览环境中最近提供的所有更改。 2017年12月14日，预览环境中提供了此页面上的功能。 该版本将于2018年3月在生产环境中提供。
...
2018.1测试版2包含面向Workfront管理员和其他用户的增强功能：
...
我们将介绍 **组管理员**. 为了支持此功能， **组所有者** 字段已重命名为 **组管理员** 而指定为组管理员的用户具有管理用户和组的附加权限。
...
有关组管理员的详细信息，请参阅中的“了解组管理员”部分 [创建组](../../../../administration-and-setup/manage-groups/create-and-manage-groups/create-a-group.md).

### 组管理员的布局模板管理 {#layout-template-management-by-group-administrators}

我们将介绍 **具有管理访问权限的组** ，以便与布局模板关联。
...
有关配置信息在甘特图上的显示方式的更多信息，请参阅 [配置信息在甘特图上的显示方式](../../../../manage-work/gantt-chart/use-the-gantt-chart/configure-info-on-gantt-chart.md).
...
有关在Business Case中完成预算项目资源的详细信息，请参阅 [业务案例中的预算资源](../../../../manage-work/projects/define-a-business-case/budget-resources-in-business-case.md).

## 资源规划者 — 用户分配图中的可视化 {#visualization-in-the-resource-planner-user-allocation-chart}

您现在可以在资源规划者图表中显示所有用户相对于其可用性的总计划分配。 当您选择时，图表可用 **按用户查看** 在资源规划者中。
...
* 在请求中单击“处理它”后，与问题关联的字段将显示在右侧面板中。
  ...
  有关处理来自主页区域的请求的更多信息，请参阅 [在“主页”区域管理工作和团队请求](../../../../workfront-basics/using-home/using-the-home-area/manage-work-and-team-requests-home.md) 在 [在“主页”区域管理工作和团队请求](../../../../workfront-basics/using-home/using-the-home-area/manage-work-and-team-requests-home.md).

* 指向左侧面板中工作项上的用户头像，以查看用户的名称。
* 展开左侧面板中的“延迟”区域以查看所有延迟的项目（当此区域折叠时，仅显示前5项）。
* 将某个项目标记为“完成”后，该项目将保留在左侧面板中，直到您选择另一个项目为止。\
  有关显示已完成项目的信息，请参见 [在“主页”区域的工作列表中显示项目](../../../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md) 在 [在“主页”区域的工作列表中显示项目](../../../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md).

有关使用新“主页”区域的详细信息，以及描述“我的工作”和“主页”之间功能差异的信息，请参阅 [使用“主页”区域](../../../../workfront-basics/using-home/using-the-home-area/use-the-home-area.md).
