...
title: 2019.3版活动概述
description: 本页介绍了2019.3版本中包含的功能。 此页面上的功能在2019年8月19日当周的生产环境中提供。 有关发布时间的特定日期和时间，请参阅Workfront信任网站。
author: Luke
...
* [“打开”筛选器现在在问题列表中显示更多结果](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#changes)
  ...
  * <MadCap:conditionalText data-mc-conditions="OnlineOrPDF.OnlineOnly">  <a href="../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#new" class="MCXref xref" xrefformat="{para}">New experience when inline editing information in lists</a> </MadCap:conditionalText><MadCap:conditionalText data-mc-conditions="OnlineOrPDF.PrintOnly">  <a href="https://experience.workfront.com/s/article/2019-3-Project-enhancements-1332102832" target="_blank" data-mc-conditions="QuicksilverOrClassic.Draft mode">New experience when inline editing information in lists</a> </MadCap:conditionalText>
  ...
  当在新列表中内联编辑信息时，已编辑的行将灰显，但信息将保持可见。
...
* [在不启用特殊编辑模式的情况下编辑甘特图](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#edit)
  ...
  现在，在启用或未启用自动保存的情况下，您可以编辑任务列表甘特图。

* [“项目”、“任务”和“问题小时”选项卡的更新列表](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#updated2)
...
* [用于隐藏资源规划者中实际小时数列的新设置](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#new2)
  ...
  现在，在资源规划程序中按用户查看信息时，您可以显示或隐藏“实际小时数”列。

* [资源池在Business Case的资源预算区域中是持久性的](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-resource-planning-enhancements.md#resource)
  ...
  现在，当您在Business Case的“资源预算”区域中预算资源时，当您离开页面并返回时，已保存在项目中的资源池是永久性的。
...
* [所有Workfront登录都需要定义域规范](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#domain)
  ...
  现在，如果尚未在Workfront URL中指定域，则所有Workfront登录都要求用户指定域。 要求提供此信息可使Workfront实例更加安全。

* 适用于Blackberry Marketplace的Workfront移动应用程序（即将推出）
...
* [用于在移动设备上自动注销用户的新设置](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#new2)
  ...
  为了让您和您的公司更安全Workfront移动应用程序，用户将在处于非活动状态8分钟后自动注销。

* [按移动设备应用程序中的无效项目进行筛选](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-integration-mobile-enhancements.md#filter) [按移动设备应用程序中的无效项目进行筛选](https://experience.workfront.com/s/article/2019-3-Integration-and-mobile-enhancements-1150184880)

  我们已在移动应用程序的“项目”选项卡上添加了“停止的项目”作为过滤器选项。
...
我们新增了一些外观和感觉改进，以增强您在Workfront移动设备应用程序中的体验。
...
此部分介绍了在2019.3发布时间范围内所做的更改，这些更改将在2019.3常规版本之前发布到生产环境。
...
* [更改自定义表单中字段的显示类型](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019.3-project-enhancements.md#change)
  ...
  现在，您可以在自定义表单中更改字段的显示类型。

  例如，如果已创建复选框字段，则可以将其更改为下拉字段或单选按钮字段。 这三种场显示类型可以互换。
...
您现在可以决定是否允许任务的主要被分派人的休假计划调整计划日期。
...
现在，当您对文档进行注释时，更新会显示在文档以及附加文档的对象的“更新”选项卡上。
...
当您将用户分配给任务或问题时，如果所选用户在任务或问题的计划日期之间安排了任意时间的休息时间，您现在可以看到内联警告。
...
我们已在自定义表单生成器中创建了一个名为Typeahead的新字段类型。 此字段允许您向自定义表单添加表示对象的字段。
...
Workfront Library是一个企业数字内容中心，您可以使用它来管理组织数字资产的整个生命周期。

### 不再支持API版本3 {#api-version-3-no-longer-supported}

对API版本3的支持已于2018年11月终止。 有关Workfront API版本支持计划的更多信息，请参阅 [API版本控制和支持计划](../../../../wf-api/api/api-version-support-schedule.md)
...
了解更多有关“ ”期间将推出的功能 [第3季度路线图网络研讨会](https://event.on24.com/eventRegistration/EventLobbyServlet?target=reg20.jsp&amp;partnerref=Product&amp;eventid=2040896&amp;sessionid=1&amp;key=EFBB434E2FDF446E010DA62D1C27E9E5&amp;regTag=&amp;sourcepage=register) 8月1日上午9点。 MST.
