...
## 在项目群或Portfolio的项目列表甘特图中查看任务信息 {#view-task-information-in-the-project-list-gantt-chart-in-a-program-or-portfolio}
