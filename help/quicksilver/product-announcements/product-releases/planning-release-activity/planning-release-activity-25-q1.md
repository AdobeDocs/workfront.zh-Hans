...
>[!NOTE]
>
>预览版本： 2024年12月5日；适用于所有客户的生产版本： 2024年12月5日

在Workfront Planning中查找字段类型时，我们添加了智能搜索功能。 现在，您可以在键入关键字时查找字段类型。 例如，键入“Price”将查找“Number”和“Currency”字段类型。 在此增强功能之前，您只能搜索实际的字段类型名称。

有关信息，请参阅[创建字段](/help/quicksilver/planning/fields/create-fields.md)。

## 用于单选或多选字段的颜色编码选项的自定义拾色器

>[!NOTE]
>
>预览版本： 2024年12月5日；用于快速发布的生产：用于24.12版（2024年12月12日）；用于季度发布的生产：用于25.1版（2025年1月）

现在，您可以在创建或编辑单选或多选字段时进行自定义颜色选择。 创建或编辑具有颜色编码选项的字段时，单击颜色图标将打开拾色器框。 您可以从预定义的颜色中进行选择，也可以使用十六进制代码或色谱创建自定义颜色。
...
>[!NOTE]
>
>预览版本： 2024年11月27日；用于快速发布的生产：用于24.12版（2024年12月12日）；用于季度发布的生产：用于25.1版（2025年1月）
...
>[!NOTE]
>
>预览版本： 2024年11月26日；用于快速发布的生产：用于24.12版（2024年12月12日）；用于季度发布的生产：用于25.1版（2025年1月）
...
>[!NOTE]
>
>预览版本： 2024年11月22日；用于快速发布的生产：用于24.12版（2024年12月12日）；用于季度发布的生产：用于25.1版（2025年1月）
...
>[!NOTE]
>
>预览版本： 2024年11月20日；用于快速发布的生产：用于24.12版（2024年12月12日）；用于季度发布的生产：用于25.1版（2025年1月）
...
>[!NOTE]
>
>预览版本： 2024年11月7日；用于快速发布的生产版本：用于24.12版本（2024年12月12日）；用于季度发布的生产版本：用于25.1版本（2025年1月）
