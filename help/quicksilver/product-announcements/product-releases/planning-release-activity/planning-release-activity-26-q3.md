...
>[!NOTE]
>
>适用于所有客户的预览和生产： 2026年6月30日
>[!BADGE 超出计划]{type=Neutral}

Planning中的全局搜索框现在会记住您最近的搜索：最近7个访问过的工作区、记录类型和视图显示在带有明确标记的专用部分中，因此您可以快速访问它们，而无需重新运行查询。

最新结果会考虑当前权限，并且最新项目的列表与实时搜索结果在视觉上有所不同。 与之前一样，您可以使用键盘组合从Planning登陆页面或任何页面访问搜索。

有关详细信息，请参阅[Workspace概述](/help/quicksilver/planning/architecture/workspaces-overview.md)。
...
>[!NOTE]
>
>适用于所有客户的预览和生产： 2026年6月5日
>仅适用于也拥有Adobe GenStudio for Performance Marketing的Adobe Workfront Planning客户。
>[!BADGE 超出计划]{type=Neutral}
...
>[!NOTE]
>
>适用于所有人的预览和生产： 2026年5月28日
>仅适用于同时拥有Adobe GenStudio for Performance Marketing和Adobe Experience Manager的Adobe Workfront Planning客户。
>[!BADGE 超出计划]{type=Neutral}
...
>
>面向所有客户的预览和生产： 2026年5月14日
>仅适用于也拥有Adobe Experience Manager的Adobe Workfront Planning客户。
>[!BADGE 超出计划]{type=Neutral}
