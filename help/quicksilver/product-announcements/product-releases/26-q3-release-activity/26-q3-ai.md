...
将Workfront Workflow和Workfront Planning连接到任何与MCP兼容的人工智能平台，包括Claude、ChatGPT、Copilot、Gemini等，并使用自然语言查找、创建、更新和管理Workfront项目，而不会离开您选择的人工智能工具。 询问您超期的任务、推送项目的完成日期、向审批者发送提醒、更新活动预算，并且您的AI平台可以在Workfront中为您工作。
