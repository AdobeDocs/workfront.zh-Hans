...
有关任何Workfront模块的详细信息，请参阅文章[Workfront模块](/help/quicksilver/workfront-fusion/apps-and-their-modules/workfront-modules.md)中该模块的部分。
...
有关通过AdobeUnified Experience访问Fusion的信息，请参阅 [!DNL Workfront Fusion]](/help/quicksilver/workfront-fusion/fusion-in-admin-console/fusion-unified-experience.md)的[[!DNL Adobe Unified Experience] 。
...
有关创建与Adobe Target的连接的信息，请参阅Adobe Target模块一文中的[创建与 [!DNL Adobe Target]](/help/quicksilver/workfront-fusion/apps-and-their-modules/adobe-target-modules.md#create-a-connection-to-adobe-target)的连接。
