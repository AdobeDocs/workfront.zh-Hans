...
如果您要连接到Campaign版本8或更高版本，则 **必须** 创建服务器到服务器连接。

有关在Adobe Campaign Classic连接器中创建连接的更多信息，请参阅 [连接 [!DNL Adobe Campaign Classic] 到 [!DNL Adobe Workfront Fusion]](/help/quicksilver/workfront-fusion/apps-and-their-modules/adobe-campaign-classic-connector.md#connect-adobe-campaign-classic-to-adobe-workfront-fusion) 在文章中 [Adobe Campaign Classic模块](/help/quicksilver/workfront-fusion/apps-and-their-modules/adobe-campaign-classic-connector.md).
