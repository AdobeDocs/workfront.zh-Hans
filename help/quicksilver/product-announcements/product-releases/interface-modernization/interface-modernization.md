...
“新建里程碑路径”和“编辑里程碑路径”框现在具有新界面。 里程碑路径列表具有新外观，此区域中的某些功能可能已更改。
...
**预览版本： 2025年9月30日；生产版本：从2025年10月2日起的一周开始**

在编辑或添加组时间表配置文件时，我们更新了“时间表配置文件”页面的外观。

要查看这些更改，请转到设置>组>选择组名称>时间表配置文件，然后添加新配置文件或编辑现有配置文件。
...
**预览版本： 2025年10月2日；生产版本： 2025年10月9日**

我们更新了Status列表的外观，以与应用程序其他区域中的设计相匹配。
...
界面中的一个可见变化是，要使严重性成为默认严重性或删除严重性，必须选中严重性名称旁边的复选框，然后从屏幕底部的操作栏中选择一个选项。

要查看这些更改，请转到“设置”>“项目首选项”>“严重程度”。

有关详细信息，请参阅[创建或自定义问题严重程度](/help/quicksilver/administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-customize-issue-severities.md)。
...
界面中一个可见的更改是，要将优先级设为默认优先级或删除优先级，必须选中优先级名称旁边的复选框，然后从屏幕底部的操作栏中选择一个选项。

要查看这些更改，请转到“设置”>“项目首选项”>“优先级”。

有关详细信息，请参阅[创建和自定义优先级](/help/quicksilver/administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/create-customize-priorities.md)。
...
我们更新了项目上“计费费率”页面的外观，以匹配应用程序的其他方面。 用于添加和编辑计费率的对话框也已更新。

要查看此更改，请转到项目>记帐费率。

有关信息，请参阅[覆盖项目级别](/help/quicksilver/manage-work/projects/project-finances/override-job-role-billing-rates-at-the-project-level.md)的工作角色记帐费率。
...
我们更新了“用户详细信息”页面的外观，以匹配应用程序的其他区域。

您可以转到用户，选择一个用户，然后单击左侧面板中的详细信息来查看更新的设计。
...
有关信息，请参阅[2025年第四季度管理员增强功能](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-admin-and-setup.md)页面上的[将用户添加到Workfront用户配置文件](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/add-users.md)和[更新](/help/quicksilver/product-announcements/product-releases/25-q4-release-activity/25-q4-admin-and-setup.md#updates-to-the-workfront-user-profile)。
...
**预览版本： 2025年6月27日；生产版本： 2025年7月10日**
