...
<table>
    ...
    <col style="width: 50%;" />
        <tbody>
            ...
            <tr>
                <td>
                    Workfront中提供了<a href="/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Adobe AI助手</a></p>
                    [!BADGE In Production &#x200B;]{type=Informational}
