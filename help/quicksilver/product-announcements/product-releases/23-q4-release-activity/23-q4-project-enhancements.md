...
有关使用新文档审批的详细信息，请参阅[新文档审批概述](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md)。
...
有关详细信息，请参阅[创建问题](/help/quicksilver/manage-work/issues/manage-issues/create-issues.md)。
