...
用户具有 [!UICONTROL 管理员] 或 [!UICONTROL 账单管理员] 用户档案还可以在帐户设置中为其他用户的帐户设置验证默认值。
...
1. 单击 **[!UICONTROL 默认电子邮件通知设置]** 以将其展开。
1. 在下面两个设置右侧的下拉列表中，选择下表说明的选项之一。

   * **[!UICONTROL 默认电子邮件警报]**：影响与您共享的每个验证。 可以在验证级别覆盖此设置。
   * **[!UICONTROL 新访客审阅人的默认电子邮件警报]**：影响以前不作为帐户联系人存在的审阅人。

   >[!NOTE]
   >
   >如果不选择下列选项之一， [!DNL Workfront Proof] 向您发送有关校样活动的每日摘要。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>[!DNL Workfront] 仅当您有其他活动时，才会发送一封电子邮件，其中包含列出的所有评论、回复和决策。<p>此警报非常适合用于查看项目摘要，而不会在一天之内出现多次更新。</p><p>此摘要的示例用例是一个部门领导，他想要监控项目的整体进度。</p><p>有关更多信息，请参阅 <a href="../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/manage-notifications-for-proof-comments.md" class="MCXref xref">管理验证评论和决策的通知</a>.</p></td> 
     </tr> 
     <tr data-mc-conditions=""> 
      <td role="rowheader">[！UICONTROL无电子邮件]</td> 
      <td>[!DNL Workfront] 不发送任何电子邮件警报。<br>这对于仅出于参考目的添加到验证而无需通知任何更改的人员非常有用。<p>系统默认值为[！UICONTROL Daily summary] （也称为[！UICONTROL未设置]）。 如果您或您的审阅人没有进行任何其他更改，则您的所有验证均具有此设置。</p></td> 
     </tr> 
    </tbody> 
   </table>
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>指定在创建验证时是否要接收[！UICONTROL Proof maked]电子邮件。 有关更多信息，请参阅 <a href="../../../workfront-proof/wp-emailsntfctns/proof-notifications-and-reminders/proof-made-email.md" class="MCXref xref">[！UICONTROL Proof Made]电子邮件</a></td> 
     </tr> 
     <tr> 
...
1. 下 **[!UICONTROL 消息设置]**，更改以下任一项：

   | 校对模板 | 描述 |
   |---|---|
   | **[!UICONTROL 校对主题模板]** | 显示在新验证页面、新版本页面、消息页面和提醒页面上。 可以在发送之前进行编辑。 |
   | **[!UICONTROL 验证消息模板]** | 显示在新验证页面、新版本页面、消息页面和提醒页面上。 可以在发送之前进行编辑。 |

## 更改收件人的电子邮件警报

您可以在批处理操作中更改特定收件人的电子邮件警报。

1. 单击 **[!UICONTROL 联系人]** （在左侧导航面板中）。
1. 单击 **[!UICONTROL 更多]** 菜单 ![](assets/more-button-small.png) 对于收件人，然后单击 **[!UICONTROL 查看成员详细信息]** （在下拉菜单中）。

1. 打开 **[!UICONTROL 共享的项目]** 部分。
1. 选中要更改其电子邮件警报的每个项目左侧的复选框。
1. 单击 **[!UICONTROL 更多]** 在共享项目列表上方单击，然后单击 **[!UICONTROL 更改电子邮件警报]** （在下拉菜单中）。

1. 更改电子邮件警报，然后单击 **[!UICONTROL 提交]**.

## 为用户配置校对默认值

如果您是 [!DNL Workfront Proof] 管理员，您可以为帐户中的用户设置验证默认值。

1. 单击 **[!UICONTROL 设置]** > **[!UICONTROL 帐户设置]**.

1. 打开 **[!UICONTROL 用户]** 选项卡。
1. 打开 **[!UICONTROL 更多]** 菜单 ![More_button_small.png](assets/more-button-small.png) 用户名右侧。

1. 单击 **[!UICONTROL 查看用户详细信息]** （在下拉菜单中）。
1. 下 **[!UICONTROL 设置]**，单击 **[!UICONTROL 默认电子邮件警报设置]** 以将其展开。
...
1. 在下列两个设置右侧的下拉列表中，选择下表说明的选项之一：
   ...
   * **[!UICONTROL 新访客审阅人的默认电子邮件警报]**：影响以前不作为帐户联系人存在的审阅人。
   ...
   >[!NOTE]
   >
   >如果您没有为用户选择以下选项之一， [!DNL Workfront Proof] 向用户发送有关其验证活动的每日摘要。
...
1. 剩余 **[!UICONTROL 默认电子邮件警报设置]**，更改以下任一项：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      <td role="rowheader">[！UICONTROL验证就绪时电子邮件确认]</td> 
      <td>指定在创建验证时是否要接收[！UICONTROL Proof maked]电子邮件。 有关更多信息，请参阅 <a href="https://support.workfront.com/hc/en-us/article">[！UICONTROL Proof Made]电子邮件。</a></td> 
     </tr> 
     <tr> 
      <td role="rowheader">[！UICONTROL发送给我的电子邮件格式] </td> 
