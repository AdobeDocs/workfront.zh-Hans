...
除[!DNL Adobe Workfront]许可证外，[!DNL Scenario Planner]还需要单独的许可证。 有关[!DNL Workfront Scenario Planner]的信息，请参阅[概述 [!DNL Scenario Planner] ](../scenario-planner/scenario-planner-overview.md)。

作为业务经理，您可以使用[!DNL Adobe Workfront Scenario Planner]概述组织的1年、3年或5年计划，从而概述组织的短期和长期未来战略。

## 访问要求

要使用[!DNL Adobe Workfront Scenario Planner]，您必须具有以下访问权限：
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"> <p><a href="https://www.workfront.com/plans" target="_blank">[!DNL Adobe Workfront]计划</a>*</p> </td> 
   <td>[！UICONTROL Business]或更高版本</td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>许可证类型*</p> </td> 
   <td> <p>[！UICONTROL Review]或更高版本。 有关详细信息，请参阅<a href="../administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md" class="MCXref xref">[!DNL Adobe Workfront]许可证概述</a>。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>[！UICONTROL View]或更高版本对 [!DNL Scenario Planner]</p> <p>注意：如果您仍然没有访问权限，请咨询Workfront管理员是否对您的访问级别设置了其他限制。 有关Workfront管理员如何更改访问级别的信息，请参阅<a href="../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">创建或修改自定义访问级别</a>。</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td role="rowheader"> <p>对象权限</p> </td> 
   <td> <p>计划的[！UICONTROL View]权限或更高版本<!--
      <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
        (NOTE: this might change if they have permissions for initiatives/ scenarios, etc) 
      </MadCap:conditionalText>
     --></p> <p>有关请求对计划的附加访问权限的信息，请参阅<a href="../scenario-planner/request-access-to-plan.md" class="MCXref xref">在[!DNL Scenario Planner]</a>中请求对计划的访问权限。</p> </td> 
  </tr> 
 </tbody> 
</table>
