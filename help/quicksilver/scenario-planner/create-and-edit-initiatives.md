...
有关什么是计划的详细信息，请参阅[中的 [!DNL Scenario Planner]](../scenario-planner/initiatives-overview.md)计划概述。
...
1. （可选）从&#x200B;**[!UICONTROL 月]**&#x200B;下拉菜单中，选择以下选项之一以更改计划的时间表：
   ...
   | 下拉菜单选项 | 描述 |
   |---|---|
   | [!UICONTROL Month] | 按月显示时间线。 这是一年计划的默认选项。 |
   | [!UICONTROL 季度] | 按季度显示时间线。 仅当计划的[!UICONTROL 持续时间]为3年或5年时，此选项才可用。 这是3年计划的默认选项。 |
   | [!UICONTROL Year] | 按年显示时间线。 仅当计划的[!UICONTROL 持续时间]为5年时，此选项才可用。 这是5年计划的默认选项。 |
