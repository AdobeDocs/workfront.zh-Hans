...
description: Workfront for Experience Manager增强型连接器可以自动捕获从构思到交付的元数据。 通过提高资产存储库中的可搜索性来提高内容速度。 用户可通过搜索项目标题、参考编号、日期或任何其他关联的元数据属性，轻松查找与特定Workfront项目关联的所有资源。
author: Courtney
...
Workfront for Experience Manager增强型连接器可以自动捕获从构思到交付的元数据。 通过提高资产存储库中的可搜索性来提高内容速度。 用户可通过搜索项目标题、参考编号、日期或任何其他关联的元数据属性，轻松查找与特定Workfront项目关联的所有资源。
