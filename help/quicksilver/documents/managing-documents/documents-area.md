...
新文档区域仅在您的组织位于企业存储上时才可用。 有关企业存储的更多信息，请参阅[Adobe企业存储概述](/help/quicksilver/review-and-approve-work/esm-overview.md)。
...
* 新文档区域已针对宽度或大于1024像素的屏幕进行了优化。 如果您的屏幕较小，则访问“摘要”面板时可能会遇到问题。
