...
title: 为Experience Manager Assets或Assets Essentials校样链接的资产
description: 从Experience Manager Assets Essentials链接资产后，您可以创建校样并分配用户以审核资产并向资产添加评论。
author: Courtney
...
# 为Experience Manager Assets或Assets Essentials校样链接的资产

从Experience Manager Assets Essentials链接资产后，您可以创建校样并分配用户以审核资产并向资产添加评论。
...
1. 选择以下选项之一：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      <td role="rowheader"><strong>简单校样</strong></td> 
     ...
     <tr> 
      <td role="rowheader"><strong>高级校样</strong></td> 
