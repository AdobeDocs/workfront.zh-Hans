...
title: 查看或下载从Experience Manager Assets或Assets Essentials链接的资源
description: 您可以在Adobe Workfront中查看或下载从Experience Manager Assets或Assets Essentials链接的资源。
author: Courtney
...
1. 在右侧的文档摘要中，将鼠标悬停在顶部的缩略图上，然后选择&#x200B;**预览**&#x200B;或&#x200B;**下载**。
   ...
   ![预览或下载](assets/preview-or-download-350x107.png)
