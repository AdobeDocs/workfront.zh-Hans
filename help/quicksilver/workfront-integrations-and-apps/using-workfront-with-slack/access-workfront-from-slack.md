...
有关可从Slack为[!DNL Workfront]运行的所有命令的列表，请参见 [!DNL Slack]](#access-workfront-from-a-slash-command-in-slack-access-workfront-from-a-slash-command-in-slack)中的[Access [!DNL Workfront] slash命令。
...
1. 从以下选项中取消选择，以禁用Workfront设置：
   ...
   * 在&#x200B;**[!UICONTROL 常规设置]**&#x200B;区域中，禁用&#x200B;**[!UICONTROL 在[!DNL Slack]渠道中粘贴[!DNL Workfront] URL时，如果不想让[!DNL Slack]在共享[!UICONTROL Slack]中对象的URL时添加有关[!DNL Workfront]对象的其他信息，则显示&#x200B;其他描述、截止日期或请求者姓名]**&#x200B;设置。
