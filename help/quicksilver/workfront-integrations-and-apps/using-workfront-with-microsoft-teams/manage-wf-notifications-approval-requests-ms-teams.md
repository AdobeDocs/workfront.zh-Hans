...
title: 管理 [!DNL Adobe Workfront] 中的通知 [!DNL Microsoft] 团队
description: 您可以接收通知 [!DNL Adobe Workfront] 关于需要批准的项目、已给予您的工作分配，或您关联项目的注释和更改。
author: Becky
...
这些通知包含 [!DNL Workfront] 您可以在中执行的操作 [!DNL Microsoft Teams] 无需导航离开 [!DNL Microsoft Teams] 完成任务。
...
## 接收的先决条件 [!DNL Workfront] 中的通知 [!DNL Microsoft Teams]

您可以接收 [!DNL Workfront] 中的通知 [!DNL Microsoft Teams] 如果满足以下条件：

* 已安装和配置团队所有者 [!DNL Workfront for Microsoft Teams] 为你的团队准备的。
* 您已登录 [!DNL Workfront] 从 [!DNL Microsoft Teams].
* 您已在中启用即时通知 [!DNL Workfront]. 有关启用即时通知的信息，请参阅 [修改您自己的电子邮件通知](../../workfront-basics/using-notifications/activate-or-deactivate-your-own-event-notifications.md).

有关安装的信息 [!DNL Workfront for Microsoft Teams] 并登录到 [!DNL Workfront from Microsoft Teams]，请参见 [安装 [!DNL Adobe Workfront for Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/install-workfront-ms-teams.md).

## 管理 [!DNL Workfront] 中的通知 [!DNL Microsoft Teams]

当 [!DNL Workfront for Microsoft Teams] 已安装应用程序，已 [!DNL Workfront] 聊天渠道创建于 [!DNL Microsoft Teams] 给团队的每个成员。 在中执行特定操作时 [!DNL Workfront]，您可以配置的设置 [!DNL Workfront for Microsoft Teams] 以在中接收有关该操作的通知 [!DNL Workfront] 聊天渠道 [!DNL Microsoft Teams].

使用时，请考虑以下事项 [!DNL Workfront] 通知来源 [!DNL Microsoft Teams]：

* 您不能接收全部，只能接收选定数量的 [!DNL Workfront] 中的通知 [!DNL Microsoft Teams].
* 您从收到的所有通知 [!DNL Workfront] 显示在 [!DNL Workfront] 机器人聊天频道。

  有关安装的信息 [!DNL Workfront] 机器人渠道，请参见 [登录 [!DNL Workfront] 从 [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/install-workfront-ms-teams.md#logging-in-to-workfront) 中的部分 [安装 [!DNL Workfront for Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/install-workfront-ms-teams.md) 文章。

* 进行更新的时间间隔最长为5分钟 [!DNL Workfront] 当您在中收到有关该事件的通知时 [!DNL Microsoft Teams].
* 对于每个 [!DNL Microsoft Teams] 通知时，您还会收到电子邮件通知。

要管理 [!DNL Workfront] 您可在中收到的通知 [!DNL Microsoft Teams]：

1. 单击 **[!UICONTROL 更多内容]** （三点）应用程序图标，位于左侧导航栏中 [!DNL Microsoft Teams].
...
1. 转到 **[!UICONTROL 聊天]** 区域并单击 **[!DNL Workfront]** 机器人渠道。\
   此频道用于您与 [!DNL Workfront] 机器人。 全部 [!DNL Workfront] 通知将显示在此处。
1. 根据您收到的通知类型，转到相关部分：
...
* **[!UICONTROL 批准]**：单击以批准项目。
* **[!UICONTROL 更改]**：单击以批准有更改的项目。
* **[!UICONTROL 拒绝]**：单击以拒绝项目。
* **[!UICONTROL 注释]**：单击以发表评论。 您的评论也会出现在 [!DNL Workfront] 作为通知所属对象的更新。
* **[!UICONTROL 前往校对]**：单击以打开验证。 然后，您可以直接在验证中做出决定。 有关更多信息，请参阅 [在验证查看者中做出验证决策](../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/make-a-decision-on-a-proof/make-decisions-on-proof.md).
...
* **[!UICONTROL 处理它]**：选择以提交此项上的工作。 系统会短暂显示通知，确认您已将新项目添加到工作列表。
* **[!UICONTROL 在中查看[!DNL Workfront]]**：选择以在Workfront中查看分配的问题或任务，这将打开一个新选项卡。
* **[!UICONTROL 开始]**：单击以开始处理项目。 系统会短暂显示通知，确认您已将新项目添加到工作列表。
* **[!UICONTROL 注释]**：单击可对项目进行评论。 您的备注也会在Workfront的项目更新流中显示。
...
* **代表光年**：单击以回复评论或 [!UICONTROL 更新]. 您的回复也会出现在更新流中，评论会显示在Workfront中。
* **[!UICONTROL 在Workfront中查看]**：选择以在Workfront中查看评论和项目，该选项卡将在新选项卡中打开。
* **[!UICONTROL 状态]**：单击，然后为注释或更新所关联的工作项选择新状态。
...
* **在Workfront中查看**：选择以在Workfront中查看评论和项目，该选项卡将在新选项卡中打开。
