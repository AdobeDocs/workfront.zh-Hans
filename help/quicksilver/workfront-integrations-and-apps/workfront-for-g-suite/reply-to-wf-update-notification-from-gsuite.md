...
title: 回复Google Workspace的 [!DNL Adobe Workfront] 更新通知
description: 当您在 [!DNL Adobe] [!DNL Workfront]中收到有关更新的通知时，可以从Workfront快速发布针对Google Workspace的回复。
author: Becky
...
# 回复来自[!DNL Adobe Workfront]的[!DNL Google Workspace]更新通知
...
当您在[!DNL Adobe Workfront]中收到有关更新的通知时，您可以快速发布来自[!DNL Workfront for Google Workspace]的回复。
