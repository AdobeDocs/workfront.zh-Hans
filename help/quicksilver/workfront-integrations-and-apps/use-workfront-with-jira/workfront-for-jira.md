...
title: 适用于Jira的Adobe Workfront：文章索引
description: Adobe Workfront Fusion提供了与Jira的集成。 本文链接到安装和配置此集成的说明，以及如何在日常工作中使用它。
author: Becky
...
>
>有关Jira的Workfront自动化和集成模块的特定功能的信息，请参阅[Jira软件模块](https://experienceleague.adobe.com/zh-hans/docs/workfront-fusion/using/references/apps-and-their-modules/third-party-app-connectors/jira-modules-new)。
...
* [链接介于 [!DNL Adobe Workfront] 和 [!DNL Jira]之间的项目](../../workfront-integrations-and-apps/use-workfront-with-jira/link-items-between-wf-jira.md)
* [更新 [!DNL Jira] 和 [!DNL Adobe Workfront]之间的链接项](../../workfront-integrations-and-apps/use-workfront-with-jira/update-linked-items-between-jira-wf.md)
