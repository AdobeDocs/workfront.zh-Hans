...
title: 创建 [!DNL Anaplan] 列表项 [!DNL Adobe Workfront] 预算请求
description: 此集成方案将链接 [!DNL Adobe Workfront] 项目（营销活动） [!DNL Anaplan] 预算列表项。 这可通过向 [!DNL Workfront] 需要获得资金的项目。 此方案会监视未处理的预算请求，然后执行一个流程以在 [!DNL Anaplan] 启动Anaplan中的预算分配流程。
author: Becky
...
# 创建 [!DNL Anaplan] 列表项 [!DNL Adobe Workfront] 预算请求

此集成方案将链接 [!DNL Adobe Workfront] 项目（营销活动） [!DNL Anaplan] 预算列表项。 这可通过向 [!DNL Workfront] 需要获得资金的项目。 此方案会监视未处理的预算请求，然后执行一个流程以在 [!DNL Anaplan] 启动预算分配流程 [!DNL Anaplan].
...
* A **[!UICONTROL 预算请求]** 附加到的自定义表单 [!UICONTROL 请求] 对象。

   自定义表单中必须包含以下必填字段，以便帮助将数据映射到 [!DNL Anaplan]:
   ...
   <tbody> 
    <tr> 
     ...
     <td> <p>[!UICONTROL下拉列表]</p> <p>选项:</p> 
      <ul> 
       <li> <p>[!UICONTROL对资金的调整]</p> </li> 
       <li> <p>[!UICONTROL Initial Funding]</p> </li> 
      </ul> </td> 
    </tr> 
    <tr> 
     <td role="rowheader">[!UICONTROL请求的人工资金]</td> 
     <td> </td> 
    </tr> 
    <tr> 
     <td role="rowheader">[!UICONTROL请求的费用基金]</td> 
     <td> </td> 
    </tr> 
   </tbody> 
  </table>
...
* 代表营销活动和其他需要资金的项目模板，配置有 [!UICONTROL 预算请求] 队列主题。 的 [!UICONTROL 预算请求] 分配了队列主题以使用 [!UICONTROL 预算请求] 自定义表单。
* A **[!UICONTROL 营销活动摘要]** 表单。
...
1. 导航到 [!UICONTROL 模板] 菜单 [!DNL Workfront Fusion] ，然后单击 **[!UICONTROL 创建 [!DNL Anaplan] 从Workfront预算请求中列出项目]** 方案模板。
