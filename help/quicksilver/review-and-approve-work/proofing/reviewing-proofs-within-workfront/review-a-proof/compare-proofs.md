...
1. 单击&#x200B;**比较校样**。
   ...
   有关可用于比较两个校样的工具的信息，请参阅[在校样查看器中比较校样](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md)中的[使用比较工具](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md#using-compare-tools)。
