...
1. 执行以下操作之一以下载应用程序：
   ...
   * 如果您使用的是“预览”环境，请单击桌面验证查看器的[Mac预览下载。](https://assets.preview.proofhq.com/nativeviewer/desktop_viewer/Workfront+Proof+Preview-2.1.39.pkg)
...
1. 执行以下操作之一以下载应用程序：
   ...
   * 在“预览”环境中，单击桌面验证查看器的[Windows预览下载](https://assets.preview.proofhq.com/nativeviewer/desktop_viewer/Workfront+Proof+Preview+Setup+2.1.39.exe)
