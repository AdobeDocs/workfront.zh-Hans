...
title: 将基本工作流转换为校样上的自动工作流
description: 如果您是校样所有者，则可以将现有校样的基本工作流转换为自动工作流。
author: Courtney
...
如果您是校样所有者，则可以将现有校样的基本工作流转换为自动工作流。
...
1. 在文档列表中，将鼠标悬停在文档上，然后单击 **校对工作流** 显示时。
1. 在Adobe Workfront的右上角附近，单击 **转换为自动化工作流**.
1. 单击 **新阶段** 中。
1. 指定以下内容：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader"><strong>锁台</strong> </td> 
      <td>选择是否应锁定舞台。</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      <td role="rowheader"><strong>决定</strong> </td> 
      <td>选择是否只需要一个决策。 </td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td>输入联系人姓名或电子邮件地址，选择校样角色，然后配置电子邮件警报。</td> 
     </tr> 
    </tbody> 
   </table>

1. 单击 **添加阶段**.
1. （可选）重复步骤3和4，直到您对工作流满意为止。
