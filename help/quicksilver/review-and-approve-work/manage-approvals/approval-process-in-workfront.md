...
旧文档审批用于更一般的审批。 在“更新”选项卡上以聊天格式捕获反馈。 您可以使用批准按钮批准、拒绝或批准更改。

要在文档上传到Workfront后添加审批者，请参阅[请求旧版文档审批](../../review-and-approve-work/manage-approvals/request-document-approvals.md)。

>[!NOTE]
>
>Workfront中当前有多个文档审批选项。 有关详细信息，请参阅[用于文档审批的可用功能](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)。
