...
title: 将附加批准者添加到已提交的文档批准
description: 您可以直接从“主页”(Home)区域将附加批准者添加到文档批准。
author: Courtney
...
您可以直接从“主页”(Home)区域将附加批准者添加到文档批准。
...
1. 单击 **管理批准** 中。
1. 在 **让某人批准此文档** 框中，键入审批者的名称。

   如果您的Adobe Workfront管理员已启用与未使用Workfront的人员协作的功能，如 [配置系统安全首选项](../../administration-and-setup/manage-workfront/security/configure-security-preferences.md)，则可以键入其电子邮件地址以包含这些地址。
