...
title: 将附加审批者添加到已提交的文档审批
description: 您可以直接从主页区域向文档审批添加其他审批者。
author: Courtney
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>查看或更高权限访问与请求访问权限或审批关联的对象 </p> <p>有关请求其他访问权限的信息，请参阅<a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">请求访问对象</a>。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 单击右面板右上角的&#x200B;**管理审批**。
1. 在&#x200B;**请某人批准此文档**&#x200B;框中，键入批准者的姓名。

   如果Adobe Workfront管理员启用了与不使用Workfront的用户进行协作的功能（如[配置系统安全首选项](../../administration-and-setup/manage-workfront/security/configure-security-preferences.md)中所述），则可以键入其电子邮件地址以包含这些用户。
