...
1. 单击Adobe Workfront左上角的&#x200B;**主页**&#x200B;图标![](assets/home-icon-30x29.png)。
   ...
   单击左侧面板中的&#x200B;**主菜单**&#x200B;图标> **您的姓名** > **休息时间**。

1. （可选，有条件）在“主页”区域中，单击&#x200B;**筛选器**&#x200B;下拉菜单，然后单击&#x200B;**审批**。

1. （视情况而定）单击&#x200B;**委托我的审批**

   或

   如果您的系统管理员或组管理员启用了任务和问题委派，请单击“委派”****，然后单击“委派审批”****。
...
1. 单击&#x200B;**筛选器**&#x200B;下拉菜单，然后单击&#x200B;**审批**。

1. （视情况而定）单击&#x200B;**编辑委派**

   或

   如果您的系统管理员或组管理员启用了任务和问题委派，请单击“编辑委派”****，然后单击“委派审批”****。
