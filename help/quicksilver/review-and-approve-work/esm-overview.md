...
您可以在类似存储模型之间移动、复制和转换Workfront对象。 例如，您可以将任务从Adobe云存储项目移动到另一个Adobe云存储项目。 您无法将任务从Adobe云存储项目移动到旧版Workfront存储项目。

这些操作可从任务或问题的更多菜单中获取。 每个操作都尊重文档完整性、权限继承和Adobe云存储规则。
