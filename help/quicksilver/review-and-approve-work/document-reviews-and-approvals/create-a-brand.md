...
在编写准则之前，请查看[AI审阅者评估了哪些图像和品牌声音准则类型](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/wf-ai-reviewer.md#what-ai-reviewer-evaluates)。 这些评估区域之外的准则不计分。

*  编写描述可衡量标准的品牌指南。 AI审核者按字面意思对内容进行评估，因此客观规则会生成比主观规则更一致的分数。
