...
1. （可选）选择现有的审批模板。 拥有Standard许可证的用户可以从设置区域创建可重复使用的审批模板。 有关详细信息，请参阅[为文档创建审批工作流模板](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md)。
...
1. （可选）根据需要重复上一步添加其他阶段。
   ...
   ![新阶段](assets/new-stage.png)

1. 添加所有审阅人和批准者后，单击&#x200B;**请求批准**。 将通过电子邮件通知参与者。
