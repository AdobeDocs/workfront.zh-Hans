...
Workfront中的统一审批引入了一组新功能，可帮助您审阅和批准文档。 您可以使用具有现有校样查看器的统一审批工作流程，向正在审阅的文档添加注释和标记。
...
您可以选择指定审阅人、审批人或同时指定两者：

* **审阅人**&#x200B;可以添加注释和标记资源。 完成后，他们可以将其审阅标记为完成。 文档在审批流程中向前移动不需要将审核标记为完成。
...
1. （可选）选择现有审批模板。 拥有标准许可证的用户可以从“设置”区域创建可重用的审批模板。 有关详细信息，请参阅[为资源和文档创建批准模板](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md)。
...
1. 将新文件拖放到Workfront中的上一个文档上。 这会自动创建一个新版本。

1. 文档上传完成后，请选择该文档，然后单击&#x200B;**创建校样** > **简单校样**。
...
1. （可选）设置批准的截止日期。 用户和团队将在指定截止日期前72小时收到电子邮件通知。

1. 若要添加审批人，请单击“审批人”按钮，然后开始键入用户或团队名称，<span class="preview">或从以前的版本中选择审批人。</span>

1. 要添加审阅人，请单击“审阅人”按钮，然后开始键入用户或团队名称<span class="preview">或从以前的版本中选择审阅人。</span>

   ![添加审批人](assets/add-approvers.png)
...
>[!IMPORTANT]
>
>文档决策按钮不会显示在校样查看器中。 您必须导航回文档摘要或文档详细信息页面才能做出决定或标记审阅完成。

要审阅并批准文档，请执行以下操作：

1. 转到您的审阅电子邮件通知，然后单击以&#x200B;**转到审阅**。

1. 登录Workfront后，单击&#x200B;**转到校样**。
...
1. 选择以下决策之一：
   ...
   * **批准**：文档不需要更改，可以使用了。
   * **通过更改批准**：文档需要更改，并且可以在更改完成后立即使用。 无需额外批准。
