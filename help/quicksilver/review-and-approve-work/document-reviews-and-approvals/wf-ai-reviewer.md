...
借助Workfront AI审阅者，您可以在审阅和批准工作流程中提高内容速度并优化品牌合规性。 您可以在Workfront中将AI审阅人添加到批准模板或个人审阅和批准请求。
...
Workfront AI审阅者在审阅内容时，会使用Genstudio基础中设置的品牌准则。
...
一旦在GenStudio Foundation中至少设置了一个品牌，Workfront管理员便可以在“设置”区域开始创建AI审阅者。 随后，可以将这些AI审阅人分配给审批模板以及单个审阅和审批请求。
...
如果图像长期符合品牌规范，创意人员可以上传新版本，审批负责人可以使用AI审核者创建第二个审核和审批请求，从而允许您在版本之间切换并比较反馈。
