...
1. 将鼠标悬停在要删除的批准者或审阅者的名称上，然后单击 **删除** 图标 ![](../assets/delete.png) 出现在他们名字后面的。

   审批或审阅请求将被删除，审批者会收到通知，告知不再需要其审批。 与审批相关的共享访问权限也会被删除。

1. （可选）要将审批者降级为审阅人而不是完全删除他们，请取消选中 **审批者** 复选框。
...
1. 向下滚动到 **审批** 部分。 将鼠标悬停在要删除的批准者或审阅者的名称上，然后单击 **删除** 图标 ![](../assets/delete.png) 出现在他们名字后面的。
