...
title: 设置和管理统一审批：文章索引
description: 此部分包含有关在Workfront中管理统一审批的文章。
author: Courtney
...
* [为内容查看者创建和管理品牌](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/create-a-brand.md)
...
* [管理审批模板](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-approval-templates.md)
