...
1. 要添加审批者，请确保 **审批者** 勾选复选框，然后开始键入 **审阅者** 文本框。 您可以按名称添加Workfront用户或团队。 如果要添加审阅者，只需取消选中 **审批者** 复选框。
...
1. 在版本下拉菜单中选择要向其中添加审批者或审阅者的文档的版本。 默认情况下将选择最新版本。

1. 向下滚动到 **审批** “文档摘要”窗格中的部分，其中列出了所有现有的批准者和审阅者。 要添加审批者，请确保 **审批者** 勾选复选框，然后开始键入 **审阅者** 文本框。 您可以按名称添加Workfront用户或团队。 如果要添加审阅者，只需取消选中 **审批者** 复选框。
