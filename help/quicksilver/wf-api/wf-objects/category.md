...
title: 当APIModel INTERNAL不支持字段项目(OpTask)类别时
description: 当APIModel INTERNAL不支持字段项目(OpTask)时
author: John
...
消息：&quot;APIModel INTERNAL不支持字段项目id(OpTask)&quot;
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;acessorIDs&quot;}">处理器ID</td> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">字符串</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Type of Object the Custom form is related to&quot;}">自定义表单所关联的对象类型</td> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">字符串</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;ID of the User that added the Custom Form&quot;}">添加自定义表单的用户ID</td> 
   <td> </td> 
   <td> <p><span class="dtGrp">不可分组</span> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">字符串</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;User Editable Field inteded to be used a link to an external object&quot;}">用户可编辑字段，希望用作指向外部对象的链接</td> 
   <td> </td> 
   <td> <p><span class="dtEdit">可编辑的</span> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">字符串</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;ID of the first group with access to the custom form&quot;}">有权访问自定义表单的第一个组的ID</td> 
   <td> </td> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Does the form have calculated fields associated with it?&quot;}">表单是否具有与其关联的计算字段？</td> 
   <td> </td> 
   <td> <p><span class="dtGrp">不可分组</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">字符串</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;ID of the last user to Update the object&quot;}">要更新对象的上一个用户的ID</td> 
   <td> </td> 
   <td> <p><span class="dtGrp">不可分组</span> </p> </td> 
  </tr> 
  <tr> 
...
| 名称 | 标签 | 类型 | 类型对象代码 | URL |
|---|---|---|---|---|
| 客户 | 客户 | 客户 | CUST | [https://support.workfront.com/hc/en-us/articles/226425467](https://support.workfront.com/hc/en-us/articles/226425467) |
| 输入者 | enteredBy | 用户 | 用户 | [https://support.workfront.com/hc/en-us/articles/226425467](https://support.workfront.com/hc/en-us/articles/226425467) |
...
| 类别访问规则 | categoryAccessRules | 类别访问规则 | 卡塔克 | [https://support.workfront.com/hc/en-us/articles/226425467](https://support.workfront.com/hc/en-us/articles/226425467) |
| 类别级联规则 | categoryCascadeRules | 卡塔哥里级联规则 | CTCSRL | [https://support.workfront.com/hc/en-us/articles/226425467](https://support.workfront.com/hc/en-us/articles/226425467) |
...
| 其他组 | otherGroups | 组 | 组 | [https://support.workfront.com/hc/en-us/articles/226425467](https://support.workfront.com/hc/en-us/articles/226425467) |
...
| 标签 | 名称 | 参数 |
|---|---|---|
| 分配类别 | assignCategories | `[{name: "objID",type: "string"},{name: "objCode",type: "string"},{name: "categoryIDs",type: "string[]"}]` |
| 分配类别 | assignCategory | `[{name: "objID",type: "string"},name: "objCode",type: "string"},{name: "categoryID",type: "string"}]` |
| 取消分配类别 | unassignCategories | `[{name: "objID",type: "string"},{name: "objCode",type: "string"},{name: "categoryIDs",type: "string[]"}]` |
