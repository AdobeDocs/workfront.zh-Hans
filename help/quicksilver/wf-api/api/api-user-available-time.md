...
* **用户ID**：字符串数组。 必填. 示例: `"61a9cc0500002f9fdaa7a6f824f557e1"`.

* **fromDate**：日期时间。 字符串. 必填. 示例:  `"2022-07-10T00:00:00"`.

* **toDate**：日期时间。 字符串. 必填. 示例 `"2022-07-20T23:59:59"`.
...
* **AVL**：实际可用小时数。 数字数组。
* **PAVL**：用于计划的纯可用小时数，不包括非工作日或用户休息时间。 字符串.
