...
有关开票记录的更多信息，请参阅 [创建开票记录](../../manage-work/projects/project-finances/create-billing-records.md).

BillingRecord对象添加了标志 **数据可扩展**.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>getGroupStatuses</b> </p> <p>已添加. 此查询支持创建和管理组和子组的状态。 </p> <p>有关更多信息，请参阅 <a href="../../administration-and-setup/manage-groups/manage-group-statuses/manage-group-statuses.md" class="MCXref xref">管理组状态</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>name</b> </p> <p>添加的可能值：</p> 
      <ul> 
       <li> <p>允许用户在更新中添加图像(updates：images.toggle)</p> </li> 
      </ul> <p>此参数支持将图像添加到工作项更新的功能。 </p> <p>有关更多信息，请参阅 <a href="../../workfront-basics/updating-work-items-and-viewing-updates/update-work.md" class="MCXref xref">更新工作</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
有关在更新中标记的详细信息，请参阅 [为其他人标记更新](../../workfront-basics/updating-work-items-and-viewing-updates/tag-others-on-updates.md).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>searchByPath</b> </p> <p>已添加. 此操作支持通过使用请求队列和主题组中的路径来查找请求的功能。</p> <p>有关按路径搜索请求队列的详细信息，请参见 <a href="../../manage-work/requests/create-requests/create-submit-requests.md#create-requests-in-the-web-app" class="MCXref xref">在Workfront Web应用程序中创建请求并生成草稿</a> 在 <a href="../../manage-work/requests/create-requests/create-submit-requests.md" class="MCXref xref">创建和提交Adobe Workfront请求</a>.</p> </li> 
    </ul> <p> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li style="font-weight: bold;"> <p>groupID</p> <p style="font-weight: normal;">已添加. 添加此字段是为了支持将组与模板关联的能力。</p> <p style="font-weight: normal;">有关更多信息，请参阅 <a href="../../manage-work/projects/create-and-manage-templates/edit-templates.md" class="MCXref xref">编辑项目模板</a>.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">引用字段</td> 
   <td> 
    <ul> 
     <li style="font-weight: bold;"> <p>组</p> <p style="font-weight: normal;">已添加. 添加此字段是为了支持将组与模板关联的能力。</p> <p style="font-weight: normal;">有关更多信息，请参阅 <a href="../../manage-work/projects/create-and-manage-templates/edit-templates.md" class="MCXref xref">编辑项目模板</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
