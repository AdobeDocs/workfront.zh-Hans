...
BreadCrumb对象表示Workfront工作项的父/子层次结构中的元素。 痕迹导航指示工作项如何适应项目组合、项目、项目和任务的更大结构。
...
有关组的详细信息，请参阅Adobe Workfront[中的](../../people-teams-and-groups/work-with-groups-and-teams/understanding-differences-and-similarities-between-groups-and-teams.md)组与团队。
