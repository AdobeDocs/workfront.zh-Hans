...
以下现有资源已使用此版本的Adobe Workfront API进行了更新。 要查看版本9的新资源，您可以访问[API版本9](../../wf-api/api/new-api-version-9.md)的新增功能[API版本9的新增功能（续）](../../wf-api/api/new-api-version-9-continue.md)。 对资源所做的更改按以下方式表示：
