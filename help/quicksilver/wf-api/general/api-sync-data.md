...
批量更新是一种通过定期向Workfront服务器发出请求来配置系统以进行更新的方法。 有很多方法可以做到这一点，但通常流程包括让您的服务向Workfront API服务器发出请求，并搜索自上次请求调用以来创建或修改的对象。 有关潜在请求调用和有用参数的信息，请参阅[API基础知识](../../wf-api/general/api-basics.md)文章中的[获取行为](../../wf-api/general/api-basics.md#get-behavior)部分。
...
**示例：**&#x200B;利用&#x200B;**lastUpdateDate**&#x200B;字段对问题对象的GET请求。 此请求将返回自指定日期以来更新的所有问题。
