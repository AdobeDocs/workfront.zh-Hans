...
<pre>POST /attask/api/v15.0/document？updates={<br>名称： aFileName，<br>句柄： abc...123，（文件上载的句柄）<br> docObjCode： PROJ，（或TASK、OPTASK等）<br> objID： abc...123，<br> currentVersion：{version：v1.0，文件名：aFileName}<br></pre>
...
<pre>PUT /attask/api/v15.0/project/123abcxxxxxxxxxxxxxxxxxxxxxx？method=PUT&amp;updates={accessRules：[{accessorID：'123abcxxxxxxxxxxxxxxxxxxxxxxxxxx'，accessorObjCode：'TEAMOB'，coreAction：'VIEW'}]</pre>以下示例显示了将任务从一个项目移动到另一个项目的语法：
