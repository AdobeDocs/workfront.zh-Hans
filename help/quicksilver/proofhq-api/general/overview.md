...
公共接口与WSDL支持兼容，即SOAP 1.1。 因此，所有请求都将通过HTTPS使用XML执行。

## API版本控制

为了保持与现有客户端集成的兼容性，我们从12.1版本引入了API版本控制。 有关详细信息，请参阅[API更新](https://api.proofhq.com/new-updates.html)页面。 如果某个方法或参数没有版本信息，则意味着您会在标准API中找到此信息，请参阅下面的“API快速入门”部分。
